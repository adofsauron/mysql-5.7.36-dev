    ...
    sym_tab_t *sym_tab) /*!< in, own: symbol table */
{
  ...
  for (sym = UT_LIST_GET_FIRST(sym_tab->sym_list); sym != NULL; sym = UT_LIST_GET_NEXT(sym_list, sym))
  {
  ...
  for (func = UT_LIST_GET_FIRST(sym_tab->func_node_list); func != NULL; func = UT_LIST_GET_NEXT(func_node_list, func))
  {
    ...
    ulint len)          /*!< in: string length */
{
  ...
  data = (len) ? static_cast<byte *>(mem_heap_dup(sym_tab->heap, str, len)) : NULL;
    ...
    ulint len)          /*!< in: identifier length */
{
  ...
  node = static_cast<sym_node_t *>(mem_heap_zalloc(sym_tab->heap, sizeof(*node)));
