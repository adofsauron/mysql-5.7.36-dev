...
static const Alter_inplace_info::HA_ALTER_FLAGS INNOBASE_ONLINE_CREATE =
    Alter_inplace_info::ADD_INDEX | Alter_inplace_info::ADD_UNIQUE_INDEX | Alter_inplace_info::ADD_SPATIAL_INDEX;
...
static const Alter_inplace_info::HA_ALTER_FLAGS INNOBASE_ALTER_REBUILD =
    ...
    | Alter_inplace_info::ALTER_COLUMN_NULLABLE | Alter_inplace_info::ALTER_COLUMN_NOT_NULLABLE |
    Alter_inplace_info::ALTER_STORED_COLUMN_ORDER | Alter_inplace_info::DROP_STORED_COLUMN |
    Alter_inplace_info::ADD_STORED_BASE_COLUMN | Alter_inplace_info::RECREATE_TABLE
    /*
...
static const Alter_inplace_info::HA_ALTER_FLAGS INNOBASE_ALTER_DATA = INNOBASE_ONLINE_CREATE | INNOBASE_ALTER_REBUILD;

/** Operations for altering a table that InnoDB does not care about */
static const Alter_inplace_info::HA_ALTER_FLAGS INNOBASE_INPLACE_IGNORE =
    Alter_inplace_info::ALTER_COLUMN_DEFAULT | Alter_inplace_info::ALTER_COLUMN_COLUMN_FORMAT |
...
static const Alter_inplace_info::HA_ALTER_FLAGS INNOBASE_ALTER_NOREBUILD =
    INNOBASE_ONLINE_CREATE | INNOBASE_FOREIGN_OPERATIONS | Alter_inplace_info::DROP_INDEX |
    Alter_inplace_info::DROP_UNIQUE_INDEX | Alter_inplace_info::RENAME_INDEX | Alter_inplace_info::ALTER_COLUMN_NAME |
    Alter_inplace_info::ALTER_COLUMN_EQUAL_PACK_LENGTH | Alter_inplace_info::ALTER_INDEX_COMMENT |
    Alter_inplace_info::ADD_VIRTUAL_COLUMN | Alter_inplace_info::DROP_VIRTUAL_COLUMN |
    Alter_inplace_info::ALTER_VIRTUAL_COLUMN_ORDER | Alter_inplace_info::ALTER_COLUMN_INDEX_LENGTH;
...
struct ha_innobase_inplace_ctx : public inplace_alter_handler_ctx
{
  ...
  ha_innobase_inplace_ctx(row_prebuilt_t *&prebuilt_arg, dict_index_t **drop_arg, ulint num_to_drop_arg,
                          dict_index_t **rename_arg, ulint num_to_rename_arg, dict_foreign_t **drop_fk_arg,
                          ulint num_to_drop_fk_arg, dict_foreign_t **add_fk_arg, ulint num_to_add_fk_arg,
                          bool online_arg, mem_heap_t *heap_arg, dict_table_t *new_table_arg,
                          const char **col_names_arg, ulint add_autoinc_arg, ulonglong autoinc_col_min_value_arg,
                          ulonglong autoinc_col_max_value_arg, ulint num_to_drop_vcol_arg)
      : inplace_alter_handler_ctx(),
        ...
        add_cols(0),
        sequence(prebuilt->trx->mysql_thd, autoinc_col_min_value_arg, autoinc_col_max_value_arg),
        max_autoinc(0),
        tmp_name(0),
        skip_pk_sort(false),
        num_to_add_vcol(0),
  ...
  void set_shared_data(const inplace_alter_handler_ctx *ctx)
  {
    ...
    const ha_innobase_inplace_ctx *ha_ctx = static_cast<const ha_innobase_inplace_ctx *>(ctx);
...
{
  Alter_inplace_info::HA_ALTER_FLAGS alter_inplace_flags = ha_alter_info->handler_flags & ~(INNOBASE_INPLACE_IGNORE);

  if (alter_inplace_flags == Alter_inplace_info::CHANGE_CREATE_OPTION &&
      !(ha_alter_info->create_info->used_fields &
        (HA_CREATE_USED_ROW_FORMAT | HA_CREATE_USED_KEY_BLOCK_SIZE | HA_CREATE_USED_TABLESPACE)))
  {
...
static bool check_v_col_in_order(const TABLE *table, const TABLE *altered_table, Alter_inplace_info *ha_alter_info)
{
  ulint j = 0;
  ...
  if (ha_alter_info->handler_flags & Alter_inplace_info::ADD_VIRTUAL_COLUMN)
  {
    ...
    List_iterator_fast<Create_field> cf_it(ha_alter_info->alter_info->create_list);
  ...
  if (!(ha_alter_info->handler_flags & Alter_inplace_info::ALTER_VIRTUAL_COLUMN_ORDER))
  {
    return (true);
  }
  ...
  for (ulint i = 0; i < table->s->fields; i++)
  {
    ...
    List_iterator_fast<Alter_drop> cf_it(ha_alter_info->alter_info->drop_list);

    while ((drop = (cf_it++)) != NULL)
    {
      if (my_strcasecmp(system_charset_info, field->field_name, drop->name) == 0)
      {
        dropped = true;
        break;
      }
    ...
    while (j < altered_table->s->fields)
    {
      ...
      if (my_strcasecmp(system_charset_info, field->field_name, new_field->field_name) != 0)
      {
        /* different column */
        return (false);
      }
    ...
    TABLE *altered_table, Alter_inplace_info *ha_alter_info)
{
  ...
  if (high_level_read_only || srv_sys_space.created_new_raw() || srv_force_recovery)
  {
    ha_alter_info->unsupported_reason = (srv_force_recovery) ? innobase_get_err_msg(ER_INNODB_FORCED_RECOVERY)
  ...
  if (altered_table->s->fields > REC_MAX_N_USER_FIELDS)
  {
    ...
    ha_alter_info->unsupported_reason = innobase_get_err_msg(ER_TOO_MANY_FIELDS);
    DBUG_RETURN(HA_ALTER_INPLACE_NOT_SUPPORTED);
  }
  ...
  {
    ha_alter_info->unsupported_reason = innobase_get_err_msg(ER_UNSUPPORTED_ALTER_ENCRYPTION_INPLACE);
    DBUG_RETURN(HA_ALTER_INPLACE_NOT_SUPPORTED);
  }
  ...
  if (ha_alter_info->handler_flags & ~(INNOBASE_INPLACE_IGNORE | INNOBASE_ALTER_NOREBUILD | INNOBASE_ALTER_REBUILD))
  {
    if (ha_alter_info->handler_flags & Alter_inplace_info::ALTER_STORED_COLUMN_TYPE)
    {
      ha_alter_info->unsupported_reason = innobase_get_err_msg(ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_COLUMN_TYPE);
    }
    DBUG_RETURN(HA_ALTER_INPLACE_NOT_SUPPORTED);
  }
  ...
  if ((ha_alter_info->handler_flags & Alter_inplace_info::ADD_FOREIGN_KEY) && m_prebuilt->trx->check_foreigns)
  {
    ha_alter_info->unsupported_reason = innobase_get_err_msg(ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_FK_CHECK);
    DBUG_RETURN(HA_ALTER_INPLACE_NOT_SUPPORTED);
  }
  ...
  if ((ha_alter_info->handler_flags & Alter_inplace_info::ALTER_COLUMN_NOT_NULLABLE) && !thd_is_strict_mode(m_user_thd))
  {
    ha_alter_info->unsupported_reason = innobase_get_err_msg(ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_NOT_NULL);
    DBUG_RETURN(HA_ALTER_INPLACE_NOT_SUPPORTED);
  }

  /* DROP PRIMARY KEY is only allowed in combination with ADD
  PRIMARY KEY. */
  if ((ha_alter_info->handler_flags & (Alter_inplace_info::ADD_PK_INDEX | Alter_inplace_info::DROP_PK_INDEX)) ==
      Alter_inplace_info::DROP_PK_INDEX)
  {
    ha_alter_info->unsupported_reason = innobase_get_err_msg(ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_NOPK);
    DBUG_RETURN(HA_ALTER_INPLACE_NOT_SUPPORTED);
  }
  ...
  if ((ha_alter_info->handler_flags & Alter_inplace_info::ALTER_COLUMN_NULLABLE))
  {
    ...
    if (UNIV_UNLIKELY(my_primary_key >= MAX_KEY) && !row_table_got_default_clust_index(m_prebuilt->table))
    {
      ha_alter_info->unsupported_reason = innobase_get_err_msg(ER_PRIMARY_CANT_HAVE_NULL);
      DBUG_RETURN(HA_ALTER_INPLACE_NOT_SUPPORTED);
    }
  }
  ...
  if (ha_alter_info->handler_flags & (Alter_inplace_info::ADD_VIRTUAL_COLUMN | Alter_inplace_info::DROP_VIRTUAL_COLUMN |
                                      Alter_inplace_info::ALTER_VIRTUAL_COLUMN_ORDER))
  {
    ...
    support them */
    flags &= ~(Alter_inplace_info::ADD_VIRTUAL_COLUMN | Alter_inplace_info::DROP_VIRTUAL_COLUMN |
               Alter_inplace_info::ALTER_VIRTUAL_COLUMN_ORDER |
    ...
    if (flags != 0 || (altered_table->s->partition_info_str && altered_table->s->partition_info_str_len) ||
  ...
  for (KEY *new_key = ha_alter_info->key_info_buffer;
       new_key < ha_alter_info->key_info_buffer + ha_alter_info->key_count; new_key++)
  {
    ...
    for (KEY_PART_INFO *key_part = new_key->key_part; key_part < new_key->key_part + new_key->user_defined_key_parts;
         key_part++)
    {
      ...
      if (m_prebuilt->table->fts && innobase_fulltext_exist(altered_table) &&
          !my_strcasecmp(system_charset_info, key_part->field->field_name, FTS_DOC_ID_COL_NAME))
      {
        ha_alter_info->unsupported_reason = innobase_get_err_msg(ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_HIDDEN_FTS);
        DBUG_RETURN(HA_ALTER_INPLACE_NOT_SUPPORTED);
      }

      assert((MTYP_TYPENR(key_part->field->unireg_check) == Field::NEXT_NUMBER) ==
      ...
      if (key_part->field->flags & AUTO_INCREMENT_FLAG)
      {
        ...
        ha_alter_info->unsupported_reason = innobase_get_err_msg(ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_AUTOINC);
        online = false;
      }
      ...
      if (key_part->field->is_virtual_gcol())
      {
        ...
        ha_alter_info->unsupported_reason = innobase_get_err_msg(ER_UNSUPPORTED_ALTER_ONLINE_ON_VIRTUAL_COLUMN);
        online = false;
      }
    }
  }

  assert(!m_prebuilt->table->fts || m_prebuilt->table->fts->doc_col <= table->s->fields);
  assert(!m_prebuilt->table->fts || m_prebuilt->table->fts->doc_col < dict_table_get_n_user_cols(m_prebuilt->table));

  if (ha_alter_info->handler_flags & Alter_inplace_info::ADD_SPATIAL_INDEX)
  {
    ha_alter_info->unsupported_reason = innobase_get_err_msg(ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_GIS);
    online = false;
  }
  ...
  if (m_prebuilt->table->fts && innobase_fulltext_exist(altered_table))
  {
    ...
    {
      if (!my_strcasecmp(system_charset_info, ha_alter_info->index_drop_buffer[i]->name, FTS_DOC_ID_INDEX_NAME))
      {
        ha_alter_info->unsupported_reason = innobase_get_err_msg(ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_CHANGE_FTS);
        DBUG_RETURN(HA_ALTER_INPLACE_NOT_SUPPORTED);
      }
    }
    ...
    for (Field **fp = table->field; *fp; fp++)
    {
      ...
      if (!my_strcasecmp(system_charset_info, (*fp)->field_name, FTS_DOC_ID_COL_NAME))
      {
        ha_alter_info->unsupported_reason = innobase_get_err_msg(ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_CHANGE_FTS);
        DBUG_RETURN(HA_ALTER_INPLACE_NOT_SUPPORTED);
      }
  ...
  else if (((ha_alter_info->handler_flags & Alter_inplace_info::ADD_PK_INDEX) ||
            innobase_need_rebuild(ha_alter_info)) &&
           (innobase_fulltext_exist(altered_table) || innobase_spatial_exist(altered_table)))
  {
    ...
    {
      ha_alter_info->unsupported_reason = innobase_get_err_msg(ER_INNODB_FT_LIMIT);
      DBUG_RETURN(HA_ALTER_INPLACE_NOT_SUPPORTED);
    }
    ...
    {
      ha_alter_info->unsupported_reason = innobase_get_err_msg(ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_FTS);
    }
  }
  else if ((ha_alter_info->handler_flags & Alter_inplace_info::ADD_INDEX))
  {
    ...
    for (uint i = 0; i < ha_alter_info->index_add_count; i++)
    {
      ...
      {
        assert(!(key->flags & HA_KEYFLAG_MASK & ~(HA_FULLTEXT | HA_PACK_KEY | HA_GENERATED_KEY | HA_BINARY_PACK_KEY)));
        ha_alter_info->unsupported_reason = innobase_get_err_msg(ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_FTS);
        online = false;
        break;
      }
  ...
  DBUG_RETURN(online ? HA_ALTER_INPLACE_NO_LOCK_AFTER_PREPARE : HA_ALTER_INPLACE_SHARED_LOCK_AFTER_PREPARE);
}
                                          ...
                                          columns */
{
  ...
  if (constraint_name)
  {
    ...
    foreign->id = static_cast<char *>(mem_heap_alloc(foreign->heap, db_len + strlen(constraint_name) + 2));
  ...
  foreign->foreign_col_names = static_cast<const char **>(mem_heap_alloc(foreign->heap, num_field * sizeof(void *)));

  for (ulint i = 0; i < foreign->n_fields; i++)
  {
    foreign->foreign_col_names[i] = mem_heap_strdup(foreign->heap, column_names[i]);
  }
  ...
  foreign->referenced_col_names =
      static_cast<const char **>(mem_heap_alloc(foreign->heap, referenced_num_field * sizeof(void *)));

  for (ulint i = 0; i < foreign->n_fields; i++)
  {
    foreign->referenced_col_names[i] = mem_heap_strdup(foreign->heap, referenced_column_names[i]);
  }
    ...
    const dict_foreign_t *foreign) /*!< in: foreign key */
{
  ...
  if (foreign->type & (DICT_FOREIGN_ON_UPDATE_SET_NULL | DICT_FOREIGN_ON_DELETE_SET_NULL))
  {
    ...
    uint n_add)      /*!< in: number of indexes to create */
{
  for (uint i = 0; i < n_add; i++)
  {
    ...
    for (uint j = 0; j < n_cols; j++)
    {
      ...
      {
        col_len -= static_cast<const Field_varstring *>(key_part.field)->length_bytes;
      }
    ...
    ulint n_cols)         /*!< in: number of columns */
{
  ...
  while (index != NULL)
  {
    if (!(index->type & DICT_FTS) &&
        dict_foreign_qualify_index(table, col_names, columns, n_cols, index, NULL, true, 0))
    {
...
static bool innobase_col_check_fk(const char *col_name, const dict_table_t *table, dict_s_col_list *s_cols)
{
  ...
  for (it = s_cols->begin(); it != s_cols->end(); ++it)
  {
    ...
    {
      if (strcmp(col_name, dict_table_get_col_name(table, s_col.base_col[j]->ind)) == 0)
      {
        return (true);
      }
    }
...
static bool innobase_check_fk_stored(const dict_foreign_t *foreign, const dict_table_t *table, dict_s_col_list *s_cols)
{
  ...
  type &= ~(DICT_FOREIGN_ON_DELETE_NO_ACTION | DICT_FOREIGN_ON_UPDATE_NO_ACTION);
...
static MY_ATTRIBUTE((warn_unused_result)) bool innobase_get_foreign_key_info(
    Alter_inplace_info *ha_alter_info, const TABLE_SHARE *table_share, dict_table_t *table, const char **col_names,
    dict_index_t **drop_index, ulint n_drop_index, dict_foreign_t **add_fk, ulint *n_add_fk, const trx_t *trx,
  ...
  *n_add_fk = 0;
  ...
  while ((key = key_iterator++))
  {
    ...
    if (fk_key->columns.elements > 0)
    {
      ...
      List_iterator<Key_part_spec> key_part_iterator(fk_key->columns);
      ...
      index = innobase_find_fk_index(ha_alter_info, table, col_names, drop_index, n_drop_index, column_names, i);
      ...
      if (!index && !innobase_find_equiv_index(column_names, static_cast<uint>(i), ha_alter_info->key_info_buffer,
                                               ha_alter_info->index_add_buffer, ha_alter_info->index_add_count))
      {
        my_error(ER_FK_NO_INDEX_CHILD, MYF(0), fk_key->name.str ? fk_key->name.str : "", table_share->table_name.str);
        goto err_exit;
      }
    ...
    referenced_table_name = dict_get_referenced_table(table->name.m_name, db_namep, db_name_len, tbl_namep,
                                                      tbl_name_len, &referenced_table, add_fk[num_fk]->heap);

    /* Test the case when referenced_table failed to
    open, if trx->check_foreigns is not set, we should
    still be able to add the foreign key */
    DBUG_EXECUTE_IF("innodb_test_open_ref_fail", referenced_table = NULL;);
    ...
    if (fk_key->ref_columns.elements > 0)
    {
      ulint i = 0;
      Key_part_spec *column;
      List_iterator<Key_part_spec> key_part_iterator(fk_key->ref_columns);

      while ((column = key_part_iterator++))
      {
        referenced_column_names[i] = column->field_name.str;
        ut_ad(i < MAX_NUM_FK_COLUMNS);
        i++;
      }
      ...
      if (referenced_table)
      {
        referenced_index = dict_foreign_find_index(referenced_table, 0, referenced_column_names, i, index, TRUE, FALSE);

        DBUG_EXECUTE_IF("innodb_test_no_reference_idx", referenced_index = NULL;);
        ...
        {
          mutex_exit(&dict_sys->mutex);
          my_error(ER_FK_NO_INDEX_PARENT, MYF(0), fk_key->name.str ? fk_key->name.str : "", tbl_namep);
          goto err_exit;
        }
      }
      else
    ...
    if (!innobase_init_foreign(add_fk[num_fk], fk_key->name.str, table, index, column_names, num_col,
                               referenced_table_name, referenced_table, referenced_index, referenced_column_names,
                               referenced_num_col))
    {
      mutex_exit(&dict_sys->mutex);
    ...
    if (!correct_option)
    {
      my_error(ER_FK_INCORRECT_OPTION, MYF(0), table_share->table_name.str, add_fk[num_fk]->id);
      goto err_exit;
    }
  ...
  switch (col->mtype)
  {
    ...
    case DATA_BINARY:
      ...
      if (field->type() == MYSQL_TYPE_VARCHAR)
      {
        ...
        dest = row_mysql_store_true_var_len(dest, len, flen - field->key_length());
      }
                               ...
                               rec, index, ...) */
{
  ...
  ut_ad(n_fields ==
        dict_table_get_n_user_cols(index->table) - !!(DICT_TF2_FLAG_IS_SET(index->table, DICT_TF2_FTS_HAS_DOC_ID)));
  ...
  for (uint i = 0; i < n_fields; i++)
  {
    ...
    ipos = dict_index_get_nth_col_or_prefix_pos(index, i, true, false);
    ...
    innobase_col_to_mysql(dict_field_get_col(dict_index_get_nth_field(index, ipos)), ifield, ilen, field);
  }
}
    ...
    const dfield_t *fields)    /*!< in: InnoDB index fields */
{
  ...
  ut_ad(n_fields == dict_table_get_n_user_cols(index->table) + dict_table_get_n_v_cols(index->table) -
  ...
  for (uint i = 0; i < n_fields; i++)
  {
    ...
    ipos = dict_index_get_nth_col_or_prefix_pos(index, col_n, true, innobase_is_v_fld(field));

    if (ipos == ULINT_UNDEFINED || dfield_is_ext(&fields[ipos]) || dfield_is_null(&fields[ipos]))
    {
      field->set_null();
    }
    else
    {
      ...
      innobase_col_to_mysql(dict_field_get_col(dict_index_get_nth_field(index, ipos)),
                            static_cast<const uchar *>(dfield_get_data(df)), dfield_get_len(df), field);
    }
  }
}
    ...
    const dtuple_t *row)      /*!< in: InnoDB row */
{
  ...
  ut_ad(n_fields == row->n_fields - DATA_N_SYS_COLS + dict_table_get_n_v_cols(itab) -
  ...
  for (uint i = 0; i < n_fields; i++)
  {
    ...
    else
    {
      ...
      innobase_col_to_mysql(dict_table_get_nth_col(itab, i - num_v), static_cast<const uchar *>(dfield_get_data(df)),
...
/*!< in: Existing indexes */
{
  for (uint key_num = 0; key_num < info->index_add_count; key_num++)
  {
    ...
    for (index = dict_table_get_first_index(innodb_table); index; index = dict_table_get_next_index(index))
    {
    ...
    for (ulint i = 0; i < key.user_defined_key_parts; i++)
    {
      ...
      switch (get_innobase_type_from_mysql_type(&is_unsigned, field))
      {
        ...
        case DATA_DECIMAL:
          ...
          if (field->type() == MYSQL_TYPE_VARCHAR)
          {
            if (key_part1.length >= field->pack_length() - ((Field_varstring *)field)->length_bytes)
            {
              break;
            }
          }
...
static void innobase_create_index_field_def(const TABLE *altered_table, const KEY_PART_INFO *key_part,
                                            index_field_t *index_field, bool new_clustered)
{
  const Field *field;
  ibool is_unsigned;
  ulint col_type;
  ...
  field = new_clustered ? altered_table->field[key_part->fieldnr] : key_part->field;
  ut_a(field);
  ...
  if (DATA_LARGE_MTYPE(col_type) || (key_part->length < field->pack_length() && field->type() != MYSQL_TYPE_VARCHAR) ||
...
static void innobase_create_index_def(const TABLE *altered_table, const KEY *keys, ulint key_number, bool new_clustered,
                                      bool key_clustered, index_def_t *index, mem_heap_t *heap)
{
  ...
  index->fields = static_cast<index_field_t *>(mem_heap_alloc(heap, n_fields * sizeof *index->fields));
  ...
  else if (key->flags & HA_FULLTEXT)
  {
    ...
    assert(!(key->flags & HA_KEYFLAG_MASK & ~(HA_FULLTEXT | HA_PACK_KEY | HA_BINARY_PACK_KEY)));
  ...
  else if (key->flags & HA_SPATIAL)
  {
    ...
    if (!key->key_part[0].field->stored_in_db && key->key_part[0].field->gcol_info)
    {
  ...
  if (!(key->flags & HA_SPATIAL))
  {
    for (i = 0; i < n_fields; i++)
    {
      innobase_create_index_field_def(altered_table, &key->key_part[i], &index->fields[i], new_clustered);
    ...
    ulint *num_v) /*!< out: number of virtual column */
{
  ...
  *num_v = 0;
  ...
  for (i = 0; i < n_cols; i++)
  {
    ...
    if (my_strcasecmp(system_charset_info, field->field_name, FTS_DOC_ID_COL_NAME))
    {
      continue;
    }
    ...
    else if (field->type() != MYSQL_TYPE_LONGLONG || field->pack_length() != 8 || field->real_maybe_null() ||
                                ...
                                ha_alter_info */
{
  ...
  if (altered_table)
  {
    ...
    for (uint i = 0; i < altered_table->s->keys; i++)
    {
      ...
      if ((key.flags & HA_NOSAME) && key.user_defined_key_parts == 1 && !strcmp(key.name, FTS_DOC_ID_INDEX_NAME) &&
  ...
  for (index = dict_table_get_first_index(table); index; index = dict_table_get_next_index(index))
  {
    ...
    if (!dict_index_is_unique(index) || dict_index_get_n_unique(index) > 1 ||
    ...
    if (strcmp(field->name, FTS_DOC_ID_COL_NAME) == 0 && field->col->mtype == DATA_INT && field->col->len == 8 &&
        field->col->prtype & DATA_NOT_NULL && !dict_col_is_virtual(field->col))
    {
      if (fts_doc_col_no)
      {
...
static MY_ATTRIBUTE((warn_unused_result, malloc)) index_def_t *innobase_create_key_defs(
    /*=====================*/
    mem_heap_t *heap,
...
index for FTS index */
{
  ...
  new_primary = n_add > 0 && !my_strcasecmp(system_charset_info, key_info[*add].name, "PRIMARY");
  n_fts_add = 0;
  ...
  ut_ad(altered_table->s->primary_key == 0 || altered_table->s->primary_key == MAX_KEY);
  ...
  const bool rebuild = new_primary || add_fts_doc_id || innobase_need_rebuild(ha_alter_info);

  /* Reserve one more space if new_primary is true, and we might
  need to add the FTS_DOC_ID_INDEX */
  indexdef = indexdefs = static_cast<index_def_t *>(
      mem_heap_alloc(heap, sizeof *indexdef * (ha_alter_info->key_count + rebuild + got_default_clust)));
  ...
  if (rebuild)
  {
    ...
    innobase_create_index_def(altered_table, key_info, primary_key_number, true, true, indexdef++, heap);
  ...
  created_clustered:
    ...
    for (ulint i = 0; i < ha_alter_info->key_count; i++)
    {
      ...
      innobase_create_index_def(altered_table, key_info, i, true, false, indexdef, heap);
    ...
    if (n_fts_add > 0)
    {
      ...
      if (!add_fts_doc_id && !innobase_fts_check_doc_id_col(NULL, altered_table, &fts_doc_id_col, &num_v))
      {
  ...
  else
  {
    ...
    {
      innobase_create_index_def(altered_table, key_info, add[i], false, false, indexdef, heap);
  ...
  if (add_fts_doc_idx)
  {
    ...
    index->fields = static_cast<index_field_t *>(mem_heap_alloc(heap, sizeof *index->fields));
    index->n_fields = 1;
    index->fields->col_no = fts_doc_id_col;
    index->fields->prefix_len = 0;
    index->fields->is_v_col = false;
    index->ind_type = DICT_UNIQUE;
    ut_ad(!rebuild || !add_fts_doc_id || fts_doc_id_col <= altered_table->s->fields);
  ...
  assert((ulint)(indexdef - indexdefs) <= ha_alter_info->key_count + add_fts_doc_idx + got_default_clust);
  assert(ha_alter_info->index_add_count <= n_add);
...
/** Search for a given column in each index that is not being dropped. Return true if the column is part of any of the
active indexes or it is a system column.
@param[in]	table	table object
...
static bool check_col_exists_in_indexes(const dict_table_t *table, ulint col_no, bool is_v)
{
  ...
  for (dict_index_t *index = dict_table_get_first_index(table); index; index = dict_table_get_next_index(index))
  {
    ...
    {
      const dict_col_t *idx_col = dict_index_get_nth_col(index, i);

      if (is_v && dict_col_is_virtual(idx_col))
      {
        const dict_v_col_t *v_col = reinterpret_cast<const dict_v_col_t *>(idx_col);
      ...
      if (!is_v && !dict_col_is_virtual(idx_col) && dict_col_get_no(idx_col) == col_no)
      {
        return (true);
      }
    }
...
/********************************************************************/ /**
 ...
 open table handles. */
static void online_retry_drop_indexes_low(
    /*==========================*/
...
/********************************************************************/ /**
 Drop any indexes that we were not able to free previously due to
 open table handles. */
static void online_retry_drop_indexes(
    /*======================*/
    dict_table_t *table, /*!< in/out: table */
...
static void online_retry_drop_indexes_with_trx(
    /*===============================*/
    dict_table_t *table, /*!< in/out: table */
    trx_t *trx)          /*!< in/out: transaction */
{
  ut_ad(trx_state_eq(trx, TRX_STATE_NOT_STARTED) || trx_state_eq(trx, TRX_STATE_FORCED_ROLLBACK));
...
static MY_ATTRIBUTE((warn_unused_result)) bool innobase_check_foreigns_low(
    /*========================*/
    const dict_table_t *user_table, dict_foreign_t **drop_fk, ulint n_drop_fk, const char *col_name, bool drop)
{
  ...
  for (dict_foreign_set::iterator it = user_table->foreign_set.begin(); it != user_table->foreign_set.end(); ++it)
  {
    foreign = *it;

    if (!drop && !(foreign->type & (DICT_FOREIGN_ON_DELETE_SET_NULL | DICT_FOREIGN_ON_UPDATE_SET_NULL)))
    {
      continue;
    }
    ...
    for (unsigned f = 0; f < foreign->n_fields; f++)
    {
      ...
      {
        my_error(drop ? ER_FK_COLUMN_CANNOT_DROP : ER_FK_COLUMN_NOT_NULL, MYF(0), col_name, foreign->id);
        return (true);
      }
    }
  }
  ...
  for (dict_foreign_set::iterator it = user_table->referenced_set.begin(); it != user_table->referenced_set.end(); ++it)
  {
    foreign = *it;
    ...
    for (unsigned f = 0; f < foreign->n_fields; f++)
    {
      ...
      char *buf_end = innobase_convert_name(display_name, (sizeof display_name) - 1, foreign->foreign_table_name,
                                            strlen(foreign->foreign_table_name), NULL);
      *buf_end = '\0';
      my_error(ER_FK_COLUMN_CANNOT_DROP_CHILD, MYF(0), col_name, foreign->id, display_name);
...
static MY_ATTRIBUTE((warn_unused_result)) bool innobase_check_foreigns(
    /*====================*/
    Alter_inplace_info *ha_alter_info, const TABLE *altered_table, const TABLE *old_table,
    const dict_table_t *user_table, dict_foreign_t **drop_fk, ulint n_drop_fk)
{
  ...
  for (Field **fp = old_table->field; *fp; fp++)
  {
    ...
    {
      if (innobase_check_foreigns_low(user_table, drop_fk, n_drop_fk, (*fp)->field_name, !new_field))
      {
        return (true);
      }
    }
...
static const byte *innobase_build_default_mysql_point(mem_heap_t *heap, ulint length)
{
  byte *buf = static_cast<byte *>(mem_heap_alloc(heap, DATA_POINT_LEN + length));
    ...
    mem_heap_t *heap, dfield_t *dfield, const Field *field, ulint comp)
{
  ...
  row_mysql_store_col_in_innobase_format(dfield, buf, true, mysql_data, size, comp);
}
...
static MY_ATTRIBUTE((warn_unused_result)) const ulint *innobase_build_col_map(
    /*===================*/
    Alter_inplace_info *ha_alter_info, const TABLE *altered_table, const TABLE *table, const dict_table_t *new_table,
    const dict_table_t *old_table, dtuple_t *add_cols, mem_heap_t *heap)
{
  DBUG_ENTER("innobase_build_col_map");
  assert(altered_table != table);
  assert(new_table != old_table);
  assert(dict_table_get_n_cols(new_table) + dict_table_get_n_v_cols(new_table) >=
         altered_table->s->fields + DATA_N_SYS_COLS);
  assert(dict_table_get_n_cols(old_table) + dict_table_get_n_v_cols(old_table) >= table->s->fields + DATA_N_SYS_COLS);
  assert(!!add_cols == !!(ha_alter_info->handler_flags & Alter_inplace_info::ADD_COLUMN));
  assert(!add_cols || dtuple_get_n_fields(add_cols) == dict_table_get_n_cols(new_table));

  ulint *col_map =
      static_cast<ulint *>(mem_heap_alloc(heap, (old_table->n_cols + old_table->n_v_cols) * sizeof *col_map));
  ...
  while (const Create_field *new_field = cf_it++)
  {
    ...
    ut_ad(!is_v);
    innobase_build_col_map_add(heap, dtuple_get_nth_field(add_cols, i), altered_table->field[i + num_v],
  ...
  if (i + DATA_N_SYS_COLS < old_table->n_cols)
  {
    ...
    assert(!strcmp(dict_table_get_col_name(old_table, i), FTS_DOC_ID_COL_NAME));
    if (altered_table->s->fields + DATA_N_SYS_COLS - new_table->n_v_cols < new_table->n_cols)
    {
    ...
    dict_table_t *table, trx_t *trx)
{
  ...
  for (dict_index_t *index = dict_table_get_first_index(table); index != NULL; index = dict_table_get_next_index(index))
  {
    if (index->type & DICT_FTS)
    {
      dberr_t err;
...
static MY_ATTRIBUTE((warn_unused_result)) const
    char **innobase_get_col_names(Alter_inplace_info *ha_alter_info, const TABLE *altered_table, const TABLE *table,
                                  const dict_table_t *user_table, mem_heap_t *heap)
{
  const char **cols;
  uint i;
  ...
  cols = static_cast<const char **>(mem_heap_zalloc(heap, user_table->n_def * sizeof *cols));
...
static inline lint innobase_pk_col_prefix_compare(ulint new_prefix_len, ulint old_prefix_len)
{
...
static inline bool innobase_pk_col_is_existing(const ulint new_col_no, const ulint *col_map, const ulint col_map_size)
{
...
@retval false. */
static MY_ATTRIBUTE((warn_unused_result)) bool innobase_pk_order_preserved(const ulint *col_map,
                                                                           ...
                                                                           const dict_index_t *new_clust_index)
{
  ...
  for (ulint new_field = 0; new_field < new_n_uniq; new_field++)
  {
    ...
    const lint prefix_change = innobase_pk_col_prefix_compare(new_clust_index->fields[new_field].prefix_len,
...
static bool innobase_update_gis_column_type(table_id_t table_id, const char *col_name, trx_t *trx)
{
  pars_info_t *info;
  dberr_t error;
...
static dberr_t innobase_check_gis_columns(Alter_inplace_info *ha_alter_info, dict_table_t *table, trx_t *trx)
{
  DBUG_ENTER("innobase_check_gis_columns");

  for (uint key_num = 0; key_num < ha_alter_info->index_add_count; key_num++)
  {
    const KEY &key = ha_alter_info->key_info_buffer[ha_alter_info->index_add_buffer[key_num]];
    ...
    ulint col_nr = dict_table_has_column(table, key_part.field->field_name, key_part.fieldnr);
    ...
    const char *col_name = dict_table_get_col_name(table, col_nr);

    if (innobase_update_gis_column_type(table->id, col_name, trx))
    {
    ...
    else
    {
      ...
      ib::info() << "Updated mtype of column" << col_name << " in table " << table->name << ", whose id is "
                 << table->id << " to DATA_GEOMETRY";
    }
  }
...
@retval true Failure
@retval false Success */
static bool prepare_inplace_add_virtual(Alter_inplace_info *ha_alter_info, const TABLE *altered_table,
                                        const TABLE *table)
{
  ...
  ctx->num_to_add_vcol = altered_table->s->fields + ctx->num_to_drop_vcol - table->s->fields;

  ctx->add_vcol = static_cast<dict_v_col_t *>(mem_heap_zalloc(ctx->heap, ctx->num_to_add_vcol * sizeof *ctx->add_vcol));
  ctx->add_vcol_name =
      static_cast<const char **>(mem_heap_alloc(ctx->heap, ctx->num_to_add_vcol * sizeof *ctx->add_vcol_name));
  ...
  while ((new_field = (cf_it++)) != NULL)
  {
    ...
    if (dtype_is_string_type(col_type))
    {
      ...
      DBUG_EXECUTE_IF("ib_alter_add_virtual_fail", charset_no += MAX_CHAR_COLL_NUM;);
    ...
    if (field->type() == MYSQL_TYPE_VARCHAR)
    {
      uint32 length_bytes = static_cast<const Field_varstring *>(field)->length_bytes;
    ...
    ctx->add_vcol[j].base_col = static_cast<dict_col_t **>(
        mem_heap_alloc(ctx->heap, ctx->add_vcol[j].num_base * sizeof *(ctx->add_vcol[j].base_col)));
    ctx->add_vcol[j].v_pos = ctx->old_table->n_v_cols - ctx->num_to_drop_vcol + j;
...
@retval true Failure
@retval false Success */
static bool prepare_inplace_drop_virtual(Alter_inplace_info *ha_alter_info, const TABLE *altered_table,
                                         const TABLE *table)
{
  ha_innobase_inplace_ctx *ctx;
  ulint i = 0;
  ...
  ctx->drop_vcol =
      static_cast<dict_v_col_t *>(mem_heap_alloc(ctx->heap, ctx->num_to_drop_vcol * sizeof *ctx->drop_vcol));
  ctx->drop_vcol_name =
      static_cast<const char **>(mem_heap_alloc(ctx->heap, ctx->num_to_drop_vcol * sizeof *ctx->drop_vcol_name));
  ...
  while ((drop = (cf_it++)) != NULL)
  {
    ...
    {
      const Field *n_field = table->field[old_i];
      if (!my_strcasecmp(system_charset_info, n_field->field_name, drop->name))
      {
        break;
      }
    }
...
static dberr_t innobase_insert_sys_virtual(const dict_table_t *table, ulint pos, ulint base_pos, trx_t *trx)
{
...
@param[in] trx		transaction
@return DB_SUCCESS if successful, otherwise error code */
static dberr_t innobase_add_one_virtual(const dict_table_t *table, const char *col_name, dict_v_col_t *vcol, trx_t *trx)
{
  ulint pos = dict_create_v_col_pos(vcol->v_pos, vcol->m_col.ind);
  ...
  {
    error = innobase_insert_sys_virtual(table, pos, vcol->base_col[i]->ind, trx);
    if (error != DB_SUCCESS)
    {
      return (error);
    }
...
@param[in] trx		transaction
@return DB_SUCCESS if successful, otherwise error code */
static dberr_t innobase_update_n_virtual(const dict_table_t *table, ulint n_col, trx_t *trx)
{
...
@retval true Failure
@retval false Success */
static bool innobase_add_virtual_try(Alter_inplace_info *ha_alter_info, const TABLE *altered_table, const TABLE *table,
                                     const dict_table_t *user_table, trx_t *trx)
{
  ha_innobase_inplace_ctx *ctx;
  dberr_t err = DB_SUCCESS;
  ...
  {
    err = innobase_add_one_virtual(user_table, ctx->add_vcol_name[i], &ctx->add_vcol[i], trx);

    if (err != DB_SUCCESS)
    {
      my_error(ER_INTERNAL_ERROR, MYF(0), "InnoDB: ADD COLUMN...VIRTUAL");
      return (true);
    }
  }
  ...
  ulint new_n = dict_table_encode_n_col(n_col, n_v_col) + ((user_table->flags & DICT_TF_COMPACT) << 31);
...
@param[in]	trx	transaction
@return DB_SUCCESS if successful, otherwise error code */
static dberr_t innobase_update_v_pos_sys_columns(const dict_table_t *table, ulint old_pos, ulint new_pos, trx_t *trx)
{
  pars_info_t *info = pars_info_create();
...
@param[in]	trx		transaction
@return DB_SUCCESS if successful, otherwise error code */
static dberr_t innobase_update_v_pos_sys_virtual(const dict_table_t *table, ulint old_pos, ulint new_pos, trx_t *trx)
{
  pars_info_t *info = pars_info_create();
...
@param[in]	trx		transaction
@return DB_SUCCESS if successful, otherwise error code */
static dberr_t innobase_drop_one_virtual_sys_columns(const dict_table_t *table, const char *col_name,
                                                     dict_col_t *drop_col, ulint n_prev_dropped, trx_t *trx)
{
  pars_info_t *info = pars_info_create();
  pars_info_add_ull_literal(info, "id", table->id);
  ...
  dict_v_col_t *v_col = dict_table_get_nth_v_col_mysql(table, drop_col->ind);
  ...
  for (ulint i = v_col->v_pos + 1; i < table->n_v_cols; i++)
  {
    ...
    ulint old_p = dict_create_v_col_pos(t_col->v_pos - n_prev_dropped, t_col->m_col.ind - n_prev_dropped);
    ulint new_p = dict_create_v_col_pos(t_col->v_pos - 1 - n_prev_dropped, t_col->m_col.ind - 1 - n_prev_dropped);

    error = innobase_update_v_pos_sys_columns(table, old_p, new_p, trx);
    if (error != DB_SUCCESS)
    {
      return (error);
    }
    error = innobase_update_v_pos_sys_virtual(table, old_p, new_p, trx);
    if (error != DB_SUCCESS)
    {
      return (error);
    }
...
@param[in]	trx	transaction
@return DB_SUCCESS if successful, otherwise error code */
static dberr_t innobase_drop_one_virtual_sys_virtual(const dict_table_t *table, ulint pos, trx_t *trx)
{
  pars_info_t *info = pars_info_create();
  pars_info_add_ull_literal(info, "id", table->id);
...
@retval true Failure
@retval false Success */
static bool innobase_drop_virtual_try(Alter_inplace_info *ha_alter_info, const TABLE *altered_table, const TABLE *table,
                                      const dict_table_t *user_table, trx_t *trx)
{
  ha_innobase_inplace_ctx *ctx;
  dberr_t err = DB_SUCCESS;
  ...
  {
    ulint pos = dict_create_v_col_pos(ctx->drop_vcol[i].v_pos - i, ctx->drop_vcol[i].m_col.ind - i);
    err = innobase_drop_one_virtual_sys_virtual(user_table, pos, trx);

    if (err != DB_SUCCESS)
    {
      my_error(ER_INTERNAL_ERROR, MYF(0), "InnoDB: DROP COLUMN...VIRTUAL");
      return (true);
    }

    err = innobase_drop_one_virtual_sys_columns(user_table, ctx->drop_vcol_name[i], &(ctx->drop_vcol[i].m_col), i, trx);
...
static void innodb_v_adjust_idx_col(const Alter_inplace_info *ha_alter_info, const TABLE *old_table,
                                    ulint num_v_dropped, index_def_t *index_def)
{
  List_iterator_fast<Create_field> cf_it(ha_alter_info->alter_info->create_list);
...
static MY_ATTRIBUTE((warn_unused_result)) bool prepare_inplace_alter_table_dict(
    /*=============================*/
    Alter_inplace_info *ha_alter_info, const TABLE *altered_table, const TABLE *old_table, const char *table_name,
    ulint flags, ulint flags2, ulint fts_doc_id_col, bool add_fts_doc_id, bool add_fts_doc_id_idx)
{
  ...
  assert((ctx->add_autoinc != ULINT_UNDEFINED) == (ctx->sequence.m_max_value > 0));
  ...
  if (ha_alter_info->handler_flags & Alter_inplace_info::ADD_VIRTUAL_COLUMN)
  {
    ...
    if (ha_alter_info->handler_flags & Alter_inplace_info::ADD_INDEX)
    {
      for (ulint i = 0; i < ctx->num_to_add_vcol; i++)
      {
        ...
        dtype_get_mblen(ctx->add_vcol[i].m_col.mtype, ctx->add_vcol[i].m_col.prtype, &i_mbminlen, &i_mbmaxlen);

        dtype_set_mbminmaxlen((dtype_t *)&ctx->add_vcol[i].m_col, i_mbminlen, i_mbmaxlen);
      }
      add_v = static_cast<dict_add_v_col_t *>(mem_heap_alloc(ctx->heap, sizeof *add_v));
  ...
  index_defs = innobase_create_key_defs(ctx->heap, ha_alter_info, altered_table, ctx->num_to_add_index, num_fts_index,
  ...
  if (!ctx->online)
  {
    /* This is not an online operation (LOCK=NONE). */
           ...
           (!innobase_need_rebuild(ha_alter_info) || !innobase_fulltext_exist(altered_table)))
  {
  ...
  else
  {
    ...
    ut_ad(0);
    my_error(ER_NOT_SUPPORTED_YET, MYF(0), thd_query_unsafe(ctx->prebuilt->trx->mysql_thd).str);
    goto error_handled;
  }
  ...
  assert(!!new_clustered == (innobase_need_rebuild(ha_alter_info) || add_fts_doc_id));

  /* Allocate memory for dictionary index definitions */

  ctx->add_index =
      static_cast<dict_index_t **>(mem_heap_alloc(ctx->heap, ctx->num_to_add_index * sizeof *ctx->add_index));
  ctx->add_key_numbers = add_key_nums =
      static_cast<ulint *>(mem_heap_alloc(ctx->heap, ctx->num_to_add_index * sizeof *ctx->add_key_numbers));
  ...
  if (new_clustered)
  {
    const char *new_table_name =
        dict_mem_create_temporary_tablename(ctx->heap, ctx->new_table->name.m_name, ctx->new_table->id);
    ulint n_cols = 0;
    ulint n_v_cols = 0;
    dtuple_t *add_cols;
    ulint space_id = 0;
    ...
    if (innobase_check_foreigns(ha_alter_info, altered_table, old_table, user_table, ctx->drop_fk, ctx->num_to_drop_fk))
    {
    ...
    if (add_fts_doc_id)
    {
      ...
      flags2 |= DICT_TF2_FTS_ADD_DOC_ID | DICT_TF2_FTS_HAS_DOC_ID | DICT_TF2_FTS;
    }
    ...
    if (DICT_TF_HAS_SHARED_SPACE(user_table->flags) &&
        (ha_alter_info->create_info->tablespace == NULL ||
         (0 == strcmp(ha_alter_info->create_info->tablespace, user_table->tablespace))))
    {
      space_id = user_table->space;
    }
    else if (tablespace_is_shared_space(ha_alter_info->create_info))
    {
      space_id = fil_space_get_id_by_name(ha_alter_info->create_info->tablespace);
    ...
    ctx->new_table = dict_mem_table_create(new_table_name, space_id, n_cols + n_v_cols, n_v_cols, flags, flags2);
    ...
    {
      ctx->new_table->data_dir_path = mem_heap_strdup(ctx->new_table->heap, user_table->data_dir_path);
    }
    ...
    for (uint i = 0; i < altered_table->s->fields; i++)
    {
      ...
      if (is_virtual)
      {
        dict_mem_table_add_v_col(ctx->new_table, ctx->heap, field->field_name, col_type,
                                 dtype_form_prtype(field_type, charset_no) | DATA_VIRTUAL, col_len, i,
                                 field->gcol_info->non_virtual_base_columns());
      }
      else
      {
        dict_mem_table_add_col(ctx->new_table, ctx->heap, field->field_name, col_type,
    ...
    if (!(ctx->new_table->flags2 & DICT_TF2_USE_FILE_PER_TABLE) &&
        ha_alter_info->create_info->encrypt_type.length > 0 && !Encryption::is_none(encrypt))
    {
      dict_mem_table_free(ctx->new_table);
    ...
    error = row_create_table_for_mysql(ctx->new_table, compression, ctx->trx, false);

    punch_hole_warning = (error == DB_IO_NO_PUNCH_HOLE_FS) ? "Punch hole is not supported by the file system"
    ...
    switch (error)
    {
      ...
      case DB_IO_NO_PUNCH_HOLE_TABLESPACE:
        ...
        push_warning_printf(ctx->prebuilt->trx->mysql_thd, Sql_condition::SL_WARNING, HA_ERR_UNSUPPORTED,
                            "%s. Compression disabled for '%s'", punch_hole_warning, ctx->old_table->name.m_name);
      ...
      case DB_SUCCESS:
        ...
        the dict_sys->mutex. */
        ut_ad(mutex_own(&dict_sys->mutex));
        temp_table = dict_table_open_on_name(ctx->new_table->name.m_name, TRUE, FALSE, DICT_ERR_IGNORE_NONE);
    ...
    {
      add_cols = dtuple_create_with_vcol(ctx->heap, dict_table_get_n_cols(ctx->new_table),
    ...
    ctx->col_map = innobase_build_col_map(ha_alter_info, altered_table, old_table, ctx->new_table, user_table, add_cols,
                                          ctx->heap);
  ...
  else
  {
    ...
    for (dict_index_t *index = dict_table_get_first_index(user_table); index != NULL;
         index = dict_table_get_next_index(index))
    {
  ...
  {
    if (index_defs[a].ind_type & DICT_VIRTUAL && ctx->num_to_drop_vcol > 0 && !new_clustered)
    {
      innodb_v_adjust_idx_col(ha_alter_info, old_table, ctx->num_to_drop_vcol, &index_defs[a]);
    }

    ctx->add_index[a] = row_merge_create_index(ctx->trx, ctx->new_table, &index_defs[a], add_v);
    ...
    if (new_clustered || !ctx->online || user_table->ibd_file_missing || dict_table_is_discarded(user_table))
    {
    ...
    {
      DBUG_EXECUTE_IF("innodb_OOM_prepare_inplace_alter", error = DB_OUT_OF_MEMORY; goto error_handling;);
      rw_lock_x_lock(&ctx->add_index[a]->lock);
      bool ok = row_log_allocate(ctx->add_index[a], NULL, true, NULL, NULL, path);
  ...
  if (new_clustered)
  {
    ...
    dict_index_t *new_clust_index = dict_table_get_first_index(ctx->new_table);
    ctx->skip_pk_sort = innobase_pk_order_preserved(ctx->col_map, clust_index, new_clust_index);

    DBUG_EXECUTE_IF("innodb_alter_table_pk_assert_no_sort", assert(ctx->skip_pk_sort););

    if (ctx->online)
    {
      /* Allocate a log for online table rebuild. */
      rw_lock_x_lock(&clust_index->lock);
      bool ok = row_log_allocate(clust_index, ctx->new_table,
                                 !(ha_alter_info->handler_flags & Alter_inplace_info::ADD_PK_INDEX), ctx->add_cols,
                                 ctx->col_map, path);
  ...
  op_ok:
    ...
    if (new_clustered)
    {
      ...
      ctx->new_table->fts_doc_id_index = dict_table_get_index_on_name(ctx->new_table, FTS_DOC_ID_INDEX_NAME);
    ...
    DBUG_EXECUTE_IF("innodb_test_fail_after_fts_index_table", error = DB_LOCK_WAIT_TIMEOUT; goto error_handling;);
    ...
    if (!ctx->new_table->fts || ib_vector_size(ctx->new_table->fts->indexes) == 0)
    {
      error = fts_create_common_tables(ctx->trx, ctx->new_table, user_table->name.m_name, TRUE);

      DBUG_EXECUTE_IF("innodb_test_fail_after_fts_common_table", error = DB_LOCK_WAIT_TIMEOUT;);
      ...
      ctx->new_table->fts->fts_status |= TABLE_DICT_LOCKED;

      error =
          innobase_fts_load_stopword(ctx->new_table, ctx->trx, ctx->prebuilt->trx->mysql_thd) ? DB_SUCCESS : DB_ERROR;
      ctx->new_table->fts->fts_status &= ~TABLE_DICT_LOCKED;
                                       ...
                                       to drop */
{
  ...
  for (dict_foreign_set::const_iterator it = fks->begin(); it != fks->end(); ++it)
  {
    ...
    if (NULL == dict_foreign_find_index(indexed_table, col_names, foreign->referenced_col_names, foreign->n_fields,
                                        index,
                                        /*check_charsets=*/TRUE,
                                        /*check_null=*/FALSE) &&
        NULL == innobase_find_equiv_index(foreign->referenced_col_names, foreign->n_fields,
                                          ha_alter_info->key_info_buffer, ha_alter_info->index_add_buffer,
  ...
  for (dict_foreign_set::const_iterator it = fks->begin(); it != fks->end(); ++it)
  {
    ...
    if (!innobase_dropping_foreign(foreign, drop_fk, n_drop_fk) &&
        NULL == dict_foreign_find_index(indexed_table, col_names, foreign->foreign_col_names, foreign->n_fields, index,
                                        /*check_charsets=*/TRUE,
                                        /*check_null=*/FALSE) &&
        NULL == innobase_find_equiv_index(foreign->foreign_col_names, foreign->n_fields, ha_alter_info->key_info_buffer,
                                          ha_alter_info->index_add_buffer, ha_alter_info->index_add_count))
    {
      /* Index cannot be dropped. */
      trx->error_index = index;
...
@retval true Failure
@retval false Success */
static MY_ATTRIBUTE((warn_unused_result)) bool rename_index_in_data_dictionary(
    /*============================*/
    const dict_index_t *index, const char *new_name, trx_t *trx)
{
  ...
  DBUG_EXECUTE_IF("ib_rename_index_fail1", DBUG_SET("+d,innodb_report_deadlock"););
...
@retval true Failure
@retval false Success */
static MY_ATTRIBUTE((warn_unused_result)) bool rename_indexes_in_data_dictionary(
    /*==============================*/
    const ha_innobase_inplace_ctx *ctx, const Alter_inplace_info *ha_alter_info, trx_t *trx)
{
  ...
  for (ulint i = 0; i < ctx->num_to_rename; i++)
  {
    ...
    if (rename_index_in_data_dictionary(index, pair->new_key->name, trx))
    {
      /* failed */
      DBUG_RETURN(true);
    }
...
*/
static void rename_index_in_cache(
    /*==================*/
    dict_index_t *index, const char *new_name)
{
  ...
  else
  {
    ...
    3. go to 1. */
    index->name = mem_heap_strdup_replace(index->heap,
...
static void rename_indexes_in_cache(
    /*====================*/
    const ha_innobase_inplace_ctx *ctx, const Alter_inplace_info *ha_alter_info)
{
...
column information. */
static void alter_fill_stored_column(const TABLE *altered_table, dict_table_t *table, dict_s_col_list **s_cols,
                                     mem_heap_t **s_heap)
{
  ...
  for (ulint i = 0; i < n_cols; i++)
  {
    ...
    dict_col_t *col = dict_table_get_nth_col(table, stored_col_no);
    ...
    if (num_base != 0)
    {
      s_col.base_col = static_cast<dict_col_t **>(mem_heap_zalloc(*s_heap, num_base * sizeof(dict_col_t *)));
    }
    else
    {
      s_col.base_col = NULL;
    ...
    TABLE *altered_table, Alter_inplace_info *ha_alter_info)
{
...
#ifdef UNIV_DEBUG
  for (dict_index_t *index = dict_table_get_first_index(m_prebuilt->table); index;
       index = dict_table_get_next_index(index))
  {
  ...
  if (indexed_table->corrupted || dict_table_get_first_index(indexed_table) == NULL ||
      dict_index_is_corrupted(dict_table_get_first_index(indexed_table)))
  {
  ...
  bool is_file_per_table = !in_system_space && !DICT_TF_HAS_SHARED_SPACE(indexed_table->flags);
#ifdef UNIV_DEBUG
  bool in_general_space = !in_system_space && DICT_TF_HAS_SHARED_SPACE(indexed_table->flags);
  ...
  create_table_info_t info(m_user_thd, altered_table, ha_alter_info->create_info, NULL, NULL, NULL, NULL);
  ...
  if (innobase_index_name_is_reserved(m_user_thd, ha_alter_info->key_info_buffer, ha_alter_info->key_count))
  {
  err_exit_no_heap:
    assert(m_prebuilt->trx->dict_operation_lock_mode == 0);
    if (ha_alter_info->handler_flags & ~INNOBASE_INPLACE_IGNORE)
  ...
  {
    max_col_len = DICT_MAX_FIELD_LEN_BY_FORMAT_FLAG(m_prebuilt->table->flags);
  }
  ...
  if (!DICT_TF2_FLAG_IS_SET(indexed_table, DICT_TF2_FTS_AUX_HEX_NAME) && indexed_table->fts != NULL && add_fts_idx)
  {
  ...
  for (const dict_index_t *index = dict_table_get_first_index(indexed_table); index;
       index = dict_table_get_next_index(index))
  {
    if (index->type & DICT_FTS)
    {
      assert(index->type == DICT_FTS || (index->type & DICT_CORRUPT));
  ...
  if (ha_alter_info->handler_flags & (INNOBASE_ALTER_NOREBUILD | INNOBASE_ALTER_REBUILD))
  {
    heap = mem_heap_create(1024);

    if (ha_alter_info->handler_flags & Alter_inplace_info::ALTER_COLUMN_NAME)
    {
      col_names = innobase_get_col_names(ha_alter_info, altered_table, table, indexed_table, heap);
    }
    else
    {
      col_names = NULL;
  ...
  if (ha_alter_info->handler_flags & Alter_inplace_info::DROP_FOREIGN_KEY)
  {
    ...
    drop_fk = static_cast<dict_foreign_t **>(
        mem_heap_alloc(heap, ha_alter_info->alter_info->drop_list.elements * sizeof(dict_foreign_t *)));

    List_iterator<Alter_drop> drop_it(ha_alter_info->alter_info->drop_list);
    ...
    assert(n_drop_fk == ha_alter_info->alter_info->drop_list.elements);
  }
  else
  {
    drop_fk = NULL;
  ...
  if (ha_alter_info->index_drop_count)
  {
    ...
    assert(ha_alter_info->handler_flags & (Alter_inplace_info::DROP_INDEX | Alter_inplace_info::DROP_UNIQUE_INDEX |
                                           Alter_inplace_info::DROP_PK_INDEX));
    /* Check which indexes to drop. */
    drop_index =
        static_cast<dict_index_t **>(mem_heap_alloc(heap, (ha_alter_info->index_drop_count + 1) * sizeof *drop_index));

    for (uint i = 0; i < ha_alter_info->index_drop_count; i++)
    {
      const KEY *key = ha_alter_info->index_drop_buffer[i];
      dict_index_t *index = dict_table_get_index_on_name(indexed_table, key->name);

      if (!index)
      {
        push_warning_printf(m_user_thd, Sql_condition::SL_WARNING, HA_ERR_WRONG_INDEX,
    ...
    if (innobase_fulltext_exist(table) && !innobase_fulltext_exist(altered_table) &&
        !DICT_TF2_FLAG_IS_SET(indexed_table, DICT_TF2_FTS_HAS_DOC_ID))
    {
      ...
      for (uint i = 0; i < table->s->keys; i++)
      {
        if (!my_strcasecmp(system_charset_info, FTS_DOC_ID_INDEX_NAME, table->key_info[i].name))
        {
  ...
  check_if_can_drop_indexes:
    ...
    for (uint i = 0; i < n_drop_index; i++)
    {
      ...
      if (innobase_check_foreign_key_index(ha_alter_info, index, indexed_table, col_names, m_prebuilt->trx, drop_fk,
                                           n_drop_fk))
      {
    ...
    if (drop_primary && innobase_check_foreign_key_index(ha_alter_info, drop_primary, indexed_table, col_names,
  ...
  if (n_rename_index > 0)
  {
    rename_index = static_cast<dict_index_t **>(mem_heap_alloc(heap, n_rename_index * sizeof(*rename_index)));
    for (ulint i = 0; i < n_rename_index; i++)
    {
      dict_index_t *index;
      const char *old_name = ha_alter_info->index_rename_buffer[i].old_key->name;

      index = dict_table_get_index_on_name(indexed_table, old_name);

      if (index == NULL)
      {
        my_error(ER_KEY_DOES_NOT_EXITS, MYF(0), old_name, m_prebuilt->table->name.m_name);
        goto err_exit;
      }
  ...
  if (ha_alter_info->handler_flags & Alter_inplace_info::ADD_FOREIGN_KEY)
  {
    ...
    alter_fill_stored_column(altered_table, m_prebuilt->table, &s_cols, &s_heap);

    add_fk = static_cast<dict_foreign_t **>(
        mem_heap_zalloc(heap, ha_alter_info->alter_info->key_list.elements * sizeof(dict_foreign_t *)));

    if (!innobase_get_foreign_key_info(ha_alter_info, table_share, m_prebuilt->table, col_names, drop_index,
                                       n_drop_index, add_fk, &n_add_fk, m_prebuilt->trx, s_cols))
    {
    err_exit:
      if (n_drop_index)
      {
       ...
       !innobase_need_rebuild(ha_alter_info)))
  {
    if (heap)
    {
      ha_alter_info->handler_ctx = new ha_innobase_inplace_ctx(
          (*m_prebuilt_ptr), drop_index, n_drop_index, rename_index, n_rename_index, drop_fk, n_drop_fk, add_fk,
          n_add_fk, ha_alter_info->online, heap, indexed_table, col_names, ULINT_UNDEFINED, 0, 0, 0);
    }
  ...
  if (innobase_fulltext_exist(altered_table))
  {
    ...
    if (!innobase_fts_check_doc_id_col(m_prebuilt->table, altered_table, &fts_doc_col_no, &num_v))
    {
    ...
    switch (innobase_fts_check_doc_id_index(m_prebuilt->table, altered_table, &doc_col_no))
    {
  ...
  ha_alter_info->handler_ctx = new ha_innobase_inplace_ctx(
      (*m_prebuilt_ptr), drop_index, n_drop_index, rename_index, n_rename_index, drop_fk, n_drop_fk, add_fk, n_add_fk,
      ha_alter_info->online, heap, m_prebuilt->table, col_names, add_autoinc_col_no,
      ha_alter_info->create_info->auto_increment_value, autoinc_col_max_value, 0);

  DBUG_RETURN(prepare_inplace_alter_table_dict(ha_alter_info, altered_table, table, table_share->table_name.str,
                                               info.flags(), info.flags2(), fts_doc_col_no, add_fts_doc_id,
                                               add_fts_doc_id_idx));
}
...
{
  for (dict_index_t *index = dict_table_get_next_index(dict_table_get_first_index(table)); index != NULL;
       index = dict_table_get_next_index(index))
  {
    ...
    {
      dict_field_t *field = dict_index_get_nth_field(index, k);
...
static bool alter_templ_needs_rebuild(TABLE *altered_table, Alter_inplace_info *ha_alter_info, dict_table_t *table)
{
  ...
  for (Field **fp = altered_table->field; *fp; fp++, i++)
  {
    ...
    while (const Create_field *cf = cf_it++)
    {
      ...
      {
        dict_col_t *cols = dict_table_get_nth_col(table, j);
...
static const char *get_error_key_name(ulint error_key_num, const Alter_inplace_info *ha_alter_info,
    ...
    TABLE *altered_table, Alter_inplace_info *ha_alter_info)
{
  ...
  if ((ha_alter_info->handler_flags & ~INNOBASE_INPLACE_IGNORE) == Alter_inplace_info::CHANGE_CREATE_OPTION &&
      !innobase_need_rebuild(ha_alter_info))
  {
    goto ok_exit;
  }

  ha_innobase_inplace_ctx *ctx = static_cast<ha_innobase_inplace_ctx *>(ha_alter_info->handler_ctx);
  ...
  if (m_prebuilt->table->ibd_file_missing || dict_table_is_discarded(m_prebuilt->table))
  {
    goto all_done;
  }
  ...
  rebuild_templ =
      ctx->need_rebuild() || ((ha_alter_info->handler_flags & Alter_inplace_info::ALTER_COLUMN_EQUAL_PACK_LENGTH) &&
  ...
  if ((ctx->new_table->n_v_cols > 0) && rebuild_templ)
  {
    ...
    innobase_build_v_templ(altered_table, ctx->new_table, s_templ, NULL, false, NULL);
  ...
  else if (ctx->num_to_add_vcol > 0 && ctx->num_to_drop_vcol == 0)
  {
    ...
    innobase_build_v_templ(altered_table, ctx->new_table, s_templ, add_v, false, NULL);
    old_templ = ctx->new_table->vc_templ;
    ctx->new_table->vc_templ = s_templ;
  }
  ...
  DBUG_EXECUTE_IF("innodb_OOM_inplace_alter", error = DB_OUT_OF_MEMORY; goto oom;);
  error =
      row_merge_build_indexes(m_prebuilt->trx, m_prebuilt->table, ctx->new_table, ctx->online, ctx->add_index,
                              ctx->add_key_numbers, ctx->num_to_add_index, altered_table, ctx->add_cols, ctx->col_map,
                              ctx->add_autoinc, ctx->sequence, ctx->skip_pk_sort, ctx->m_stage, add_v, eval_table);
...
oom:
  ...
  if (error == DB_SUCCESS && ctx->online && ctx->need_rebuild())
  {
    ...
    error = row_log_table_apply(ctx->thr, m_prebuilt->table, altered_table, ctx->m_stage);
  }
  ...
  DBUG_EXECUTE_IF("create_index_fail", error = DB_DUPLICATE_KEY; m_prebuilt->trx->error_key_num = ULINT_UNDEFINED;);
  ...
  case DB_SUCCESS:
    ...
    goto ok_exit;
    case DB_DUPLICATE_KEY:
      if (m_prebuilt->trx->error_key_num == ULINT_UNDEFINED || ha_alter_info->key_count == 0)
      {
      ...
      {
        dup_key = &ha_alter_info->key_info_buffer[m_prebuilt->trx->error_key_num];
      }
      else
      {
        ...
        if (ctx->num_to_add_index > ha_alter_info->key_count)
        {
          ...
          dup_key = &ha_alter_info->key_info_buffer[m_prebuilt->trx->error_key_num - 1];
        }
        else
        {
          assert(m_prebuilt->trx->error_key_num < ha_alter_info->key_count);
    ...
    case DB_ONLINE_LOG_TOO_BIG:
      ...
      my_error(ER_INNODB_ONLINE_LOG_TOO_BIG, MYF(0),
               get_error_key_name(m_prebuilt->trx->error_key_num, ha_alter_info, m_prebuilt->table));
      break;
    case DB_INDEX_CORRUPT:
      ...
      break;
    default:
      my_error_innodb(error, table_share->table_name.str, m_prebuilt->table->flags);
  }
    ...
    dict_table_t *user_table, const TABLE *table, ibool locked, trx_t *trx)
{
  ...
  in the table */
  if (user_table->fts && !DICT_TF2_FLAG_IS_SET(user_table, DICT_TF2_FTS_HAS_DOC_ID) && !innobase_fulltext_exist(table))
  {
    fts_free(user_table);
  }
}
...
inline MY_ATTRIBUTE((warn_unused_result)) bool rollback_inplace_alter_table(
    /*=========================*/
    Alter_inplace_info *ha_alter_info, const TABLE *table, row_prebuilt_t *prebuilt)
{
  bool fail = false;
  ...
  if (ctx->need_rebuild())
  {
    ...
    {
      err = innobase_drop_fts_index_table(ctx->new_table, ctx->trx);
...
@retval true Failure
@retval false Success */
static MY_ATTRIBUTE((warn_unused_result)) bool innobase_drop_foreign_try(
    /*======================*/
    trx_t *trx, const char *table_name, const char *foreign_id)
{
  ...
  DBUG_EXECUTE_IF("ib_drop_foreign_error", error = DB_OUT_OF_FILE_SPACE;);
...
@retval true Failure
@retval false Success */
static MY_ATTRIBUTE((warn_unused_result)) bool innobase_rename_column_try(const dict_table_t *user_table, trx_t *trx,
                                                                          const char *table_name, ulint nth_col,
                                                                          const char *from, const char *to,
                                                                          bool new_clustered, bool is_virtual)
{
  pars_info_t *info;
  dberr_t error;
  ...
  DBUG_EXECUTE_IF("ib_rename_column_error", error = DB_OUT_OF_FILE_SPACE;);
  ...
  for (const dict_index_t *index = dict_table_get_first_index(user_table); index != NULL;
       index = dict_table_get_next_index(index))
  {
    for (ulint i = 0; i < dict_index_get_n_fields(index); i++)
    {
      if (strcmp(dict_index_get_nth_field(index, i)->name, from))
      {
        continue;
      }
...
rename_foreign:
  ...
  if (new_clustered)
  {
    std::for_each(fk_evict.begin(), fk_evict.end(), dict_foreign_remove_from_cache);
  }
...
@retval true Failure
@retval false Success */
static MY_ATTRIBUTE((warn_unused_result)) bool innobase_rename_columns_try(
    /*========================*/
    Alter_inplace_info *ha_alter_info, ha_innobase_inplace_ctx *ctx, const TABLE *table, trx_t *trx,
    const char *table_name)
{
  ...
  for (Field **fp = table->field; *fp; fp++, i++)
  {
    ...
    while (Create_field *cf = cf_it++)
    {
      if (cf->field == *fp)
      {
        ulint col_n = is_virtual ? dict_create_v_col_pos(num_v, i) : i - num_v;

        if (innobase_rename_column_try(ctx->old_table, trx, table_name, col_n, cf->field->field_name, cf->field_name,
                                       ctx->need_rebuild(), is_virtual))
        {
          return (true);
        }
        goto processed_field;
...
@retval true Failure
@retval false Success */
static MY_ATTRIBUTE((warn_unused_result)) bool innobase_enlarge_column_try(
    /*========================*/
    const dict_table_t *user_table, trx_t *trx, const char *table_name, ulint nth_col, ulint new_len, bool is_v)
{
  pars_info_t *info;
  dberr_t error;
#ifdef UNIV_DEBUG
  ...
  DBUG_EXECUTE_IF("ib_resize_column_error", error = DB_OUT_OF_FILE_SPACE;);
...
@retval true Failure
@retval false Success */
static MY_ATTRIBUTE((warn_unused_result)) bool innobase_enlarge_columns_try(
    /*=========================*/
    Alter_inplace_info *ha_alter_info, const TABLE *table, const dict_table_t *user_table, trx_t *trx,
    const char *table_name)
{
  List_iterator_fast<Create_field> cf_it(ha_alter_info->alter_info->create_list);
  ulint i = 0;
    ...
    while (Create_field *cf = cf_it++)
    {
      if (cf->field == *fp)
      {
        if ((*fp)->is_equal(cf) == IS_EQUAL_PACK_LENGTH &&
            innobase_enlarge_column_try(user_table, trx, table_name, idx, cf->length, is_v))
        {
          return (true);
        }
    ...
    Alter_inplace_info *ha_alter_info, const TABLE *table, dict_table_t *user_table)
{
  if (!(ha_alter_info->handler_flags &
        (Alter_inplace_info::ALTER_COLUMN_EQUAL_PACK_LENGTH | Alter_inplace_info::ALTER_COLUMN_NAME)))
  {
    return;
  }
  ...
  for (Field **fp = table->field; *fp; fp++, i++)
  {
    ...
    while (Create_field *cf = cf_it++)
    {
      ...
      if ((*fp)->is_equal(cf) == IS_EQUAL_PACK_LENGTH)
      {
        ...
        {
          dict_table_get_nth_col(user_table, col_n)->len = cf->length;
        }
      }

      if ((*fp)->flags & FIELD_IS_RENAMED)
      {
        dict_mem_table_col_rename(user_table, col_n, cf->field->field_name, cf->field_name, is_virtual);
      }
...
static MY_ATTRIBUTE((warn_unused_result)) bool commit_get_autoinc(
    /*===============*/
    Alter_inplace_info *ha_alter_info, ha_innobase_inplace_ctx *ctx, const TABLE *altered_table, const TABLE *old_table)
{
  ...
  else if ((ha_alter_info->handler_flags & Alter_inplace_info::CHANGE_CREATE_OPTION) &&
           (ha_alter_info->create_info->used_fields & HA_CREATE_USED_AUTO))
  {
    ...
    dict_index_t *index = dict_table_get_index_on_first_col(ctx->old_table, autoinc_field->field_index);

    ctx->max_autoinc = ha_alter_info->create_info->auto_increment_value;

    dict_table_autoinc_lock(ctx->old_table);

    err = row_search_max_autoinc(index, autoinc_field->field_name, &max_value_table);
    ...
    else if (ctx->max_autoinc <= max_value_table)
    {
      ...
      ctx->max_autoinc = innobase_next_autoinc(max_value_table, 1, 1, offset, col_max_value);
    }
    ...
    ha_innobase_inplace_ctx *ctx, trx_t *trx, const char *table_name)
{
  ...
  for (i = 0; i < ctx->num_to_add_fk; i++)
  {
    ...
    ut_ad(fk->foreign_table == ctx->new_table || fk->foreign_table == ctx->old_table);

    dberr_t error = dict_create_add_foreign_id(&foreign_id, ctx->old_table->name.m_name, fk);
    ...
    if (!fk->foreign_index)
    {
      fk->foreign_index = dict_foreign_find_index(
          ctx->new_table, ctx->col_names, fk->foreign_col_names, fk->n_fields, fk->referenced_index, TRUE,
          fk->type & (DICT_FOREIGN_ON_DELETE_SET_NULL | DICT_FOREIGN_ON_UPDATE_SET_NULL));
      if (!fk->foreign_index)
      {
    ...
    been renamed yet. */
    error = dict_create_add_foreign_to_dictionary(ctx->old_table->name.m_name, fk, trx);
...
static MY_ATTRIBUTE((warn_unused_result)) dberr_t innobase_update_foreign_cache(
    /*==========================*/
    ha_innobase_inplace_ctx *ctx, THD *user_thd)
{
  dict_table_t *user_table;
  dberr_t err = DB_SUCCESS;
  ...
  err = dict_load_foreigns(user_table->name.m_name, ctx->col_names, false, true, DICT_ERR_IGNORE_NONE, fk_tables);
  ...
  if (err == DB_CANNOT_ADD_CONSTRAINT)
  {
    ...
    err = dict_load_foreigns(user_table->name.m_name, ctx->col_names, false, false, DICT_ERR_IGNORE_NONE, fk_tables);
  ...
  {
    dict_table_t *table = dict_load_table(fk_tables.front(), true, DICT_ERR_IGNORE_NONE);

    if (table == NULL)
    {
      table_name_t table_name;
      table_name.m_name = const_cast<char *>(fk_tables.front());

      err = DB_TABLE_NOT_FOUND;
      ib::error() << "Failed to load table '" << table_name << "' which has a foreign key constraint with"
...
inline MY_ATTRIBUTE((warn_unused_result)) bool commit_try_rebuild(
    /*===============*/
    Alter_inplace_info *ha_alter_info, ha_innobase_inplace_ctx *ctx, TABLE *altered_table, const TABLE *old_table,
    trx_t *trx, const char *table_name)
{
  ...
  assert(!(ha_alter_info->handler_flags & Alter_inplace_info::DROP_FOREIGN_KEY) || ctx->num_to_drop_fk > 0);

  for (dict_index_t *index = dict_table_get_first_index(rebuilt_table); index; index = dict_table_get_next_index(index))
  {
  ...
  if (ctx->online)
  {
    ...
    if (ctx->new_table->n_v_cols > 0)
    {
      ...
      innobase_build_v_templ(altered_table, ctx->new_table, s_templ, NULL, true, NULL);
      ctx->new_table->vc_templ = s_templ;
    }

    error = row_log_table_apply(ctx->thr, user_table, altered_table,
                                static_cast<ha_innobase_inplace_ctx *>(ha_alter_info->handler_ctx)->m_stage);
    ...
    switch (error)
    {
      ...
      case DB_DUPLICATE_KEY:
        ...
        DBUG_RETURN(true);
      case DB_ONLINE_LOG_TOO_BIG:
        my_error(ER_INNODB_ONLINE_LOG_TOO_BIG, MYF(0), get_error_key_name(err_key, ha_alter_info, rebuilt_table));
        DBUG_RETURN(true);
      case DB_INDEX_CORRUPT:
        my_error(ER_INDEX_CORRUPT, MYF(0), get_error_key_name(err_key, ha_alter_info, rebuilt_table));
        DBUG_RETURN(true);
      default:
        my_error_innodb(error, table_name, user_table->flags);
        DBUG_RETURN(true);
  ...
  error = row_merge_rename_tables_dict(user_table, rebuilt_table, ctx->tmp_name, trx);
    ...
    ha_innobase_inplace_ctx *ctx)
{
  ...
  assert(ctx->need_rebuild());
  assert(dict_table_is_discarded(ctx->old_table) == dict_table_is_discarded(ctx->new_table));

  const char *old_name = mem_heap_strdup(ctx->heap, ctx->old_table->name.m_name);
...
@param[in, out]	drop_v_col_list	list which will be set, containing
                                ...
                                being dropped */
static void get_col_list_to_be_dropped(const ha_innobase_inplace_ctx *ctx, col_set &drop_col_list,
                                       col_set &drop_v_col_list)
{
  for (ulint index_count = 0; index_count < ctx->num_to_drop_index; index_count++)
  {
    const dict_index_t *index = ctx->drop_index[index_count];

    for (ulint col = 0; col < index->n_user_defined_cols; col++)
    {
      const dict_col_t *idx_col = dict_index_get_nth_col(index, col);
    ...
    trx_t *trx, const char *table_name)
{
  ...
  assert(trx->dict_operation_lock_mode == RW_X_LATCH);
  assert(!(ha_alter_info->handler_flags & Alter_inplace_info::DROP_FOREIGN_KEY) || ctx->num_to_drop_fk > 0);
  assert(ctx->num_to_drop_fk == ha_alter_info->alter_info->drop_list.elements ||
         ctx->num_to_drop_vcol == ha_alter_info->alter_info->drop_list.elements);
  ...
  for (ulint i = 0; i < ctx->num_to_add_index; i++)
  {
    ...
    assert(dict_index_get_online_status(index) == ONLINE_INDEX_COMPLETE);
    assert(!index->is_committed());
    error = row_merge_rename_index_to_add(trx, ctx->new_table->id, index->id);
    switch (error)
    {
      case DB_SUCCESS:
        break;
      case DB_TOO_MANY_CONCURRENT_TRXS:
        ...
        DBUG_RETURN(true);
      default:
        sql_print_error("InnoDB: rename index to add: %lu\n", (ulong)error);
        assert(0);
        my_error(ER_INTERNAL_ERROR, MYF(0), "rename index to add");
        DBUG_RETURN(true);
    }
  }
  ...
  for (ulint i = 0; i < ctx->num_to_drop_index; i++)
  {
    ...
    error = row_merge_rename_index_to_drop(trx, index->table->id, index->id);
    if (error != DB_SUCCESS)
    {
      sql_print_error("InnoDB: rename index to drop: %lu\n", (ulong)error);
      assert(0);
      my_error(ER_INTERNAL_ERROR, MYF(0), "rename index to drop");
      DBUG_RETURN(true);
    }
  }
  ...
  if ((ha_alter_info->handler_flags & Alter_inplace_info::ALTER_COLUMN_EQUAL_PACK_LENGTH) &&
      innobase_enlarge_columns_try(ha_alter_info, old_table, ctx->old_table, trx, table_name))
  {
    DBUG_RETURN(true);
  }
  ...
  if ((ha_alter_info->handler_flags & Alter_inplace_info::DROP_VIRTUAL_COLUMN) &&
      innobase_drop_virtual_try(ha_alter_info, altered_table, old_table, ctx->old_table, trx))
  {
    DBUG_RETURN(true);
  }

  if ((ha_alter_info->handler_flags & Alter_inplace_info::ADD_VIRTUAL_COLUMN) &&
      innobase_add_virtual_try(ha_alter_info, altered_table, old_table, ctx->old_table, trx))
  {
    DBUG_RETURN(true);
  }
    ...
    ha_innobase_inplace_ctx *ctx, const TABLE *table, trx_t *trx)
{
  ...
  ctx->new_table->fts_doc_id_index =
      ctx->new_table->fts ? dict_table_get_index_on_name(ctx->new_table, FTS_DOC_ID_INDEX_NAME) : NULL;
#ifdef UNIV_DEBUG
  if (!(ctx->new_table->fts != NULL && ctx->new_table->fts->cache->sync->in_progress))
  {
    assert((ctx->new_table->fts == NULL) == (ctx->new_table->fts_doc_id_index == NULL));
  }
#endif
  DBUG_RETURN(found);
}
...
static void alter_stats_norebuild(
    /*==================*/
    Alter_inplace_info *ha_alter_info, ha_innobase_inplace_ctx *ctx, TABLE *altered_table, const char *table_name,
    THD *thd)
{
  ulint i;
  ...
  for (i = 0; i < ha_alter_info->index_drop_count; i++)
  {
    ...
    if (dict_stats_drop_index(ctx->new_table->name.m_name, key->name, errstr, sizeof errstr) != DB_SUCCESS)
    {
  ...
  for (i = 0; i < ha_alter_info->index_rename_count; i++)
  {
    ...
    err = dict_stats_rename_index(ctx->new_table, pair->old_key->name, pair->new_key->name);
    ...
    if (err != DB_SUCCESS)
    {
      push_warning_printf(thd, Sql_condition::SL_WARNING, ER_ERROR_ON_RENAME,
                          ...
                          table_name, pair->old_key->name, pair->new_key->name, ut_strerr(err));
    }
  }
    ...
    dict_table_t *table, const char *table_name, THD *thd)
{
  ...
  if (dict_table_is_discarded(table) || !dict_stats_is_persistent_enabled(table))
  {
    DBUG_VOID_RETURN;
  }
  ...
  DBUG_EXECUTE_IF("ib_rename_index_fail2", ibd_file_missing_orig = table->ibd_file_missing;
                  table->ibd_file_missing = TRUE;);

  dberr_t ret = dict_stats_update(table, DICT_STATS_RECALC_PERSISTENT);

  DBUG_EXECUTE_IF("ib_rename_index_fail2", table->ibd_file_missing = ibd_file_missing_orig;);
    ...
    TABLE *altered_table, Alter_inplace_info *ha_alter_info, bool commit)
{
  ...
  if (!commit)
  {
    ...
    const bool ret = rollback_inplace_alter_table(ha_alter_info, table, m_prebuilt);
    DBUG_RETURN(ret);
  }
  ...
  for (inplace_alter_handler_ctx **pctx = &ctx_array[1]; *pctx; pctx++)
  {
    ha_innobase_inplace_ctx *ctx = static_cast<ha_innobase_inplace_ctx *>(*pctx);
  ...
  for (inplace_alter_handler_ctx **pctx = ctx_array; *pctx && !fail; pctx++)
  {
    ...
    if (ctx->need_rebuild())
    {
      ctx->tmp_name = dict_mem_create_temporary_tablename(ctx->heap, ctx->new_table->name.m_name, ctx->new_table->id);

      fail = commit_try_rebuild(ha_alter_info, ctx, altered_table, table, trx, table_share->table_name.str);
    }
    else
    {
      fail = commit_try_norebuild(ha_alter_info, ctx, altered_table, table, trx, table_share->table_name.str);
    }
...
#ifndef NDEBUG
    {
      ...
      ut_snprintf(buf, sizeof buf, "ib_commit_inplace_fail_%u", failure_inject_count++);

      DBUG_EXECUTE_IF(buf, my_error(ER_INTERNAL_ERROR, MYF(0), "Injected error!"); fail = true;);
    }
#endif
  }
rollback_trx:
  ...
  else
  {
    ...
    for (inplace_alter_handler_ctx **pctx = ctx_array; *pctx; pctx++)
    {
      ...
      error = fil_mtr_rename_log(ctx->old_table, ctx->new_table, ctx->tmp_name, &mtr);
      if (error != DB_SUCCESS)
      {
        /* Out of memory or a problem will occur
        when renaming files. */
        fail = true;
        my_error_innodb(error, ctx->old_table->name.m_name, ctx->old_table->flags);
      }
      DBUG_INJECT_CRASH("ib_commit_inplace_crash", crash_inject_count++);
    }
    ...
    DBUG_EXECUTE_IF("innodb_alter_commit_crash_before_commit", log_buffer_flush_to_disk(); DBUG_SUICIDE(););
    ut_ad(!trx->fts_trx);
    ...
    else
    {
      ...
      {
        ut_ad(*mtr.get_log()->front()->begin() == MLOG_FILE_RENAME2);
        ...
        static const byte multi = MLOG_MULTI_REC_END;
    ...
    DBUG_EXECUTE_IF("innodb_alter_commit_crash_after_commit", log_make_checkpoint_at(LSN_MAX, TRUE);
  ...
  for (inplace_alter_handler_ctx **pctx = ctx_array; *pctx; pctx++)
  {
    ...
    if (fail)
    {
      ...
      DBUG_INJECT_CRASH("ib_commit_inplace_crash_fail", crash_fail_inject_count++);
    ...
    for (int retry_count = 0;;)
    {
      ...
      {
        ib::info() << "Drop index waiting for background sync to finish\n";
        retry_count = 0;
      }
    ...
    else
    {
      ...
      else
      {
        ...
        innobase_rename_or_enlarge_columns_cache(ha_alter_info, table, ctx->new_table);
  ...
  if (ctx0->num_to_drop_vcol || ctx0->num_to_add_vcol)
  {
    ...
    m_prebuilt->table = dict_table_open_on_name(tb_name, TRUE, TRUE, DICT_ERR_IGNORE_NONE);

    /* Drop outdated table stats. */
    char errstr[1024];
    if (dict_stats_drop_table(m_prebuilt->table->name.m_name, errstr, sizeof(errstr)) != DB_SUCCESS)
    {
      push_warning_printf(m_user_thd, Sql_condition::SL_WARNING, ER_ALTER_INFO,
  ...
  for (inplace_alter_handler_ctx **pctx = ctx_array; *pctx; pctx++)
  {
    ...
    if (new_clustered)
    {
      ...
      DBUG_EXECUTE_IF("ib_rename_index_fail3", DBUG_SET("+d,innodb_report_deadlock"););

      if (dict_stats_is_persistent_enabled(ctx->new_table) &&
          dict_stats_drop_table(ctx->new_table->name.m_name, errstr, sizeof(errstr)) != DB_SUCCESS)
      {
        push_warning_printf(m_user_thd, Sql_condition::SL_WARNING, ER_ALTER_INFO,
                            "Deleting persistent statistics"
      ...
      ctx->prebuilt = row_create_prebuilt(ctx->new_table, altered_table->s->reclength);
  ...
  else
  {
    for (inplace_alter_handler_ctx **pctx = ctx_array; *pctx; pctx++)
    {
      ...
      alter_stats_norebuild(ha_alter_info, ctx, altered_table, table->s->table_name.str, m_user_thd);
      DBUG_INJECT_CRASH("ib_commit_inplace_crash", crash_inject_count++);
    }
  }
  ...
  innobase_parse_hint_from_comment(m_user_thd, m_prebuilt->table, altered_table->s);

  /* TODO: Also perform DROP TABLE and DROP INDEX after
  the MDL downgrade. */

#ifndef NDEBUG
  dict_index_t *clust_index = dict_table_get_first_index(ctx0->prebuilt->table);
  assert(!clust_index->online_log);
  assert(dict_index_get_online_status(clust_index) == ONLINE_INDEX_COMPLETE);

  for (dict_index_t *index = clust_index; index; index = dict_table_get_next_index(index))
  {
    assert(!index->to_be_dropped);
  }
#endif /* NDEBUG */
...
class ha_innopart_inplace_ctx : public inplace_alter_handler_ctx
{
 ...
 public:
  ...
  ha_innopart_inplace_ctx(THD *thd, uint tot_parts)
      : inplace_alter_handler_ctx(), m_tot_parts(tot_parts), ctx_array(), prebuilt_array()
  {
  }
                                                                        ...
                                                                        Alter_inplace_info *ha_alter_info)
{
  ...
  if (ha_alter_info->handler_flags & (Alter_inplace_info::ADD_FOREIGN_KEY | Alter_inplace_info::DROP_FOREIGN_KEY))
  {
    ha_alter_info->unsupported_reason = innobase_get_err_msg(ER_FOREIGN_KEY_ON_PARTITIONED);
    DBUG_RETURN(HA_ALTER_INPLACE_NOT_SUPPORTED);
  }
  ...
  if ((ha_alter_info->handler_flags & Alter_inplace_info::ADD_INDEX))
  {
    for (uint i = 0; i < ha_alter_info->index_add_count; i++)
    {
      ...
      {
        assert(!(key->flags & HA_KEYFLAG_MASK & ~(HA_FULLTEXT | HA_PACK_KEY | HA_GENERATED_KEY | HA_BINARY_PACK_KEY)));
        ha_alter_info->unsupported_reason = innobase_get_err_msg(ER_FULLTEXT_NOT_SUPPORTED_WITH_PARTITIONING);
        DBUG_RETURN(HA_ALTER_INPLACE_NOT_SUPPORTED);
      }
    }
  }
  ...
  if ((ha_alter_info->handler_flags & Alter_inplace_info::ALTER_STORED_COLUMN_ORDER) &&
      !m_part_info->same_key_column_order(&ha_alter_info->alter_info->create_list))
  {
    DBUG_RETURN(HA_ALTER_INPLACE_NOT_SUPPORTED);
  }
  ...
  if ((ha_alter_info->handler_flags & (Alter_inplace_info::ADD_PK_INDEX | Alter_inplace_info::DROP_PK_INDEX)))
  {
    ...
    if ((m_part_info->subpart_type == HASH_PARTITION) && m_part_info->list_of_subpart_fields &&
  ...
  set_partition(0);
  DBUG_RETURN(ha_innobase::check_if_supported_inplace_alter(altered_table, ha_alter_info));
}
...
@retval true Failure.
@retval false Success. */
bool ha_innopart::prepare_inplace_alter_table(TABLE *altered_table, Alter_inplace_info *ha_alter_info)
{
  THD *thd;
  ...
  {
    push_deprecated_warn_no_replacement(ha_thd(), PARTITION_IN_SHARED_TABLESPACE_WARNING);
  }
  ...
  uint ctx_array_size = sizeof(inplace_alter_handler_ctx *) * (m_tot_parts + 1);
  ctx_parts->ctx_array = static_cast<inplace_alter_handler_ctx **>(ut_malloc(ctx_array_size, mem_key_partitioning));
  ...
  ctx_parts->prebuilt_array =
      static_cast<row_prebuilt_t **>(ut_malloc(sizeof(row_prebuilt_t *) * m_tot_parts, mem_key_partitioning));
  ...
  for (uint i = 1; i < m_tot_parts; i++)
  {
    ...
    tmp_prebuilt = row_create_prebuilt(m_part_share->get_table_part(i), table_share->reclength);
  ...
  for (uint i = 0; i < m_tot_parts; i++)
  {
    ...
    ha_alter_info->create_info->data_file_name = m_prebuilt->table->data_dir_path;

    res = ha_innobase::prepare_inplace_alter_table(altered_table, ha_alter_info);
    update_partition(i);
...
@retval true Failure.
@retval false Success. */
bool ha_innopart::inplace_alter_table(TABLE *altered_table, Alter_inplace_info *ha_alter_info)
{
  bool res = true;
  ha_innopart_inplace_ctx *ctx_parts;

  ctx_parts = static_cast<ha_innopart_inplace_ctx *>(ha_alter_info->handler_ctx);
  for (uint i = 0; i < m_tot_parts; i++)
  {
    m_prebuilt = ctx_parts->prebuilt_array[i];
    ha_alter_info->handler_ctx = ctx_parts->ctx_array[i];
    ...
    res = ha_innobase::inplace_alter_table(altered_table, ha_alter_info);
...
@retval true Failure.
@retval false Success. */
bool ha_innopart::commit_inplace_alter_table(TABLE *altered_table, Alter_inplace_info *ha_alter_info, bool commit)
{
  bool res = false;
  ha_innopart_inplace_ctx *ctx_parts;
  ...
  if (commit)
  {
    ...
    set_partition(0);
    res = ha_innobase::commit_inplace_alter_table(altered_table, ha_alter_info, commit);
  ...
  for (uint i = 0; i < m_tot_parts; i++)
  {
    ...
    ha_alter_info->handler_ctx = ctx_parts->ctx_array[i];
    set_partition(i);
    if (ha_innobase::commit_inplace_alter_table(altered_table, ha_alter_info, commit))
    {
      res = true;
    }
    ut_ad(ctx_parts->ctx_array[i] == ha_alter_info->handler_ctx);
...
void ha_innopart::notify_table_changed()
{
  char tmp_par_path[FN_REFLEN + 1];
  strxnmov(tmp_par_path, FN_REFLEN, table->s->normalized_path.str, ".par", NullS);
...
ib_sequence_t::ib_sequence_t(THD *thd, ulonglong start_value, ulonglong max_value)
    : m_max_value(max_value), m_increment(0), m_offset(0), m_next_value(start_value), m_eof(false)
{
  if (thd != 0 && m_max_value > 0)
  {
    ...
    if (m_increment > 1 || m_offset > 1)
    {
      ...
      m_next_value = innobase_next_autoinc(start_value, 1, m_increment, m_offset, m_max_value);
    }
...
ulonglong ib_sequence_t::operator++(int) UNIV_NOTHROW
{
  ...
  m_next_value = innobase_next_autoinc(current, 1, m_increment, m_offset, m_max_value);
