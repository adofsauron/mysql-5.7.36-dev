...
ibool ibuf_page_low(const page_id_t &page_id, const page_size_t &page_size,
                    ...
                    ibool x_latch,
#endif /* UNIV_DEBUG */
                    const char *file, ulint line, mtr_t *mtr) MY_ATTRIBUTE((warn_unused_result));
...
@return TRUE if level 2 or level 3 page */
#define ibuf_page(page_id, page_size, mtr) ibuf_page_low(page_id, page_size, TRUE, __FILE__, __LINE__, mtr)
...
@param[in,out]	mtr		mini-transaction or NULL
@return TRUE if level 2 or level 3 page */
#define ibuf_page(page_id, page_size, mtr) ibuf_page_low(page_id, page_size, __FILE__, __LINE__, mtr)
