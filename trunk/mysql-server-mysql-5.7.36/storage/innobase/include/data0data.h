...
UNIV_INLINE
void dfield_set_spatial_status(dfield_t *field, spatial_status_t spatial_status);
...
UNIV_INLINE
dtuple_t *dtuple_create_from_mem(void *buf, ulint buf_size, ulint n_fields, ulint n_v_fields)
    MY_ATTRIBUTE((warn_unused_result));
/**********************************************************/ /**
...
@return own: created tuple */
UNIV_INLINE
dtuple_t *dtuple_create_with_vcol(mem_heap_t *heap, ulint n_fields, ulint n_v_fields);
...
respectively */
int dtuple_coll_cmp(const dtuple_t *tuple1, const dtuple_t *tuple2) MY_ATTRIBUTE((warn_unused_result));
...
UNIV_INLINE
ulint dtuple_fold(const dtuple_t *tuple, ulint n_fields, ulint n_bytes, index_id_t tree_id)
    MY_ATTRIBUTE((warn_unused_result));
/*******************************************************************/ /**
...
struct big_rec_field_t
{
  ...
  big_rec_field_t(ulint field_no_, ulint len_, const void *data_) : field_no(field_no_), len(len_), data(data_) {}
...
struct big_rec_t
{
  ...
  explicit big_rec_t(const ulint max) : heap(0), capacity(max), n_fields(0), fields(0) {}
