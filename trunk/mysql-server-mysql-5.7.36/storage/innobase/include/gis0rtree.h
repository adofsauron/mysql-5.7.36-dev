...
#define RTREE_SEARCH_MODE(mode) (((mode) >= PAGE_CUR_CONTAIN) && ((mode <= PAGE_CUR_RTREE_GET_FATHER)))
...
void rtr_non_leaf_insert_stack_push(
    /*===========================*/
    dict_index_t *index,      /*!< in: index descriptor */
    rtr_node_path_t *path,    /*!< in/out: search path */
    ulint level,              /*!< in: index level */
...
#define rtr_pcur_open(i, t, md, l, c, m) rtr_pcur_open_low(i, 0, t, md, l, c, __FILE__, __LINE__, m)
