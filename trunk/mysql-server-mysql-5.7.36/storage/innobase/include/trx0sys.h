...
UNIV_INLINE
bool trx_sys_is_noredo_rseg_slot(
    /*========================*/
...
UNIV_INLINE
ulint trx_sys_get_n_rw_trx(void);
/*======================*/
...
#define TRX_SYS_FILE_FORMAT_TAG_MAGIC_N \
  ((ib_uint64_t)TRX_SYS_FILE_FORMAT_TAG_MAGIC_N_HIGH << 32 | TRX_SYS_FILE_FORMAT_TAG_MAGIC_N_LOW)
/* @} */
