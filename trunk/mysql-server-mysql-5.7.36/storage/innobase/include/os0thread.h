...
#define os_thread_create(f, a, i) os_thread_create_func(reinterpret_cast<os_thread_func_t>(f), a, i)
...
void os_thread_exit(bool detach = true) UNIV_COLD MY_ATTRIBUTE((noreturn));
