...
#define btr_cur_open_at_index_side_with_no_latch(f, i, c, lv, m) \
  btr_cur_open_at_index_side_with_no_latch_func(f, i, c, lv, __FILE__, __LINE__, m)
...
#else /* UNIV_DEBUG */
#define btr_cur_optimistic_delete(cursor, flags, mtr) btr_cur_optimistic_delete_func(cursor, mtr)
#endif                                                          /* UNIV_DEBUG */
/*************************************************************/ /**
