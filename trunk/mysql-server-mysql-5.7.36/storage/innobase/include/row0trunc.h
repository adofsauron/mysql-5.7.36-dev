...
class truncate_t
{
 public:
  ...
  truncate_t(table_id_t old_table_id, table_id_t new_table_id, const char *dir_path);
  ...
  truncate_t(ulint space_id, const char *name, ulint tablespace_flags, ulint log_flags, lsn_t recv_lsn);
  ...
  table_id_t old_table_id() const { return (m_old_table_id); }

  /**
  @return new table id of the table to truncate */
  table_id_t new_table_id() const { return (m_new_table_id); }
  ...
  dberr_t update_root_page_no(trx_t *trx, table_id_t table_id, ibool reserve_dict_mutex,
  ...
  ulint create_index(const char *table_name, ulint space_id, const page_size_t &page_size, ulint index_type,
  ...
  @return DB_SUCCESS or error code. */
  dberr_t create_indexes(const char *table_name, ulint space_id, const page_size_t &page_size, ulint flags,
                         ulint format_flags);
  ...
  bool is_index_modified_since_logged(ulint space_id, ulint root_page_no) const;
  ...
  @return DB_SUCCESS or error code */
  dberr_t parse(byte *start_ptr, const byte *end_ptr);
  ...
  static byte *parse_redo_entry(byte *start_ptr, const byte *end_ptr, ulint space_id);
  ...
  dberr_t write(byte *start_ptr, byte *end_ptr, ulint space_id, const char *tablename, ulint flags, ulint format_flags,
                lsn_t lsn) const;
  ...
  static dberr_t truncate(ulint space_id, const char *dir_path, const char *tablename, ulint flags, bool default_size);
 ...
 private:
  ...
  typedef std::vector<truncate_t *, ut_allocator<truncate_t *>> tables_t;
...
class TruncateLogParser
{
 public:
  ...
  @return DB_SUCCESS or error code. */
  static dberr_t scan_and_parse(const char *dir_path);

 private:
  typedef std::vector<char *, ut_allocator<char *>> trunc_log_files_t;
 ...
 private:
  ...
  @return DB_SUCCESS or error code. */
  static dberr_t scan(const char *dir_path, trunc_log_files_t &log_files);
  ...
  @return DB_SUCCESS or error code. */
  static dberr_t parse(const char *log_file_name);
};
