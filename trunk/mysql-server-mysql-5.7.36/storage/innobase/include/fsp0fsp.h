...
UNIV_INLINE
ulint fsp_get_extent_size_in_pages(const page_size_t &page_size)
{
...
inline ulint fsp_header_get_field(const page_t *page, ulint field)
{
...
inline ulint fsp_header_get_flags(const page_t *page) { return (fsp_header_get_field(page, FSP_SPACE_FLAGS)); }
...
UNIV_INLINE
ulint fsp_flags_init(const page_size_t &page_size, bool atomic_blobs, bool has_data_dir, bool is_shared,
                     bool is_temporary, bool is_encrypted = false);
...
UNIV_INLINE
ulint xdes_calc_descriptor_page(const page_size_t &page_size, ulint offset);
#endif /* !UNIV_INNOCHECKSUM */
