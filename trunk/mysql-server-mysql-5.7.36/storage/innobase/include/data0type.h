...
#define DATA_LARGE_MTYPE(mtype) ((mtype) == DATA_BLOB || (mtype) == DATA_VAR_POINT || (mtype) == DATA_GEOMETRY)
...
#define DATA_LARGE_BINARY(mtype, prtype) \
  ((mtype) == DATA_GEOMETRY || ((mtype) == DATA_BLOB && !((prtype)&DATA_BINARY_TYPE)))
