...
#ifdef UNIV_DEBUG
#define rw_lock_create(K, L, level) rw_lock_create_func((L), (level), #L, __FILE__, __LINE__)
#else /* UNIV_DEBUG */
...
#define rw_lock_sx_lock_inline(M, P, F, L) rw_lock_sx_lock_func((M), (P), (F), (L))

#define rw_lock_sx_lock_gen(M, P) rw_lock_sx_lock_func((M), (P), __FILE__, __LINE__)

#define rw_lock_sx_lock_nowait(M, P) rw_lock_sx_lock_func_nowait((M), (P), __FILE__, __LINE__)
...
#define rw_lock_x_lock_inline(M, P, F, L) rw_lock_x_lock_func((M), (P), (F), (L))
...
#define rw_lock_x_lock_func_nowait_inline(M, F, L) rw_lock_x_lock_func_nowait((M), (F), (L))
...
#else /* UNIV_DEBUG */
#define rw_lock_create(K, L, level) pfs_rw_lock_create_func((K), (L), __FILE__, __LINE__)
#endif /* UNIV_DEBUG */
...
#define rw_lock_sx_lock_nowait(M, P) pfs_rw_lock_sx_lock_func_nowait((M), (P), __FILE__, __LINE__)
...
/******************************************************************/ /**
 ...
 this function! */
UNIV_INLINE
ibool pfs_rw_lock_sx_lock_func_nowait(
    /*===========================*/
    rw_lock_t *lock,                                                 /*!< in: pointer to rw-lock */
    ulint pass,                                                      /*!< in: pass value; != 0, if the lock will
                                                                     be passed to another thread to unlock */
