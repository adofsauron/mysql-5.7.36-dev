...
#define BTR_LATCH_MODE_WITHOUT_FLAGS(latch_mode)                                                             \
  ((latch_mode) & ~(BTR_INSERT | BTR_DELETE_MARK | BTR_RTREE_UNDO_INS | BTR_RTREE_DELETE_MARK | BTR_DELETE | \
                    BTR_ESTIMATE | BTR_IGNORE_SEC_UNIQUE | BTR_ALREADY_S_LATCHED | BTR_LATCH_FOR_INSERT |    \
                    BTR_LATCH_FOR_DELETE | BTR_MODIFY_EXTERNAL))

#define BTR_LATCH_MODE_WITHOUT_INTENTION(latch_mode) \
  ((latch_mode) & ~(BTR_LATCH_FOR_INSERT | BTR_LATCH_FOR_DELETE | BTR_MODIFY_EXTERNAL))
...
#define btr_assert_not_corrupted(block, index)                                                  \
  if ((ibool) !!page_is_comp(buf_block_get_frame(block)) != dict_table_is_comp((index)->table)) \
  {                                                                                             \
...
@return block */
UNIV_INLINE
buf_block_t *btr_block_get_func(const page_id_t &page_id, const page_size_t &page_size, ulint mode, const char *file,
                                ulint line,
#ifdef UNIV_DEBUG
...
/**************************************************************/ /**
 ...
 @return index id */
UNIV_INLINE
index_id_t btr_page_get_index_id(
    /*==================*/
