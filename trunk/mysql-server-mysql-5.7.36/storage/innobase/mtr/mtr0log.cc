    ...
    void *page_zip) /*!< in/out: compressed page, or NULL */
{
  ...
  ut_a(!page || !page_zip || (fil_page_get_type(page) != FIL_PAGE_INDEX && fil_page_get_type(page) != FIL_PAGE_RTREE));
    ...
    dict_index_t **index) /*!< out, own: dummy index */
{
  ...
  table = dict_mem_table_create("LOG_DUMMY", DICT_HDR_SPACE, n, 0, comp ? DICT_TF_COMPACT : 0, 0);
  ...
  if (comp)
  {
    for (i = 0; i < n; i++)
    {
      ...
      dict_mem_table_add_col(table, NULL, NULL, ((len + 1) & 0x7fff) <= 1 ? DATA_BINARY : DATA_FIXBINARY,
