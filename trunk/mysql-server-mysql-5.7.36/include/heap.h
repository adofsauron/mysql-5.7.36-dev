  ...
  */
  ...
  typedef struct st_hp_keydef /* Key definition with open */
  {
    ...
    */
    ...
    int (*delete_key)(struct st_heap_info *info, struct st_hp_keydef *keyinfo, const uchar *record, uchar *recpos,
                      int flag);
  ...
  extern int heap_create(const char *name, HP_CREATE_INFO *create_info, HP_SHARE **share, my_bool *created_new_share);
  ...
  int heap_rkey(HP_INFO *info, uchar *record, int inx, const uchar *key, key_part_map keypart_map,
