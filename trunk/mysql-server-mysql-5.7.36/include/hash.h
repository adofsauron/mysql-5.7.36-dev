...
#define HASH_UNIQUE 1 /* hash_insert fails on duplicate key */
  ...
  /**
    ...
    as parameters.
  */
  typedef my_hash_value_type (*my_hash_function)(const struct st_hash *, const uchar *, size_t);
...
#define my_hash_init(A, B, C, D, E, F, G, H, I) _my_hash_init(A, 0, B, NULL, C, D, E, F, G, H, I)
#define my_hash_init2(A, B, C, D, E, F, G, H, I, J) _my_hash_init(A, B, C, NULL, D, E, F, G, H, I, J)
#define my_hash_init3(A, B, C, D, E, F, G, H, I, J, K) _my_hash_init(A, B, C, D, E, F, G, H, I, J, K)
  my_bool _my_hash_init(HASH *hash, uint growth_size, CHARSET_INFO *charset, my_hash_function hash_function,
                        ulong default_array_elements, size_t key_offset, size_t key_length, my_hash_get_key get_key,
  ...
  uchar *my_hash_search_using_hash_value(const HASH *info, my_hash_value_type hash_value, const uchar *key,
                                         size_t length);
  my_hash_value_type my_calc_hash(const HASH *info, const uchar *key, size_t length);
  uchar *my_hash_first(const HASH *info, const uchar *key, size_t length, HASH_SEARCH_STATE *state);
  uchar *my_hash_first_from_hash_value(const HASH *info, my_hash_value_type hash_value, const uchar *key, size_t length,
