...
extern "C"
{
  ...
  extern void _db_enter_(const char *_func_, const char *_file_, uint _line_, struct _db_stack_frame_ *_stack_frame_);
  extern void _db_return_(uint _line_, struct _db_stack_frame_ *_stack_frame_);
  extern void _db_pargs_(uint _line_, const char *keyword);
  extern int _db_enabled_();
  extern void _db_doprnt_(const char *format, ...) MY_ATTRIBUTE((format(printf, 1, 2)));
  extern void _db_doputs_(const char *log);
  extern void _db_dump_(uint _line_, const char *keyword, const unsigned char *memory, size_t length);
...
#define DBUG_CRASH_RETURN(val) DBUG_CHECK_CRASH(_db_get_func_(), "_crash_return")
#define DBUG_CRASH_VOID_RETURN DBUG_CHECK_CRASH(_db_get_func_(), "_crash_return")
...
#define DBUG_LOG(keyword, arglist) \
  do                               \
  {                                \
  } while (0)
#define DBUG_PUSH(a1) \
