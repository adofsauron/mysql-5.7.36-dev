...
bool Rpl_info_dummy::do_set_info(const int pos MY_ATTRIBUTE((unused)), const uchar *value MY_ATTRIBUTE((unused)),
...
bool Rpl_info_dummy::do_set_info(const int pos MY_ATTRIBUTE((unused)), const ulong value MY_ATTRIBUTE((unused)))
{
  assert(!abort);
...
bool Rpl_info_dummy::do_set_info(const int pos MY_ATTRIBUTE((unused)), const int value MY_ATTRIBUTE((unused)))
{
  assert(!abort);
...
bool Rpl_info_dummy::do_set_info(const int pos MY_ATTRIBUTE((unused)), const float value MY_ATTRIBUTE((unused)))
{
  assert(!abort);
...
bool Rpl_info_dummy::do_set_info(const int pos MY_ATTRIBUTE((unused)), const Server_ids *value MY_ATTRIBUTE((unused)))
{
  assert(!abort);
...
bool Rpl_info_dummy::do_get_info(const int pos MY_ATTRIBUTE((unused)), char *value MY_ATTRIBUTE((unused)),
                                 const size_t size MY_ATTRIBUTE((unused)),
...
bool Rpl_info_dummy::do_get_info(const int pos MY_ATTRIBUTE((unused)), uchar *value MY_ATTRIBUTE((unused)),
                                 const size_t size MY_ATTRIBUTE((unused)),
...
bool Rpl_info_dummy::do_get_info(const int pos MY_ATTRIBUTE((unused)), ulong *value MY_ATTRIBUTE((unused)),
...
bool Rpl_info_dummy::do_get_info(const int pos MY_ATTRIBUTE((unused)), int *value MY_ATTRIBUTE((unused)),
...
bool Rpl_info_dummy::do_get_info(const int pos MY_ATTRIBUTE((unused)), float *value MY_ATTRIBUTE((unused)),
...
bool Rpl_info_dummy::do_get_info(const int pos MY_ATTRIBUTE((unused)), Server_ids *value MY_ATTRIBUTE((unused)),
