...
class Rpl_info_handler
{
 ...
 private:
  ...
  virtual bool do_get_info(const int pos, uchar *value, const size_t size, const uchar *default_value) = 0;
  virtual bool do_get_info(const int pos, ulong *value, const ulong default_value) = 0;
  virtual bool do_get_info(const int pos, int *value, const int default_value) = 0;
  virtual bool do_get_info(const int pos, float *value, const float default_value) = 0;
  virtual bool do_get_info(const int pos, Server_ids *value, const Server_ids *default_value) = 0;
