...
class Ndb_local_connection
{
 public:
  ...
  bool truncate_table(const char *db, size_t db_length, const char *table, size_t table_length,
  ...
  bool create_sys_table(const char *db, size_t db_length, const char *table, size_t table_length,
                        bool create_if_not_exists, const char *create_definiton, const char *create_options);
 ...
 private:
  bool execute_query(MYSQL_LEX_STRING sql_text, const unsigned int *ignore_mysql_errors,
                     const class Suppressor *suppressor = NULL);
  bool execute_query_iso(MYSQL_LEX_STRING sql_text, const unsigned int *ignore_mysql_errors,
                         const class Suppressor *suppressor = NULL);
