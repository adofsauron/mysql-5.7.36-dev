...
class Sql_cmd_common_signal : public Sql_cmd
{
  ...
  */
  static void assign_defaults(Sql_condition *cond, bool set_level_code, Sql_condition::enum_severity_level level,
                              int sqlcode);
...
class Sql_cmd_signal : public Sql_cmd_common_signal
{
  ...
  */
  Sql_cmd_signal(const sp_condition_value *cond, Set_signal_information *set) : Sql_cmd_common_signal(cond, set) {}
...
class Sql_cmd_resignal : public Sql_cmd_common_signal
{
  ...
  */
  Sql_cmd_resignal(const sp_condition_value *cond, Set_signal_information *set) : Sql_cmd_common_signal(cond, set) {}
