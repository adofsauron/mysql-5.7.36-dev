...
class Bitmap
{
 ...
 public:
  ...
  void intersect(ulonglong map2buff)
  {
    ...
    {
      int8store(const_cast<uchar *>(static_cast<uchar *>(static_cast<void *>(&buf2))), map2buff);
    }
    else
    {
      assert(sizeof(buffer) >= 4);
      int4store(const_cast<uchar *>(static_cast<uchar *>(static_cast<void *>(&buf2))), static_cast<uint32>(map2buff));
    }
  ...
  void intersect_extended(ulonglong map2buff)
  {
    ...
    if (map.n_bits > sizeof(ulonglong) * 8)
      bitmap_set_above(&map, sizeof(ulonglong), MY_TEST(map2buff & (1LL << (sizeof(ulonglong) * 8 - 1))));
  }
  ...
  {
    if (sizeof(buffer) >= 8)
      return uint8korr(static_cast<const uchar *>(static_cast<const void *>(buffer)));
    assert(sizeof(buffer) >= 4);
    return (ulonglong)uint4korr(static_cast<const uchar *>(static_cast<const void *>(buffer)));
  }
...
class Bitmap<64>
{
 ...
 public:
  ...
  {
    assert(n < 64);
    return MY_TEST(map & (((ulonglong)1) << n));
  }
...
class Table_map_iterator
{
 ...
 public:
  ...
  int next_bit()
  {
    static const char last_bit[16] = {32, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0};
    uint bit;
