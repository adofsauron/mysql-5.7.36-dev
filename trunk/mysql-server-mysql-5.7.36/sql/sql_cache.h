...
class Query_cache
{
  ...
  */
  ...
  static size_t filename_2_table_key(char *key, const char *filename, size_t *db_length);
  ...
  my_bool insert_table(size_t key_len, const char *key, Query_cache_block_table *node, size_t db_length,
  ...
  */
  ...
  my_bool write_result_data(Query_cache_block **result, ulong data_len, uchar *data, Query_cache_block *parent,
  ...
  */
  ...
  void invalidate_single(THD *thd, TABLE_LIST *table_used, my_bool using_transactions);
