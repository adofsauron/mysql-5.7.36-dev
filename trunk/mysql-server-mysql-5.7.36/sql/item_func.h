...
extern void reject_geometry_args(uint arg_count, Item **args, Item_result_field *me);
...
class Item_func : public Item_result_field
{
 ...
 public:
  ...
  Item_func(void) : allowed_arg_cols(1), arg_count(0)
  {
    args = tmp_arg;
    with_sum_func = 0;
  }

  explicit Item_func(const POS &pos) : super(pos), allowed_arg_cols(1), arg_count(0) { args = tmp_arg; }
  ...
  Item_func(const POS &pos, Item *a) : super(pos), allowed_arg_cols(1), arg_count(1)
  {
    args = tmp_arg;
    args[0] = a;
  }
  ...
  Item_func(const POS &pos, Item *a, Item *b) : super(pos), allowed_arg_cols(1), arg_count(2)
  {
    args = tmp_arg;
    args[0] = a;
    args[1] = b;
  ...
  Item_func(Item *a, Item *b, Item *c) : allowed_arg_cols(1), arg_count(3)
  {
  ...
  Item_func(const POS &pos, Item *a, Item *b, Item *c) : super(pos), allowed_arg_cols(1), arg_count(3)
  {
    if ((args = (Item **)sql_alloc(sizeof(Item *) * 3)))
    {
      args[0] = a;
  ...
  Item_func(Item *a, Item *b, Item *c, Item *d) : allowed_arg_cols(1), arg_count(4)
  {
  ...
  Item_func(const POS &pos, Item *a, Item *b, Item *c, Item *d) : super(pos), allowed_arg_cols(1), arg_count(4)
  {
    if ((args = (Item **)sql_alloc(sizeof(Item *) * 4)))
    {
      args[0] = a;
  ...
  Item_func(Item *a, Item *b, Item *c, Item *d, Item *e) : allowed_arg_cols(1), arg_count(5)
  {
  ...
  Item_func(const POS &pos, Item *a, Item *b, Item *c, Item *d, Item *e) : super(pos), allowed_arg_cols(1), arg_count(5)
  {
    if ((args = (Item **)sql_alloc(sizeof(Item *) * 5)))
    {
      args[0] = a;
  ...
  */
  ...
  inline bool get_arg0_time(MYSQL_TIME *ltime) { return (null_value = args[0]->get_time(ltime)); }
  bool is_null()
  {
    update_null_value();
    return null_value;
  ...
  */
  ...
  {
    return agg_item_charsets_for_string_result(c, func_name(), items, nitems, item_sep);
  }
  /*
  ...
  */
  ...
  {
    return agg_item_charsets_for_comparison(c, func_name(), items, nitems, item_sep);
  }
  /*
  ...
  */
  ...
  {
    return agg_item_charsets_for_string_result_with_comparison(c, func_name(), items, nitems, item_sep);
  }
  ...
  /**
     ...
     +/-INF or NAN.
  */
  inline double check_float_overflow(double value) { return my_isfinite(value) ? value : raise_float_overflow(); }
  /**
  ...
  */
  inline longlong check_integer_overflow(longlong value, bool val_unsigned)
  {
    if ((unsigned_flag && !val_unsigned && value < 0) ||
        (!unsigned_flag && val_unsigned && (ulonglong)value > (ulonglong)LLONG_MAX))
  ...
  */
  ...
  /*
    ...
    the timezone.
   */
  virtual bool check_valid_arguments_processor(uchar *bool_arg) { return has_timestamp_args(); }

  virtual bool find_function_processor(uchar *arg) { return functype() == *(Functype *)arg; }
 ...
 protected:
  /**
    ...
    placed in Item_func.
  */
  const Item_field *contributes_to_filter(table_map read_tables, table_map filter_for_table,
...
class Item_real_func : public Item_func
{
 public:
  ...
  explicit Item_real_func(const POS &pos) : Item_func(pos) { collation.set_numeric(); }

  Item_real_func(Item *a) : Item_func(a) { collation.set_numeric(); }
  Item_real_func(const POS &pos, Item *a) : Item_func(pos, a) { collation.set_numeric(); }

  Item_real_func(Item *a, Item *b) : Item_func(a, b) { collation.set_numeric(); }
  Item_real_func(const POS &pos, Item *a, Item *b) : Item_func(pos, a, b) { collation.set_numeric(); }

  Item_real_func(List<Item> &list) : Item_func(list) { collation.set_numeric(); }
  Item_real_func(const POS &pos, PT_item_list *list) : Item_func(pos, list) { collation.set_numeric(); }
...
class Item_func_numhybrid : public Item_func
{
 ...
 public:
  Item_func_numhybrid(Item *a) : Item_func(a), hybrid_type(REAL_RESULT) { collation.set_numeric(); }
  Item_func_numhybrid(const POS &pos, Item *a) : Item_func(pos, a), hybrid_type(REAL_RESULT)
  {
    collation.set_numeric();
  }

  Item_func_numhybrid(Item *a, Item *b) : Item_func(a, b), hybrid_type(REAL_RESULT) { collation.set_numeric(); }
  Item_func_numhybrid(const POS &pos, Item *a, Item *b) : Item_func(pos, a, b), hybrid_type(REAL_RESULT)
  {
    collation.set_numeric();
  }

  Item_func_numhybrid(List<Item> &list) : Item_func(list), hybrid_type(REAL_RESULT) { collation.set_numeric(); }
  Item_func_numhybrid(const POS &pos, PT_item_list *list) : Item_func(pos, list), hybrid_type(REAL_RESULT)
  {
    collation.set_numeric();
  }
...
class Item_func_num1 : public Item_func_numhybrid
{
 public:
  ...
  Item_func_num1(const POS &pos, Item *a, Item *b) : Item_func_numhybrid(pos, a, b) {}
...
class Item_num_op : public Item_func_numhybrid
{
 public:
  ...
  virtual inline void print(String *str, enum_query_type query_type) { print_op(str, query_type); }
...
class Item_int_func : public Item_func
{
 public:
  ...
  Item_int_func(const POS &pos, Item *a, Item *b, Item *c, Item *d) : Item_func(pos, a, b, c, d)
  {
    collation.set_numeric();
    fix_char_length(21);
  }
  ...
  Item_int_func(const POS &pos, PT_item_list *opt_list) : Item_func(pos, opt_list)
  {
    collation.set_numeric();
    fix_char_length(21);
  }

  Item_int_func(THD *thd, Item_int_func *item) : Item_func(thd, item) { collation.set_numeric(); }
  double val_real();
  String *val_str(String *str);
...
{
 public:
  Item_func_signed(const POS &pos, Item *a) : Item_int_func(pos, a) { unsigned_flag = 0; }
...
{
 public:
  Item_func_unsigned(const POS &pos, Item *a) : Item_func_signed(pos, a) { unsigned_flag = 1; }
...
class Item_decimal_typecast : public Item_func
{
 ...
 public:
  Item_decimal_typecast(const POS &pos, Item *a, int len, int dec) : Item_func(pos, a)
  {
    decimals = dec;
    collation.set_numeric();
...
class Item_func_plus : public Item_func_additive_op
{
 public:
  ...
  Item_func_plus(const POS &pos, Item *a, Item *b) : Item_func_additive_op(pos, a, b) {}
...
class Item_func_minus : public Item_func_additive_op
{
 public:
  ...
  Item_func_minus(const POS &pos, Item *a, Item *b) : Item_func_additive_op(pos, a, b) {}
...
class Item_func_latlongfromgeohash : public Item_real_func
{
 ...
 public:
  Item_func_latlongfromgeohash(const POS &pos, Item *a, double lower_latitude, double upper_latitude,
                               double lower_longitude, double upper_longitude, bool start_on_even_bit_arg)
  ...
  void fix_length_and_dec();
  bool fix_fields(THD *thd, Item **ref);
  static bool decode_geohash(String *geohash, double upper_latitude, double lower_latitude, double upper_longitude,
                             double lower_longitude, double *result_latitude, double *result_longitude);
...
class Item_func_round : public Item_func_num1
{
 ...
 public:
  ...
  Item_func_round(const POS &pos, Item *a, Item *b, bool trunc_arg) : Item_func_num1(pos, a, b), truncate(trunc_arg) {}
...
class Item_func_rand : public Item_real_func
{
 ...
 public:
  Item_func_rand(const POS &pos, Item *a) : Item_real_func(pos, a), rand(0), first_eval(true) {}
...
class Item_func_units : public Item_real_func
{
 ...
 public:
  Item_func_units(const POS &pos, char *name_arg, Item *a, double mul_arg, double add_arg)
...
{
 public:
  Item_func_min(const POS &pos, PT_item_list *opt_list) : Item_func_min_max(pos, opt_list, 1) {}
...
{
 public:
  Item_func_max(const POS &pos, PT_item_list *opt_list) : Item_func_min_max(pos, opt_list, -1) {}
...
class Item_func_rollup_const : public Item_func
{
 public:
  ...
  bool get_time(MYSQL_TIME *ltime) { return (null_value = args[0]->get_time(ltime)); }
...
class Item_func_locate : public Item_int_func
{
 ...
 public:
  ...
  Item_func_locate(const POS &pos, Item *a, Item *b, Item *c) : Item_int_func(pos, a, b, c) {}
...
{
 public:
  Item_func_validate_password_strength(const POS &pos, Item *a) : Item_int_func(pos, a) {}
  longlong val_int();
...
class Item_func_field : public Item_int_func
{
 ...
 public:
  Item_func_field(const POS &pos, PT_item_list *opt_list) : Item_int_func(pos, opt_list) {}
  longlong val_int();
...
class Item_func_find_in_set : public Item_int_func
{
 ...
 public:
  Item_func_find_in_set(const POS &pos, Item *a, Item *b) : Item_int_func(pos, a, b), enum_value(0) {}
  longlong val_int();
...
class Item_func_shift_left : public Item_func_bit
{
 ...
 public:
  Item_func_shift_left(const POS &pos, Item *a, Item *b) : Item_func_bit(pos, a, b) {}
  longlong val_int();
  const char *func_name() const { return "<<"; }
};
...
class Item_func_shift_right : public Item_func_bit
{
 ...
 public:
  Item_func_shift_right(const POS &pos, Item *a, Item *b) : Item_func_bit(pos, a, b) {}
  longlong val_int();
  const char *func_name() const { return ">>"; }
};
...
class Item_func_bit_neg : public Item_func_bit
{
 ...
 public:
  ...
  virtual inline void print(String *str, enum_query_type query_type) { Item_func::print(str, query_type); }
};
...
class Item_func_benchmark : public Item_int_func
{
 ...
 public:
  Item_func_benchmark(const POS &pos, Item *count_expr, Item *expr) : Item_int_func(pos, count_expr, expr) {}
...
class Item_udf_func : public Item_func
{
 ...
 public:
  Item_udf_func(const POS &pos, udf_func *udf_arg, PT_item_list *opt_list) : Item_func(pos, opt_list), udf(udf_arg) {}
...
{
 public:
  Item_func_udf_float(const POS &pos, udf_func *udf_arg, PT_item_list *opt_list) : Item_udf_func(pos, udf_arg, opt_list)
  {
  }
  longlong val_int()
  {
...
{
 public:
  Item_func_udf_int(const POS &pos, udf_func *udf_arg, PT_item_list *opt_list) : Item_udf_func(pos, udf_arg, opt_list)
  {
  }
  longlong val_int();
...
{
 public:
  Item_func_udf_str(const POS &pos, udf_func *udf_arg, PT_item_list *opt_list) : Item_udf_func(pos, udf_arg, opt_list)
  {
  }
...
class Item_master_pos_wait : public Item_int_func
{
 ...
 public:
  Item_master_pos_wait(const POS &pos, Item *a, Item *b) : Item_int_func(pos, a, b) {}
  Item_master_pos_wait(const POS &pos, Item *a, Item *b, Item *c) : Item_int_func(pos, a, b, c) {}
  Item_master_pos_wait(const POS &pos, Item *a, Item *b, Item *c, Item *d) : Item_int_func(pos, a, b, c, d) {}
...
class Item_wait_for_executed_gtid_set : public Item_int_func
{
 ...
 public:
  ...
  Item_wait_for_executed_gtid_set(const POS &pos, Item *a, Item *b) : Item_int_func(pos, a, b) {}
...
class Item_master_gtid_set_wait : public Item_int_func
{
 ...
 public:
  ...
  Item_master_gtid_set_wait(const POS &pos, Item *a, Item *b) : Item_int_func(pos, a, b) {}
  Item_master_gtid_set_wait(const POS &pos, Item *a, Item *b, Item *c) : Item_int_func(pos, a, b, c) {}
...
class Item_func_gtid_subset : public Item_int_func
{
 ...
 public:
  Item_func_gtid_subset(const POS &pos, Item *a, Item *b) : Item_int_func(pos, a, b) {}
  longlong val_int();
...
class Item_var_func : public Item_func
{
 public:
  ...
  bool get_date(MYSQL_TIME *ltime, my_time_flags_t fuzzydate) { return get_date_from_non_temporal(ltime, fuzzydate); }
  bool get_time(MYSQL_TIME *ltime) { return get_time_from_non_temporal(ltime); }
  bool check_gcol_func_processor(uchar *int_arg) { return true; }
};
...
class Item_func_set_user_var : public Item_var_func
{
 ...
 public:
  ...
  bool is_null_result();
  bool update_hash(const void *ptr, uint length, enum Item_result type, const CHARSET_INFO *cs, Derivation dv,
                   bool unsigned_arg);
  ...
  void save_org_in_field(Field *field) { save_in_field(field, true, false); }
...
class Item_func_get_user_var : public Item_var_func, private Settable_routine_parameter
{
 ...
 public:
  ...
  Item_func_get_user_var(Name_string a) : Item_var_func(), m_cached_result_type(STRING_RESULT), name(a) {}
...
class Item_user_var_as_out_param : public Item
{
 ...
 public:
  Item_user_var_as_out_param(Name_string a) : name(a) { item_name.copy(a); }
...
class Item_func_get_system_var : public Item_var_func
{
 ...
 public:
  ...
  longlong val_int();
  String *val_str(String *);
  my_decimal *val_decimal(my_decimal *dec_buf) { return val_decimal_from_real(dec_buf); }
...
class Item_func_match : public Item_real_func
{
  ...
  */
  ...
  ulonglong get_count()
  {
    ...
    return ((FT_INFO_EXT *)ft_handler)->could_you->count_matches((FT_INFO_EXT *)ft_handler);
  }
  ...
  bool ordered_result()
  {
    ...
    assert(ft_handler);
    return ((FT_INFO_EXT *)ft_handler)->could_you->get_flags() & FTS_ORDERED_RESULT;
  }
  ...
  bool docid_in_result()
  {
    ...
    return ((FT_INFO_EXT *)ft_handler)->could_you->get_flags() & FTS_DOCID_IN_RESULT;
  }
...
class Item_func_sp : public Item_func
{
 ...
 public:
  Item_func_sp(const POS &pos, const LEX_STRING &db_name, const LEX_STRING &fn_name, bool use_explicit_name,
...
class Item_func_version : public Item_static_string_func
{
 ...
 public:
  explicit Item_func_version(const POS &pos)
      : Item_static_string_func(pos, NAME_STRING("version()"), server_version, strlen(server_version),
