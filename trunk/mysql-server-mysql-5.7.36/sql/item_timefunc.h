...
{
 public:
  Item_func_period_add(const POS &pos, Item *a, Item *b) : Item_int_func(pos, a, b) {}
  longlong val_int();
  const char *func_name() const { return "period_add"; }
  void fix_length_and_dec() { fix_char_length(6); /* YYYYMM */ }
};

class Item_func_period_diff : public Item_int_func
{
 public:
  Item_func_period_diff(const POS &pos, Item *a, Item *b) : Item_int_func(pos, a, b) {}
  longlong val_int();
...
class Item_func_to_days : public Item_int_func
{
 public:
  ...
  bool check_valid_arguments_processor(uchar *arg) { return !has_date_args(); }
};
...
{
 public:
  Item_func_month(const POS &pos, Item *a) : Item_func(pos, a) { collation.set_numeric(); }
  longlong val_int();
  double val_real()
  {
    assert(fixed == 1);
...
class Item_func_hour : public Item_int_func
{
 public:
  ...
  bool check_partition_func_processor(uchar *arg) { return false; }
  bool check_valid_arguments_processor(uchar *arg) { return !has_time_args(); }
};
...
class Item_func_weekday : public Item_func
{
 ...
 public:
  Item_func_weekday(const POS &pos, Item *a, bool type_arg) : Item_func(pos, a), odbc_type(type_arg)
  {
...
class Item_timeval_func : public Item_func
{
  ...
  */
  ...
  bool get_date(MYSQL_TIME *ltime, my_time_flags_t fuzzydate) { return get_date_from_numeric(ltime, fuzzydate); }
  bool get_time(MYSQL_TIME *ltime) { return get_time_from_numeric(ltime); }
  enum Item_result result_type() const { return decimals ? DECIMAL_RESULT : INT_RESULT; }
};
...
class Item_func_unix_timestamp : public Item_timeval_func
{
  ...
  */
  bool check_valid_arguments_processor(uchar *arg) { return !has_timestamp_args(); }
  void fix_length_and_dec()
  {
    fix_length_and_dec_and_charset_datetime(11, arg_count == 0 ? 0 : args[0]->datetime_precision());
  }
...
class Item_temporal_func : public Item_func
{
 ...
 public:
  ...
  Item_temporal_func(const POS &pos, Item *a, Item *b, Item *c) : Item_func(pos, a, b, c) {}

  enum Item_result result_type() const { return STRING_RESULT; }
  CHARSET_INFO *charset_for_protocol() const { return &my_charset_bin; }
  Field *tmp_table_field(TABLE *table) { return tmp_table_field_from_field_type(table, 0); }
  uint time_precision()
  {
    assert(fixed);
    return decimals;
...
class Item_temporal_hybrid_func : public Item_str_func
{
 ...
 public:
  Item_temporal_hybrid_func(Item *a, Item *b) : Item_str_func(a, b), sql_mode(0) {}
  Item_temporal_hybrid_func(const POS &pos, Item *a, Item *b) : Item_str_func(pos, a, b), sql_mode(0) {}
  ...
  const CHARSET_INFO *charset_for_protocol() const
  {
    ...
    */
    assert(fixed == 1);
    return cached_field_type == MYSQL_TYPE_STRING ? collation.collation : &my_charset_bin;
  }
  Field *tmp_table_field(TABLE *table) { return tmp_table_field_from_field_type(table, 0); }
...
{
 protected:
  type_conversion_status save_in_field_inner(Field *field, bool no_conversions) { return save_date_in_field(field); }
 ...
 public:
  ...
  Item_date_func(const POS &pos, Item *a, Item *b) : Item_temporal_func(pos, a, b) {}
  enum_field_types field_type() const { return MYSQL_TYPE_DATE; }
  bool get_time(MYSQL_TIME *ltime) { return get_time_from_date(ltime); }
  String *val_str(String *str) { return val_string_from_date(str); }
  longlong val_int() { return val_int_from_date(); }
  longlong val_date_temporal();
  double val_real() { return (double)val_int(); }
  const char *func_name() const { return "date"; }
  void fix_length_and_dec() { fix_length_and_dec_and_charset_datetime(MAX_DATE_WIDTH, 0); }
  my_decimal *val_decimal(my_decimal *decimal_value)
  {
    assert(fixed == 1);
...
class Item_datetime_func : public Item_temporal_func
{
 ...
 public:
  ...
  Item_datetime_func(const POS &pos, Item *a, Item *b) : Item_temporal_func(pos, a, b) {}

  Item_datetime_func(Item *a, Item *b, Item *c) : Item_temporal_func(a, b, c) {}
  Item_datetime_func(const POS &pos, Item *a, Item *b, Item *c) : Item_temporal_func(pos, a, b, c) {}

  enum_field_types field_type() const { return MYSQL_TYPE_DATETIME; }
  double val_real() { return val_real_from_decimal(); }
  String *val_str(String *str) { return val_string_from_datetime(str); }
  longlong val_int() { return val_int_from_datetime(); }
  longlong val_date_temporal();
  my_decimal *val_decimal(my_decimal *decimal_value)
  {
    assert(fixed == 1);
  ...
  bool get_time(MYSQL_TIME *ltime) { return get_time_from_datetime(ltime); }
...
{
 protected:
  type_conversion_status save_in_field_inner(Field *field, bool no_conversions) { return save_time_in_field(field); }
 ...
 public:
  ...
  Item_time_func(const POS &pos, Item *a, Item *b) : Item_temporal_func(pos, a, b) {}
  Item_time_func(const POS &pos, Item *a, Item *b, Item *c) : Item_temporal_func(pos, a, b, c) {}
  ...
  longlong val_int() { return val_int_from_time(); }
  longlong val_time_temporal();
  bool get_date(MYSQL_TIME *res, my_time_flags_t fuzzy_date) { return get_date_from_time(res); }
  String *val_str(String *str) { return val_string_from_time(str); }
...
class MYSQL_TIME_cache
{
  ...
  */
  bool eq(const MYSQL_TIME_cache &tm) const { return val_packed() == tm.val_packed(); }
...
class Item_time_literal : public Item_time_func
{
  ...
  */
  ...
  void fix_length_and_dec() { fix_length_and_dec_and_charset_datetime(MAX_TIME_WIDTH, decimals); }
  bool check_partition_func_processor(uchar *arg) { return false; }
  bool basic_const_item() const { return true; }
  bool const_item() const { return true; }
  table_map used_tables() const { return (table_map)0L; }
...
class Item_datetime_literal : public Item_datetime_func
{
  ...
  */
  ...
  void fix_length_and_dec() { fix_length_and_dec_and_charset_datetime(MAX_DATETIME_WIDTH, decimals); }
  bool check_partition_func_processor(uchar *arg) { return false; }
  bool basic_const_item() const { return true; }
  bool const_item() const { return true; }
  table_map used_tables() const { return (table_map)0L; }
...
class Item_func_curtime : public Item_time_func
{
  ...
  */
  Item_func_curtime(const POS &pos, uint8 dec_arg) : Item_time_func(pos) { decimals = dec_arg; }
...
class Item_func_curtime_local : public Item_func_curtime
{
 ...
 public:
  Item_func_curtime_local(const POS &pos, uint8 dec_arg) : Item_func_curtime(pos, dec_arg) {}
...
class Item_func_curtime_utc : public Item_func_curtime
{
 ...
 public:
  Item_func_curtime_utc(const POS &pos, uint8 dec_arg) : Item_func_curtime(pos, dec_arg) {}
...
class Item_func_now : public Item_datetime_func
{
  ...
  */
  ...
  Item_func_now(const POS &pos, uint8 dec_arg) : Item_datetime_func(pos) { decimals = dec_arg; }
...
class Item_func_now_local : public Item_func_now
{
 ...
 public:
  ...
  Item_func_now_local(const POS &pos, uint8 dec_arg) : Item_func_now(pos, dec_arg) {}
...
class Item_func_now_utc : public Item_func_now
{
 ...
 public:
  Item_func_now_utc(const POS &pos, uint8 dec_arg) : Item_func_now(pos, dec_arg) {}
...
{
 public:
  Item_func_sysdate_local(uint8 dec_arg) : Item_datetime_func() { decimals = dec_arg; }
...
class Item_func_from_days : public Item_date_func
{
 public:
  ...
  bool get_date(MYSQL_TIME *res, my_time_flags_t fuzzy_date);
  bool check_partition_func_processor(uchar *arg) { return false; }
  bool check_valid_arguments_processor(uchar *arg) { return has_date_args() || has_time_args(); }
};
...
class Item_func_date_format : public Item_str_func
{
 ...
 public:
  Item_func_date_format(const POS &pos, Item *a, Item *b, bool is_time_format_arg)
...
class Item_func_sec_to_time : public Item_time_func
{
 public:
  ...
  {
    maybe_null = 1;
    fix_length_and_dec_and_charset_datetime(MAX_TIME_WIDTH, MY_MIN(args[0]->decimals, DATETIME_MAX_DECIMALS));
  }
...
class Item_date_add_interval : public Item_temporal_hybrid_func
{
 ...
 public:
  ...
  Item_date_add_interval(const POS &pos, Item *a, Item *b, interval_type type_arg, bool neg_arg)
      : Item_temporal_hybrid_func(pos, a, b), int_type(type_arg), date_sub_interval(neg_arg)
  {
  }
...
class Item_extract : public Item_int_func
{
 ...
 public:
  const interval_type int_type;  // keep it public
  Item_extract(const POS &pos, interval_type type_arg, Item *a) : Item_int_func(pos, a), int_type(type_arg) {}
  longlong val_int();
...
class Item_date_typecast : public Item_date_func
{
 public:
  ...
  Item_date_typecast(const POS &pos, Item *a) : Item_date_func(pos, a) { maybe_null = 1; }
...
class Item_time_typecast : public Item_time_func
{
 ...
 public:
  Item_time_typecast(Item *a) : Item_time_func(a) { detect_precision_from_arg = true; }
  Item_time_typecast(const POS &pos, Item *a) : Item_time_func(pos, a) { detect_precision_from_arg = true; }

  Item_time_typecast(const POS &pos, Item *a, uint8 dec_arg) : Item_time_func(pos, a)
  {
  ...
  void fix_length_and_dec()
  {
    ...
    fix_length_and_dec_and_charset_datetime(MAX_TIME_WIDTH,
                                            detect_precision_from_arg ? args[0]->time_precision() : decimals);
  }
};
...
class Item_datetime_typecast : public Item_datetime_func
{
 ...
 public:
  Item_datetime_typecast(Item *a) : Item_datetime_func(a) { detect_precision_from_arg = true; }
  Item_datetime_typecast(const POS &pos, Item *a) : Item_datetime_func(pos, a) { detect_precision_from_arg = true; }

  Item_datetime_typecast(const POS &pos, Item *a, uint8 dec_arg) : Item_datetime_func(pos, a)
  {
    detect_precision_from_arg = false;
    decimals = dec_arg;
  }
...
{
 public:
  Item_func_makedate(const POS &pos, Item *a, Item *b) : Item_date_func(pos, a, b) { maybe_null = 1; }
...
class Item_func_add_time : public Item_temporal_hybrid_func
{
 ...
 public:
  Item_func_add_time(Item *a, Item *b, bool type_arg, bool neg_arg) : Item_temporal_hybrid_func(a, b), is_date(type_arg)
  {
    sign = neg_arg ? -1 : 1;
  }
...
{
 public:
  Item_func_timediff(const POS &pos, Item *a, Item *b) : Item_time_func(pos, a, b) {}
...
{
 public:
  Item_func_maketime(const POS &pos, Item *a, Item *b, Item *c) : Item_time_func(pos, a, b, c) { maybe_null = TRUE; }
  void fix_length_and_dec()
  {
    fix_length_and_dec_and_charset_datetime(MAX_TIME_WIDTH, MY_MIN(args[2]->decimals, DATETIME_MAX_DECIMALS));
  }
...
class Item_func_get_format : public Item_str_ascii_func
{
 public:
  ...
  Item_func_get_format(const POS &pos, timestamp_type type_arg, Item *a) : Item_str_ascii_func(pos, a), type(type_arg)
  {
  }
  String *val_str_ascii(String *str);
...
class Item_func_str_to_date : public Item_temporal_hybrid_func
{
 ...
 public:
  Item_func_str_to_date(const POS &pos, Item *a, Item *b) : Item_temporal_hybrid_func(pos, a, b), const_item(false) {}
...
{
 public:
  Item_func_last_day(const POS &pos, Item *a) : Item_date_func(pos, a) { maybe_null = 1; }
