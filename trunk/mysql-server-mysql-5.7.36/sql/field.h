...
#define ASSERT_COLUMN_MARKED_FOR_READ \
  assert(!table || (!table->read_set || bitmap_is_set(table->read_set, field_index)))
...
{
  return type == MYSQL_TYPE_TIMESTAMP || type == MYSQL_TYPE_TIMESTAMP2 || type == MYSQL_TYPE_DATETIME ||
...
void copy_integer(uchar *to, size_t to_length, const uchar *from, size_t from_length, bool is_unsigned)
{
  ...
  else
  {
    ...
    for (size_t i = 1, j = from_length - 2; i < to_length; ++i, --j) to[i] = from[j];
  }
}
...
class Field : public Proto_field
{
 ...
 public:
  ...
  {
    return unireg_check == TIMESTAMP_UN_FIELD || unireg_check == TIMESTAMP_DNUN_FIELD;
  }
  ...
  static void operator delete(void *ptr, MEM_ROOT *mem_root) { assert(false); /* never called */ }

  static void operator delete(void *ptr_arg, size_t size) throw() { TRASH(ptr_arg, size); }
  ...
  */
  virtual type_conversion_status store_packed(longlong nr) { return store(nr, 0); }
  ...
  */
  ...
  /**
    ...
    @retval true   on error
  */
  type_conversion_status store_time(MYSQL_TIME *ltime) { return store_time(ltime, 0); }
  ...
  */
  virtual Item_result numeric_context_result_type() const { return result_type(); }
  ...
  {
    return (ptr == field->ptr && m_null_ptr == field->m_null_ptr && null_bit == field->null_bit &&
            field->type() == type());
  }
  ...
  */
  ...
  virtual int save_field_metadata(uchar *first_byte) { return do_save_field_metadata(first_byte); }
  ...
  */
  ...
  virtual int cmp_max(const uchar *a, const uchar *b, uint max_len) { return cmp(a, b); }
  ...
  virtual int key_cmp(const uchar *str, uint length) { return cmp(ptr, str); }
  ...
  */
  ...
  bool is_temporal() const { return is_temporal_type(type()); }

  bool is_temporal_with_date() const { return is_temporal_type_with_date(type()); }

  bool is_temporal_with_time() const { return is_temporal_type_with_time(type()); }

  bool is_temporal_with_date_and_time() const { return is_temporal_type_with_date_and_time(type()); }
  ...
  */
  void set_count_cuted_fields(enum_check_fields count_cuted_fields) { m_count_cuted_fields_saved = count_cuted_fields; }

  bool maybe_null(void) const { return real_maybe_null() || table->is_nullable(); }

  /// @return true if this field is NULL-able, false otherwise.
  bool real_maybe_null(void) const { return m_null_ptr != NULL; }

  uint null_offset(const uchar *record) const { return (uint)(m_null_ptr - record); }
  ...
  */
  ...
  virtual Field *new_key_field(MEM_ROOT *root, TABLE *new_table, uchar *new_ptr, uchar *new_null_ptr,
                               uint new_null_bit);
  ...
  */
  ...
  virtual void get_image(uchar *buff, size_t length, const CHARSET_INFO *cs) { memcpy(buff, ptr, length); }

  virtual void set_image(const uchar *buff, size_t length, const CHARSET_INFO *cs) { memcpy(ptr, buff, length); }
  ...
  */
  ...
  virtual void set_key_image(const uchar *buff, size_t length) { set_image(buff, length, &my_charset_bin); }
  ...
  */
  ...
  uint offset(uchar *record) { return (uint)(ptr - record); }
  ...
  virtual const CHARSET_INFO *charset_for_protocol(void) const { return binary() ? &my_charset_bin : charset(); }
  ...
  */
  ...
  bool set_warning(Sql_condition::enum_severity_level level, uint code, int cut_increment, const char *view_db,
                   const char *view_name);

  inline bool check_overflow(int op_result) { return (op_result == E_DEC_OVERFLOW); }
  inline bool check_truncated(int op_result) { return (op_result == E_DEC_TRUNCATED); }
  ...
  */
  ...
  virtual type_conversion_status validate_stored_val(THD *thd) { return TYPE_OK; }
  ...
  */
  virtual int do_save_field_metadata(uchar *metadata_ptr) { return 0; }
...
class Field_num : public Field
{
 public:
  ...
  Field_num(uchar *ptr_arg, uint32 len_arg, uchar *null_ptr_arg, uchar null_bit_arg, utype unireg_check_arg,
            const char *field_name_arg, uint8 dec_arg, bool zero_arg, bool unsigned_arg);
  ...
  type_conversion_status check_int(const CHARSET_INFO *cs, const char *str, size_t length, const char *int_end,
                                   int error);
  type_conversion_status get_int(const CHARSET_INFO *cs, const char *from, size_t len, longlong *rnd,
                                 ulonglong unsigned_max, longlong signed_min, longlong signed_max);
};
...
class Field_str : public Field
{
 ...
 public:
  ...
  type_conversion_status store_decimal(const my_decimal *);
  type_conversion_status store(const char *to, size_t length, const CHARSET_INFO *cs) = 0;
  uint repertoire(void) const { return my_charset_repertoire(field_charset); }
  const CHARSET_INFO *charset(void) const { return field_charset; }
  void set_charset(const CHARSET_INFO *charset_arg) { field_charset = charset_arg; }
  enum Derivation derivation(void) const { return field_derivation; }
  virtual void set_derivation(enum Derivation derivation_arg) { field_derivation = derivation_arg; }
...
class Field_longstr : public Field_str
{
 ...
 protected:
  type_conversion_status check_string_copy_error(const char *original_string, const char *well_formed_error_pos,
                                                 const char *cannot_convert_error_pos, const char *from_end_pos,
                                                 const char *end, bool count_spaces, const CHARSET_INFO *cs);
 ...
 public:
  Field_longstr(uchar *ptr_arg, uint32 len_arg, uchar *null_ptr_arg, uchar null_bit_arg, utype unireg_check_arg,
      ...
      : Field_str(ptr_arg, len_arg, null_ptr_arg, null_bit_arg, unireg_check_arg, field_name_arg, charset_arg)
  {
  }
...
class Field_decimal : public Field_real
{
 public:
  ...
  type_conversion_status store(const char *to, size_t length, const CHARSET_INFO *charset);
  type_conversion_status store(double nr);
...
class Field_new_decimal : public Field_num
{
  ...
  */
  Field_new_decimal(uchar *ptr_arg, uint32 len_arg, uchar *null_ptr_arg, uchar null_bit_arg,
                    enum utype unireg_check_arg, const char *field_name_arg, uint8 dec_arg, bool zero_arg,
                    bool unsigned_arg);
...
class Field_tiny : public Field_num
{
 public:
  ...
  virtual ulonglong get_max_int_value() const { return unsigned_flag ? 0xFFULL : 0x7FULL; }
};
...
class Field_short : public Field_num
{
 public:
  ...
  Field_short(uint32 len_arg, bool maybe_null_arg, const char *field_name_arg, bool unsigned_arg)
      : Field_num((uchar *)0, len_arg, maybe_null_arg ? (uchar *)"" : 0, 0, NONE, field_name_arg, 0, 0, unsigned_arg)
  {
  }
  enum Item_result result_type() const { return INT_RESULT; }
  ...
  virtual ulonglong get_max_int_value() const { return unsigned_flag ? 0xFFFFULL : 0x7FFFULL; }
};
...
class Field_medium : public Field_num
{
 public:
  ...
  virtual ulonglong get_max_int_value() const { return unsigned_flag ? 0xFFFFFFULL : 0x7FFFFFULL; }
};
...
class Field_long : public Field_num
{
 public:
  ...
  virtual uchar *pack(uchar *to, const uchar *from, uint max_length MY_ATTRIBUTE((unused)), bool low_byte_first)
  {
    return pack_int32(to, from, low_byte_first);
  }
  virtual const uchar *unpack(uchar *to, const uchar *from, uint param_data MY_ATTRIBUTE((unused)), bool low_byte_first)
  {
    return unpack_int32(to, from, low_byte_first);
  }

  virtual ulonglong get_max_int_value() const { return unsigned_flag ? 0xFFFFFFFFULL : 0x7FFFFFFFULL; }
};
...
class Field_longlong : public Field_num
{
 public:
  ...
  Field_longlong(uint32 len_arg, bool maybe_null_arg, const char *field_name_arg, bool unsigned_arg)
      : Field_num((uchar *)0, len_arg, maybe_null_arg ? (uchar *)"" : 0, 0, NONE, field_name_arg, 0, 0, unsigned_arg)
  {
  }
  enum Item_result result_type() const { return INT_RESULT; }
  ...
  virtual ulonglong get_max_int_value() const { return unsigned_flag ? 0xFFFFFFFFFFFFFFFFULL : 0x7FFFFFFFFFFFFFFFULL; }
};
...
class Field_float : public Field_real
{
 public:
  ...
  Field_float(uint32 len_arg, bool maybe_null_arg, const char *field_name_arg, uint8 dec_arg)
...
class Field_double : public Field_real
{
 public:
  ...
  Field_double(uint32 len_arg, bool maybe_null_arg, const char *field_name_arg, uint8 dec_arg)
      : Field_real((uchar *)0, len_arg, maybe_null_arg ? (uchar *)"" : 0, (uint)0, NONE, field_name_arg, dec_arg, 0, 0)
  {
  }
  Field_double(uint32 len_arg, bool maybe_null_arg, const char *field_name_arg, uint8 dec_arg, my_bool not_fixed_arg)
      : Field_real((uchar *)0, len_arg, maybe_null_arg ? (uchar *)"" : 0, (uint)0, NONE, field_name_arg, dec_arg, 0, 0)
  {
...
class Field_null : public Field_str
{
 ...
 public:
  Field_null(uchar *ptr_arg, uint32 len_arg, enum utype unireg_check_arg, const char *field_name_arg,
             const CHARSET_INFO *cs)
      : Field_str(ptr_arg, len_arg, null, 1, unireg_check_arg, field_name_arg, cs)
  {
  }
  enum_field_types type() const { return MYSQL_TYPE_NULL; }
  type_conversion_status store(const char *to, size_t length, const CHARSET_INFO *cs)
  {
    null[0] = 1;
    return TYPE_OK;
  }
...
class Field_temporal : public Field
{
  ...
  */
  uint8 normalize_dec(uint8 dec_arg) { return dec_arg == NOT_FIXED_DEC ? DATETIME_MAX_DECIMALS : dec_arg; }
  ...
  */
  virtual bool convert_str_to_TIME(const char *str, size_t len, const CHARSET_INFO *cs, MYSQL_TIME *ltime,
  ...
  /**
    ...
    @retval     true          On error
  */
  virtual type_conversion_status convert_number_to_TIME(longlong nr, bool unsigned_val, int nanoseconds,
  ...
  */
  virtual my_time_flags_t date_flags(const THD *thd) { return 0; }
  /**
    Flags that are passed as "flag" argument to
    check_date(), number_to_datetime(), str_to_datetime().
    Similar to the above when we don't have a THD value.
  */
  my_time_flags_t date_flags() { return date_flags(table ? table->in_use : current_thd); }
  ...
  */
  void set_datetime_warning(Sql_condition::enum_severity_level level, uint code, ErrConvString str,
  ...
  */
  Field_temporal(uchar *ptr_arg, uchar *null_ptr_arg, uchar null_bit_arg, enum utype unireg_check_arg,
                 const char *field_name_arg, uint32 len_arg, uint8 dec_arg)
      : Field(ptr_arg, len_arg + ((dec = normalize_dec(dec_arg)) ? normalize_dec(dec_arg) + 1 : 0), null_ptr_arg,
  ...
  */
  Field_temporal(bool maybe_null_arg, const char *field_name_arg, uint32 len_arg, uint8 dec_arg)
      : Field((uchar *)0, len_arg + ((dec = normalize_dec(dec_arg)) ? normalize_dec(dec_arg) + 1 : 0),
  ...
  virtual bool str_needs_quotes() { return TRUE; }
  virtual uint is_equal(Create_field *new_field);
  Item_result numeric_context_result_type() const { return dec ? DECIMAL_RESULT : INT_RESULT; }
  ...
  type_conversion_status store(const char *str, size_t len, const CHARSET_INFO *cs);
...
class Field_temporal_with_date : public Field_temporal
{
  ...
  */
  ...
  type_conversion_status convert_number_to_TIME(longlong nr, bool unsigned_val, int nanoseconds, MYSQL_TIME *ltime,
                                                int *warning);
  bool convert_str_to_TIME(const char *str, size_t len, const CHARSET_INFO *cs, MYSQL_TIME *ltime,
 ...
 public:
  /**
    ...
    @param dec_arg           Number of second fraction digits, 0..6.
  */
  Field_temporal_with_date(uchar *ptr_arg, uchar *null_ptr_arg, uchar null_bit_arg, enum utype unireg_check_arg,
                           const char *field_name_arg, uint8 int_length_arg, uint8 dec_arg)
      : Field_temporal(ptr_arg, null_ptr_arg, null_bit_arg, unireg_check_arg, field_name_arg, int_length_arg, dec_arg)
  {
  }
  /**
    Constructor for Field_temporal
  ...
  */
  Field_temporal_with_date(bool maybe_null_arg, const char *field_name_arg, uint int_length_arg, uint8 dec_arg)
      : Field_temporal((uchar *)0, maybe_null_arg ? (uchar *)"" : 0, 0, NONE, field_name_arg, int_length_arg, dec_arg)
  {
  }
  bool send_binary(Protocol *protocol);
  type_conversion_status store_time(MYSQL_TIME *ltime, uint8 dec);
...
class Field_temporal_with_date_and_time : public Field_temporal_with_date
{
 ...
 public:
  /**
    ...
    @param dec_arg           Number of second fraction digits, 0..6.
  */
  Field_temporal_with_date_and_time(uchar *ptr_arg, uchar *null_ptr_arg, uchar null_bit_arg,
                                    enum utype unireg_check_arg, const char *field_name_arg, uint8 dec_arg)
      : Field_temporal_with_date(ptr_arg, null_ptr_arg, null_bit_arg, unireg_check_arg, field_name_arg,
...
/**
  ...
  DATETIME, DATETIME(N), TIMESTAMP, TIMESTAMP(N).
*/
class Field_temporal_with_date_and_timef : public Field_temporal_with_date_and_time
{
 private:
  int do_save_field_metadata(uchar *metadata_ptr)
  {
 ...
 public:
  /**
    ...
    @param dec_arg           Number of second fraction digits, 0..6.
  */
  Field_temporal_with_date_and_timef(uchar *ptr_arg, uchar *null_ptr_arg, uchar null_bit_arg,
                                     enum utype unireg_check_arg, const char *field_name_arg, uint8 dec_arg)
      : Field_temporal_with_date_and_time(ptr_arg, null_ptr_arg, null_bit_arg, unireg_check_arg, field_name_arg,
                                          dec_arg)
  {
  }
  /**
  ...
  */
  Field_temporal_with_date_and_timef(bool maybe_null_arg, const char *field_name_arg, uint8 dec_arg)
      : Field_temporal_with_date_and_time((uchar *)0, maybe_null_arg ? (uchar *)"" : 0, 0, NONE, field_name_arg,
                                          dec_arg)
  {
  }
  ...
  int cmp(const uchar *a_ptr, const uchar *b_ptr) { return memcmp(a_ptr, b_ptr, pack_length()); }
  uint row_pack_length() const { return pack_length(); }
  double val_real();
  longlong val_int();
...
class Field_timestamp : public Field_temporal_with_date_and_time
{
 ...
 public:
  ...
  uchar *pack(uchar *to, const uchar *from, uint max_length MY_ATTRIBUTE((unused)), bool low_byte_first)
  {
    return pack_int32(to, from, low_byte_first);
  }
  const uchar *unpack(uchar *to, const uchar *from, uint param_data MY_ATTRIBUTE((unused)), bool low_byte_first)
  {
    return unpack_int32(to, from, low_byte_first);
  }
  /* Validate the value stored in a field */
...
class Field_newdate : public Field_temporal_with_date
{
 ...
 public:
  Field_newdate(uchar *ptr_arg, uchar *null_ptr_arg, uchar null_bit_arg, enum utype unireg_check_arg,
                const char *field_name_arg)
      : Field_temporal_with_date(ptr_arg, null_ptr_arg, null_bit_arg, unireg_check_arg, field_name_arg, MAX_DATE_WIDTH,
                                 0)
  {
  }
  Field_newdate(bool maybe_null_arg, const char *field_name_arg)
      : Field_temporal_with_date((uchar *)0, maybe_null_arg ? (uchar *)"" : 0, 0, NONE, field_name_arg, MAX_DATE_WIDTH,
                                 0)
  {
  }
...
class Field_time_common : public Field_temporal
{
 ...
 public:
  /**
    ...
    @param dec_arg           Number of second fraction digits, 0..6.
  */
  Field_time_common(uchar *ptr_arg, uchar *null_ptr_arg, uchar null_bit_arg, enum utype unireg_check_arg,
                    const char *field_name_arg, uint8 dec_arg)
      : Field_temporal(ptr_arg, null_ptr_arg, null_bit_arg, unireg_check_arg, field_name_arg, MAX_TIME_WIDTH, dec_arg)
  {
  }
  /**
    Constructor for Field_time_common
  ...
  */
  Field_time_common(bool maybe_null_arg, const char *field_name_arg, uint8 dec_arg)
      : Field_temporal((uchar *)0, maybe_null_arg ? (uchar *)"" : 0, 0, NONE, field_name_arg, MAX_TIME_WIDTH, dec_arg)
  {
  }
  type_conversion_status store_time(MYSQL_TIME *ltime, uint8 dec);
  String *val_str(String *, String *);
...
class Field_time : public Field_time_common
{
 ...
 public:
  Field_time(uchar *ptr_arg, uchar *null_ptr_arg, uchar null_bit_arg, enum utype unireg_check_arg,
             const char *field_name_arg)
      : Field_time_common(ptr_arg, null_ptr_arg, null_bit_arg, unireg_check_arg, field_name_arg, 0)
  {
  }
  Field_time(bool maybe_null_arg, const char *field_name_arg)
      : Field_time_common((uchar *)0, maybe_null_arg ? (uchar *)"" : 0, 0, NONE, field_name_arg, 0)
  {
  }
...
class Field_timef : public Field_time_common
{
  ...
  */
  Field_timef(uchar *ptr_arg, uchar *null_ptr_arg, uchar null_bit_arg, enum utype unireg_check_arg,
              const char *field_name_arg, uint8 dec_arg)
      : Field_time_common(ptr_arg, null_ptr_arg, null_bit_arg, unireg_check_arg, field_name_arg, dec_arg)
  {
  }
  /**
    Constructor for Field_timef
  ...
  */
  Field_timef(bool maybe_null_arg, const char *field_name_arg, uint8 dec_arg)
      : Field_time_common((uchar *)0, maybe_null_arg ? (uchar *)"" : 0, 0, NONE, field_name_arg, dec_arg)
  {
  }
...
class Field_datetime : public Field_temporal_with_date_and_time
{
 ...
 public:
   ...
   */
  Field_datetime(uchar *ptr_arg, uchar *null_ptr_arg, uchar null_bit_arg, enum utype unireg_check_arg,
                 const char *field_name_arg)
      : Field_temporal_with_date_and_time(ptr_arg, null_ptr_arg, null_bit_arg, unireg_check_arg, field_name_arg, 0)
  {
  }
  Field_datetime(bool maybe_null_arg, const char *field_name_arg)
      : Field_temporal_with_date_and_time((uchar *)0, maybe_null_arg ? (uchar *)"" : 0, 0, NONE, field_name_arg, 0)
  {
  }
...
class Field_datetimef : public Field_temporal_with_date_and_timef
{
  ...
  */
  Field_datetimef(uchar *ptr_arg, uchar *null_ptr_arg, uchar null_bit_arg, enum utype unireg_check_arg,
                  const char *field_name_arg, uint8 dec_arg)
      : Field_temporal_with_date_and_timef(ptr_arg, null_ptr_arg, null_bit_arg, unireg_check_arg, field_name_arg,
                                           dec_arg)
  {
  }
  /**
  ...
  */
  Field_datetimef(bool maybe_null_arg, const char *field_name_arg, uint8 dec_arg)
      : Field_temporal_with_date_and_timef((uchar *)0, maybe_null_arg ? (uchar *)"" : 0, 0, NONE, field_name_arg,
                                           dec_arg)
  {
  }
...
class Field_string : public Field_longstr
{
 public:
  ...
  Field_string(uchar *ptr_arg, uint32 len_arg, uchar *null_ptr_arg, uchar null_bit_arg, enum utype unireg_check_arg,
      ...
      : Field_longstr(ptr_arg, len_arg, null_ptr_arg, null_bit_arg, unireg_check_arg, field_name_arg, cs),
        can_alter_field_type(1){};
  Field_string(uint32 len_arg, bool maybe_null_arg, const char *field_name_arg, const CHARSET_INFO *cs)
      : Field_longstr((uchar *)0, len_arg, maybe_null_arg ? (uchar *)"" : 0, 0, NONE, field_name_arg, cs),
        can_alter_field_type(1){};

  enum_field_types type() const
  {
    return ((can_alter_field_type && table && table->s && table->s->db_create_options & HA_OPTION_PACK_RECORD &&
             field_length >= 4) &&
  ...
  type_conversion_status reset(void)
  {
    charset()->cset->fill(charset(), (char *)ptr, field_length, (has_charset() ? ' ' : 0));
    return TYPE_OK;
  }
  type_conversion_status store(const char *to, size_t length, const CHARSET_INFO *charset);
  type_conversion_status store(longlong nr, bool unsigned_val);
...
class Field_varstring : public Field_longstr
{
  ...
  */
  ...
  Field_varstring(uchar *ptr_arg, uint32 len_arg, uint length_bytes_arg, uchar *null_ptr_arg, uchar null_bit_arg,
                  enum utype unireg_check_arg, const char *field_name_arg, TABLE_SHARE *share, const CHARSET_INFO *cs)
      : Field_longstr(ptr_arg, len_arg, null_ptr_arg, null_bit_arg, unireg_check_arg, field_name_arg, cs),
        length_bytes(length_bytes_arg)
  {
    share->varchar_fields++;
  }
  Field_varstring(uint32 len_arg, bool maybe_null_arg, const char *field_name_arg, TABLE_SHARE *share,
                  const CHARSET_INFO *cs)
      : Field_longstr((uchar *)0, len_arg, maybe_null_arg ? (uchar *)"" : 0, 0, NONE, field_name_arg, cs),
  ...
  void get_ptr(uchar **str) { *str = ptr + length_bytes; }
  virtual bool is_text_key_type() const { return binary() ? false : true; }
...
class Field_blob : public Field_longstr
{
  ...
  */
  type_conversion_status store_to_mem(const char *from, size_t length, const CHARSET_INFO *cs, size_t max_length,
 ...
 public:
  Field_blob(uchar *ptr_arg, uchar *null_ptr_arg, uchar null_bit_arg, enum utype unireg_check_arg,
             const char *field_name_arg, TABLE_SHARE *share, uint blob_pack_length, const CHARSET_INFO *cs);
  ...
  void make_sort_key(uchar *buff, size_t length);
  uint32 pack_length() const { return (uint32)(packlength + portable_sizeof_char_ptr); }
  ...
  */
  ...
  virtual uint32 max_data_length() const { return (uint32)(((ulonglong)1 << (packlength * 8)) - 1); }
  type_conversion_status reset(void)
  {
...
#endif
      void
      store_length(uchar *i_ptr, uint i_packlength, uint32 i_number, bool low_byte_first);
  void store_length(uchar *i_ptr, uint i_packlength, uint32 i_number)
  {
    store_length(i_ptr, i_packlength, i_number, table->s->db_low_byte_first);
  }
  inline void store_length(uint32 number) { store_length(ptr, packlength, number); }
  ...
  uint32 get_length(const uchar *ptr_arg) { return get_length(ptr_arg, this->packlength, table->s->db_low_byte_first); }
  void put_length(uchar *pos, uint32 length);
  inline void get_ptr(uchar **str) { memcpy(str, ptr + packlength, sizeof(uchar *)); }
  inline void get_ptr(uchar **str, uint row_offset) { memcpy(str, ptr + packlength + row_offset, sizeof(char *)); }
  ...
  */
  void store_in_allocated_space(const char *from, uint32 length) { store_ptr_and_length(from, length); }
...
class Field_geom : public Field_blob
{
 ...
 public:
  ...
  Field_geom(uchar *ptr_arg, uchar *null_ptr_arg, uint null_bit_arg, enum utype unireg_check_arg,
             const char *field_name_arg, TABLE_SHARE *share, uint blob_pack_length, enum geometry_type geom_type_arg)
      : Field_blob(ptr_arg, null_ptr_arg, null_bit_arg, unireg_check_arg, field_name_arg, share, blob_pack_length,
                   &my_charset_bin)
  {
    geom_type = geom_type_arg;
  }
  Field_geom(uint32 len_arg, bool maybe_null_arg, const char *field_name_arg, TABLE_SHARE *share,
  ...
  type_conversion_status store(longlong nr, bool unsigned_val);
  type_conversion_status store_decimal(const my_decimal *);
  type_conversion_status store(const char *from, size_t length, const CHARSET_INFO *cs);
...
class Field_json : public Field_blob
{
 ...
 public:
  Field_json(uchar *ptr_arg, uchar *null_ptr_arg, uint null_bit_arg, enum utype unireg_check_arg,
             const char *field_name_arg, TABLE_SHARE *share, uint blob_pack_length)
      : Field_blob(ptr_arg, null_ptr_arg, null_bit_arg, unireg_check_arg, field_name_arg, share, blob_pack_length,
                   &my_charset_bin)
  {
  }
...
class Field_enum : public Field_str
{
 ...
 public:
  ...
  Field_enum(uchar *ptr_arg, uint32 len_arg, uchar *null_ptr_arg, uchar null_bit_arg, enum utype unireg_check_arg,
             const char *field_name_arg, uint packlength_arg, TYPELIB *typelib_arg, const CHARSET_INFO *charset_arg)
      : Field_str(ptr_arg, len_arg, null_ptr_arg, null_bit_arg, unireg_check_arg, field_name_arg, charset_arg),
        packlength(packlength_arg),
        typelib(typelib_arg)
  {
  ...
  uint pack_length_from_metadata(uint field_metadata) { return (field_metadata & 0x00ff); }
  uint row_pack_length() const { return pack_length(); }
...
class Field_set : public Field_enum
{
 public:
  Field_set(uchar *ptr_arg, uint32 len_arg, uchar *null_ptr_arg, uchar null_bit_arg, enum utype unireg_check_arg,
            const char *field_name_arg, uint32 packlength_arg, TYPELIB *typelib_arg, const CHARSET_INFO *charset_arg)
  ...
  type_conversion_status store(const char *to, size_t length, const CHARSET_INFO *charset);
  type_conversion_status store(double nr) { return Field_set::store((longlong)nr, FALSE); }
  type_conversion_status store(longlong nr, bool unsigned_val);
  virtual bool zero_pack() const { return 1; }
  String *val_str(String *, String *);
  void sql_type(String &str) const;
...
class Field_bit : public Field
{
 public:
  ...
  int key_cmp(const uchar *a, const uchar *b) { return cmp_binary((uchar *)a, (uchar *)b); }
  int key_cmp(const uchar *str, uint length);
  int cmp_offset(uint row_offset);
  void get_image(uchar *buff, size_t length, const CHARSET_INFO *cs) { get_key_image(buff, length, itRAW); }
  void set_image(const uchar *buff, size_t length, const CHARSET_INFO *cs)
  {
    Field_bit::store((char *)buff, length, cs);
  }
  size_t get_key_image(uchar *buff, size_t length, imagetype type);
  void set_key_image(const uchar *buff, size_t length) { Field_bit::store((char *)buff, length, &my_charset_bin); }
  void make_sort_key(uchar *buff, size_t length) { get_key_image(buff, length, itRAW); }
  uint32 pack_length() const { return (uint32)(field_length + 7) / 8; }
  uint32 pack_length_in_rec() const { return bytes_in_rec; }
  uint pack_length_from_metadata(uint field_metadata);
  uint row_pack_length() const { return (bytes_in_rec + ((bit_len > 0) ? 1 : 0)); }
...
class Field_bit_as_char : public Field_bit
{
 public:
  ...
  type_conversion_status store(longlong nr, bool unsigned_val) { return Field_bit::store(nr, unsigned_val); }
  void sql_type(String &str) const;
  Field_bit_as_char *clone(MEM_ROOT *mem_root) const { return new (mem_root) Field_bit_as_char(*this); }
...
class Create_field : public Sql_alloc
{
  ...
  */
  ...
  Create_field *clone(MEM_ROOT *mem_root) const { return new (mem_root) Create_field(*this); }
  bool is_gcol() const { return gcol_info; }
  bool is_virtual_gcol() const { return gcol_info && !gcol_info->get_field_stored(); }
  ...
  void init_for_tmp_table(enum_field_types sql_type_arg, uint32 max_length, uint32 decimals, bool maybe_null,
                          bool is_unsigned, uint pack_length = ~0U);

  bool init(THD *thd, const char *field_name, enum_field_types type, const char *length, const char *decimals,
            uint type_modifier, Item *default_value, Item *on_update_value, LEX_STRING *comment, const char *change,
            List<String> *interval_list, const CHARSET_INFO *cs, uint uint_geom_type,
...
class Copy_field : public Sql_alloc
{
  ...
  */
  ...
  {
    if (m_from_field && m_from_field->is_tmp_null() && !m_to_field->is_tmp_null())
    {
...
Field *make_field(TABLE_SHARE *share, uchar *ptr, size_t field_length, uchar *null_pos, uchar null_bit, uint pack_flag,
                  enum_field_types field_type, const CHARSET_INFO *cs, Field::geometry_type geom_type,
                  Field::utype unireg_check, TYPELIB *interval, const char *field_name);
...
inline uint8 f_decimals(int x) { return ((uint8)((x >> FIELDFLAG_DEC_SHIFT) & FIELDFLAG_MAX_DEC)); }
inline int f_is_alpha(int x) { return (!f_is_num(x)); }
inline int f_is_binary(int x)
{
  return (x & FIELDFLAG_BINARY);  // 4.0- compatibility
}
inline int f_is_enum(int x) { return ((x & (FIELDFLAG_INTERVAL | FIELDFLAG_NUMBER)) == FIELDFLAG_INTERVAL); }
inline int f_is_bitfield(int x) { return ((x & (FIELDFLAG_BITFIELD | FIELDFLAG_NUMBER)) == FIELDFLAG_BITFIELD); }
inline int f_is_blob(int x) { return ((x & (FIELDFLAG_BLOB | FIELDFLAG_NUMBER)) == FIELDFLAG_BLOB); }
inline int f_is_geom(int x) { return ((x & (FIELDFLAG_GEOM | FIELDFLAG_NUMBER)) == FIELDFLAG_GEOM); }
inline int f_is_json(int x)
{
  return ((x & (FIELDFLAG_JSON | FIELDFLAG_NUMBER | FIELDFLAG_BITFIELD)) == FIELDFLAG_JSON);
}
