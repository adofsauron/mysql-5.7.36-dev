...
#define OPTIMIZER_SWITCH_DEFAULT                                                                                       \
  (OPTIMIZER_SWITCH_INDEX_MERGE | OPTIMIZER_SWITCH_INDEX_MERGE_UNION | OPTIMIZER_SWITCH_INDEX_MERGE_SORT_UNION |       \
   OPTIMIZER_SWITCH_INDEX_MERGE_INTERSECT | OPTIMIZER_SWITCH_ENGINE_CONDITION_PUSHDOWN |                               \
   OPTIMIZER_SWITCH_INDEX_CONDITION_PUSHDOWN | OPTIMIZER_SWITCH_MRR | OPTIMIZER_SWITCH_MRR_COST_BASED |                \
   OPTIMIZER_SWITCH_BNL | OPTIMIZER_SWITCH_MATERIALIZATION | OPTIMIZER_SWITCH_SEMIJOIN | OPTIMIZER_SWITCH_LOOSE_SCAN | \
   OPTIMIZER_SWITCH_FIRSTMATCH | OPTIMIZER_SWITCH_DUPSWEEDOUT | OPTIMIZER_SWITCH_SUBQ_MAT_COST_BASED |                 \
   OPTIMIZER_SWITCH_USE_INDEX_EXTENSIONS | OPTIMIZER_SWITCH_COND_FANOUT_FILTER | OPTIMIZER_SWITCH_DERIVED_MERGE |      \
