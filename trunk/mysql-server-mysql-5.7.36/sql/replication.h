...
#define TRANS_PARAM_ZERO(trans_param_obj) memset(&trans_param_obj, 0, sizeof(Trans_param));
  ...
  */
  typedef struct Binlog_storage_observer
  {
    ...
    */
    ...
    int (*after_sync)(Binlog_storage_param *param, const char *log_file, my_off_t log_pos);
  ...
  */
  typedef struct Binlog_transmit_param
  {
     ...
     */
    bool should_observe() { return (flags & F_OBSERVE) || !(flags & F_DONT_OBSERVE); }
  ...
  */
  void thd_enter_cond(void *opaque_thd, mysql_cond_t *cond, mysql_mutex_t *mutex, const PSI_stage_info *stage,
...
#define THD_ENTER_COND(P1, P2, P3, P4, P5) thd_enter_cond(P1, P2, P3, P4, P5, __func__, __FILE__, __LINE__)
  ...
  /**
     ...
     @param src_line The caller source line number
  */
  void thd_exit_cond(void *opaque_thd, const PSI_stage_info *stage, const char *src_function, const char *src_file,
                     int src_line);
