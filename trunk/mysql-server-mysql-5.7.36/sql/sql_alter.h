...
class Alter_rename_key : public Sql_alloc
{
 public:
  ...
  Alter_rename_key(const char *old_name_arg, const char *new_name_arg) : old_name(old_name_arg), new_name(new_name_arg)
  {
  }
...
class Alter_table_ctx
{
 public:
  ...
  Alter_table_ctx(THD *thd, TABLE_LIST *table_list, uint tables_opened_arg, const char *new_db_arg,
  ...
  */
  bool is_table_renamed() const { return (is_database_changed() || new_name != table_name); };
