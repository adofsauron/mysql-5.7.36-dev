...
class Sql_cmd_create_server : public Sql_cmd_common_server
{
 ...
 public:
  Sql_cmd_create_server(Server_options *server_options) : Sql_cmd_common_server(), m_server_options(server_options) {}
...
class Sql_cmd_alter_server : public Sql_cmd_common_server
{
 ...
 public:
  Sql_cmd_alter_server(Server_options *server_options) : Sql_cmd_common_server(), m_server_options(server_options) {}
...
class Sql_cmd_drop_server : public Sql_cmd_common_server
{
 ...
 public:
  Sql_cmd_drop_server(LEX_STRING server_name, bool if_exists)
      : Sql_cmd_common_server(), m_server_name(server_name), m_if_exists(if_exists)
  {
  }
