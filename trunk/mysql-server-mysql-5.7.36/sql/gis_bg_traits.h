...
{
 public:
  explicit Gis_point_spherical(bool is_bg_adapter = true) : Gis_point(is_bg_adapter) {}

  /// @brief Default constructor, no initialization.
  Gis_point_spherical(const void *ptr, size_t nbytes, const Flags_t &flags, srid_t srid)
...
class Gis_multi_point_spherical : public Gis_wkb_vector<Gis_point_spherical>
{
 ...
 public:
  ...
  Gis_multi_point_spherical(const void *ptr, size_t nbytes, const Flags_t &flags, srid_t srid)
...
class Gis_line_string_spherical : public Gis_wkb_vector<Gis_point_spherical>
{
 ...
 public:
  ...
  Gis_line_string_spherical(const void *wkb, size_t len, const Flags_t &flags, srid_t srid)
...
class Gis_polygon_ring_spherical : public Gis_wkb_vector<Gis_point_spherical>
{
 ...
 public:
  Gis_polygon_ring_spherical(const void *wkb, size_t nbytes, const Flags_t &flags, srid_t srid)
      : base_type(wkb, nbytes, flags, srid, true)
  {
    set_geotype(wkb_linestring);
  }

  Gis_polygon_ring_spherical() : base_type(NULL, 0, Flags_t(Geometry::wkb_linestring, 0), default_srid, true) {}
};
...
class Gis_polygon_spherical : public Gis_polygon
{
 ...
 public:
  ...
  Gis_polygon_spherical(const void *wkb, size_t nbytes, const Flags_t &flags, srid_t srid)
  ...
  /*
    ...
    so we can do so.
   */
  ring_type &outer() const { return *(reinterpret_cast<ring_type *>(&base_type::outer())); }

  inner_container_type &inners() const { return *(reinterpret_cast<inner_container_type *>(&base_type::inners())); }
};
...
class Gis_multi_line_string_spherical : public Gis_wkb_vector<Gis_line_string_spherical>
{
 ...
 public:
  explicit Gis_multi_line_string_spherical(bool is_bg_adapter = true)
      : base_type(NULL, 0, Flags_t(wkb_multilinestring, 0), default_srid, is_bg_adapter)
  {
  }

  Gis_multi_line_string_spherical(const void *ptr, size_t nbytes, const Flags_t &flags, srid_t srid)
      : base_type(ptr, nbytes, flags, srid, true)
  {
...
class Gis_multi_polygon_spherical : public Gis_wkb_vector<Gis_polygon_spherical>
{
 ...
 public:
  ...
  Gis_multi_polygon_spherical(const void *ptr, size_t nbytes, const Flags_t &flags, srid_t srid)
      : base_type(ptr, nbytes, flags, srid, true)
  {
...
struct access<Gis_point, Dimension>
{
  ...
  static inline void set(Gis_point &p, double const &value) { p.set<Dimension>(value); }
};
...
template <>
struct dimension<Gis_point_spherical> : boost::mpl::int_<GEOM_DIM>
{
};
...
{
  static inline double get(Gis_point_spherical const &p) { return p.get<Dimension>(); }

  static inline void set(Gis_point_spherical &p, double const &value) { p.set<Dimension>(value); }
};
////////////////////////////////// LINESTRING ////////////////////////////
template <>
...
struct exterior_ring<Gis_polygon>
{
  ...
  static inline polygon_type::ring_type &get(polygon_type &p) { return p.outer(); }

  static inline polygon_type::ring_type const &get(polygon_type const &p) { return p.outer(); }
};
...
struct interior_rings<Gis_polygon>
{
  ...
  static inline polygon_type::inner_container_type &get(polygon_type &p) { return p.inners(); }

  static inline polygon_type::inner_container_type const &get(polygon_type const &p) { return p.inners(); }
};

template <>
struct tag<Gis_polygon_spherical>
{
  typedef boost::geometry::polygon_tag type;
};

template <>
struct ring_const_type<Gis_polygon_spherical>
{
  typedef Gis_polygon_spherical::ring_type const &type;
};

template <>
struct ring_mutable_type<Gis_polygon_spherical>
{
  typedef Gis_polygon_spherical::ring_type &type;
};

template <>
struct interior_const_type<Gis_polygon_spherical>
{
  typedef Gis_polygon_spherical::inner_container_type const &type;
};

template <>
struct interior_mutable_type<Gis_polygon_spherical>
{
  typedef Gis_polygon_spherical::inner_container_type &type;
};

template <>
struct exterior_ring<Gis_polygon_spherical>
{
...
template <>
struct interior_rings<Gis_polygon_spherical>
{
  typedef Gis_polygon_spherical polygon_type;
