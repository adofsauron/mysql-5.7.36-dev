...
@endverbatim
  ...
  */
  bool start(bool support_I_S, bool support_dbug_or_missing_priv, bool end_marker, bool one_line, long offset,
             long limit, ulong max_mem_size, ulonglong features);
  ...
  */
  ...
  bool is_started() const { return unlikely(pimpl != NULL) && pimpl->current_stmt_in_gen != NULL; }
  ...
  */
  ...
  /**
     ...
     @param  f  feature
  */
  bool feature_enabled(feature_value f) const { return unlikely(pimpl != NULL) && (pimpl->features & f); }
  ...
  /**
     ...
     this information.
  */
  Opt_trace_stmt *get_current_stmt_in_gen() { return pimpl->current_stmt_in_gen; }
