...
class Item_subselect : public Item_result_field
{
  ...
  */
  ...
  friend void Item_ident::fix_after_pullout(st_select_lex *parent_select, st_select_lex *removed_selec);
...
class Item_singlerow_subselect : public Item_subselect
{
 ...
 public:
  ...
  Item_singlerow_subselect() : Item_subselect(), value(0), row(0), no_rows(false) {}
...
class Item_in_subselect : public Item_exists_subselect
{
 ...
 public:
  bool in2exists_added_to_where() const { return in2exists_info && in2exists_info->added_to_where; }

  /// Is reliable only if IN->EXISTS has been done.
  bool dependent_before_in2exists() const { return in2exists_info->dependent_before; }
  ...
  explicit Item_in_subselect(Item *left_expr, SELECT_LEX *select_lex);
  ...
  trans_res select_transformer(st_select_lex *select);
  trans_res select_in_like_transformer(st_select_lex *select, Comp_creator *func);
  ...
  trans_res single_value_in_to_exists_transformer(st_select_lex *select, Comp_creator *func);
...
class Item_allany_subselect : public Item_in_subselect
{
 public:
  ...
  Item_allany_subselect(Item *left_expr, chooser_compare_func_creator fc, st_select_lex *select, bool all);
...
class subselect_engine : public Sql_alloc
{
 ...
 public:
  ...
  subselect_engine(Item_subselect *si, Query_result_interceptor *res)
      : result(res), item(si), res_type(STRING_RESULT), res_field_type(MYSQL_TYPE_VAR_STRING), maybe_null(false)
  {
  }
  ...
  */
  ...
  virtual bool change_query_result(Item_subselect *si, Query_result_subquery *result) = 0;
...
class subselect_single_select_engine : public subselect_engine
{
 ...
 public:
  subselect_single_select_engine(st_select_lex *select, Query_result_interceptor *result, Item_subselect *item);
  virtual void cleanup();
  ...
  virtual void print(String *str, enum_query_type query_type);
  virtual bool change_query_result(Item_subselect *si, Query_result_subquery *result);
...
{
 public:
  subselect_union_engine(st_select_lex_unit *u, Query_result_interceptor *result, Item_subselect *item);
  virtual void cleanup();
  virtual bool prepare();
  virtual void fix_length_and_dec(Item_cache **row);
  virtual bool exec();
...
class subselect_indexsubquery_engine : public subselect_engine
{
 ...
 public:
  /*
    ...
    SELECT_LEX::prepare
  */
  subselect_indexsubquery_engine(THD *thd_arg, QEP_TAB *tab_arg, Item_subselect *subs, Item *where, Item *having_arg,
                                 bool chk_null, bool unique_arg)
  ...
  virtual bool exec();
  virtual void print(String *str, enum_query_type query_type);
  virtual enum_engine_type engine_type() const { return unique ? UNIQUESUBQUERY_ENGINE : INDEXSUBQUERY_ENGINE; }
  virtual void cleanup() {}
  virtual bool prepare();
  virtual void fix_length_and_dec(Item_cache **row);
 ...
 */
Item *all_any_subquery_creator(Item *left_expr, chooser_compare_func_creator cmp, bool all, st_select_lex *select);
...
class subselect_hash_sj_engine : public subselect_indexsubquery_engine
{
 ...
 public:
  subselect_hash_sj_engine(THD *thd, Item_subselect *in_predicate, subselect_single_select_engine *old_engine)
      : subselect_indexsubquery_engine(thd, NULL, in_predicate, NULL, NULL, false, true),
  ...
  virtual void cleanup();
  virtual bool prepare() { return materialize_engine->prepare(); }
  virtual bool exec();
  virtual void print(String *str, enum_query_type query_type);
  virtual uint cols() const { return materialize_engine->cols(); }
