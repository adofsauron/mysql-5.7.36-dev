...
class Opt_hints_map : public Sql_alloc
{
  ...
  */
  my_bool is_specified(opt_hints_enum type_arg) const { return hints_specified.is_set(type_arg); }
  /**
  ...
  */
  ...
  /**
     ...
     @return switch value.
  */
  bool switch_on(opt_hints_enum type_arg) const { return hints.is_set(type_arg); }
};
...
class Opt_hints : public Sql_alloc
{
 ...
 public:
  Opt_hints(const LEX_CSTRING *name_arg, Opt_hints *parent_arg, MEM_ROOT *mem_root_arg)
      : name(name_arg), parent(parent_arg), child_array(mem_root_arg), resolved(false), resolved_children(0)
  {
  }

  bool is_specified(opt_hints_enum type_arg) const { return hints_map.is_specified(type_arg); }
  ...
  */
  ...
  {
    if (is_specified(type_arg) || (check_parent && parent->is_specified(type_arg)))
      return true;
  ...
  */
  ...
  bool is_all_resolved() const { return child_array.size() == resolved_children; }
...
class Opt_hints_global : public Opt_hints
{
 public:
  ...
  Opt_hints_global(MEM_ROOT *mem_root_arg) : Opt_hints(NULL, NULL, mem_root_arg) { max_exec_time = NULL; }
...
class Opt_hints_table : public Opt_hints
{
 public:
  ...
  Opt_hints_table(const LEX_CSTRING *table_name_arg, Opt_hints_qb *qb_hints_arg, MEM_ROOT *mem_root_arg)
      : Opt_hints(table_name_arg, qb_hints_arg, mem_root_arg), keyinfo_array(mem_root_arg)
  {
  }
