...
class sys_var
{
  ...
  */
  ...
  virtual void update_default(longlong new_def_value) { option.def_value = new_def_value; }
  ...
  */
  ...
  {
    return (option.id != -1) && (m_parse_flag & parse_flags) && (array->push_back(option), false);
  }
...
class Sys_var_tracker
{
 public:
  ...
  bool operator==(const Sys_var_tracker &x) const { return m_var && m_var == x.m_var; }
...
class set_var_password : public set_var_base
{
 ...
 public:
  set_var_password(st_lex_user *user_arg, char *password_arg) : user(user_arg), password(password_arg) {}
  int check(THD *thd);
  int update(THD *thd);
  void print(THD *thd, String *str); /* To self-print */
};
...
class set_var_collation_client : public set_var_base
{
 ...
 public:
  ...
  set_var_collation_client(int set_cs_flags_arg, const CHARSET_INFO *client_coll_arg,
                           const CHARSET_INFO *connection_coll_arg, const CHARSET_INFO *result_coll_arg)
...
bool enumerate_sys_vars(THD *thd, Show_var_array *show_var_array, bool sort, enum enum_var_type type, bool strict);
