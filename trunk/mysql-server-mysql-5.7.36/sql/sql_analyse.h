...
class field_str : public field_info
{
 ...
 public:
  field_str(Item *a, Query_result_analyse *b)
      : field_info(a, b),
        ...
        can_be_still_num(1)
  {
    init_tree(&tree, 0, 0, sizeof(String), (qsort_cmp2)sortcmp2, 0, free_string, NULL);
  };

  void add();
  void get_opt_type(String *, ha_rows);
  String *get_min_arg(String *not_used MY_ATTRIBUTE((unused))) { return &min_arg; }
  String *get_max_arg(String *not_used MY_ATTRIBUTE((unused))) { return &max_arg; }
  ...
  String *std(String *s MY_ATTRIBUTE((unused)), ha_rows rows MY_ATTRIBUTE((unused))) { return (String *)0; }
};
...
class field_real : public field_info
{
 ...
 public:
  field_real(Item *a, Query_result_analyse *b)
      : field_info(a, b), min_arg(0), max_arg(0), sum(0), sum_sqr(0), max_notzero_dec_len(0)
  {
...
class field_longlong : public field_info
{
 ...
 public:
  field_longlong(Item *a, Query_result_analyse *b) : field_info(a, b), min_arg(0), max_arg(0), sum(0), sum_sqr(0)
  {
...
class field_ulonglong : public field_info
{
 ...
 public:
  field_ulonglong(Item *a, Query_result_analyse *b) : field_info(a, b), min_arg(0), max_arg(0), sum(0), sum_sqr(0)
  {
...
class Query_result_analyse : public Query_result_send
{
 ...
 public:
  ...
  virtual uint field_count(List<Item> &) const { return array_elements(func_items); }
  virtual int prepare(List<Item> &list, SELECT_LEX_UNIT *u) { return result->prepare(list, u); }
