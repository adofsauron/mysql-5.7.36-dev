...
class base_list : public Sql_alloc
{
  ...
  */
  base_list(const base_list &tmp)
      : Sql_alloc(), first(tmp.first), last(tmp.elements ? tmp.last : &first), elements(tmp.elements)
  {
  }
...
class List : public base_list
{
 public:
  ...
  List &operator=(const List &tmp) { return static_cast<List &>(base_list::operator=(tmp)); }
...
class List_iterator : public base_list_iterator
{
 public:
  ...
  inline bool after(T *a, MEM_ROOT *mem_root) { return base_list_iterator::after(a, mem_root); }
...
class base_ilist_iterator
{
 ...
 public:
  base_ilist_iterator(base_ilist<T> &list_par) : list(&list_par), el(&list_par.first), current(NULL) {}
...
class I_List : private base_ilist<T>
{
 public:
  ...
  void move_elements_to(I_List<T> *new_owner) { base_ilist<T>::move_elements_to(new_owner); }
