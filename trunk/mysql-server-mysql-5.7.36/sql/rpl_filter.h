...
class Rpl_filter
{
 ...
 private:
  ...
  int build_table_hash_from_array(Table_rule_array *table_array, HASH *table_hash, bool array_inited,
                                  bool *hash_inited);
...
class Sql_cmd_change_repl_filter : public Sql_cmd
{
 public:
  ...
  virtual enum_sql_command sql_command_code() const { return SQLCOM_CHANGE_REPLICATION_FILTER; }
