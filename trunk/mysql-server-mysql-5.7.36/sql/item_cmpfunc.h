...
class Arg_comparator : public Sql_alloc
{
  ...
  static bool get_date_from_const(Item *date_arg, Item *str_arg, ulonglong *value);
  /**
...
class Item_bool_func : public Item_int_func
{
 public:
  ...
  explicit Item_bool_func(const POS &pos) : Item_int_func(pos), m_created_by_in2exists(false) {}

  Item_bool_func(Item *a) : Item_int_func(a), m_created_by_in2exists(false) {}
  Item_bool_func(const POS &pos, Item *a) : Item_int_func(pos, a), m_created_by_in2exists(false) {}

  Item_bool_func(Item *a, Item *b) : Item_int_func(a, b), m_created_by_in2exists(false) {}
  Item_bool_func(const POS &pos, Item *a, Item *b) : Item_int_func(pos, a, b), m_created_by_in2exists(false) {}

  Item_bool_func(THD *thd, Item_bool_func *item)
      : Item_int_func(thd, item), m_created_by_in2exists(item->m_created_by_in2exists)
  {
  }
...
{
 public:
  Item_func_istrue(const POS &pos, Item *a) : Item_func_truth(pos, a, true, true) {}
  ~Item_func_istrue() {}
...
{
 public:
  Item_func_isnottrue(const POS &pos, Item *a) : Item_func_truth(pos, a, true, false) {}
  ~Item_func_isnottrue() {}
...
{
 public:
  Item_func_isfalse(const POS &pos, Item *a) : Item_func_truth(pos, a, false, true) {}
  ~Item_func_isfalse() {}
...
{
 public:
  Item_func_isnotfalse(const POS &pos, Item *a) : Item_func_truth(pos, a, false, false) {}
...
class Item_in_optimizer : public Item_bool_func
{
 ...
 public:
  Item_in_optimizer(Item *a, Item_in_subselect *b)
      : Item_bool_func(a, reinterpret_cast<Item *>(b)), cache(0), save_cache(0), result_for_null_param(UNKNOWN)
  {
    with_subselect = TRUE;
  }
...
{ /* Bool with 2 string args */
 ...
 public:
  Item_bool_func2(Item *a, Item *b) : Item_bool_func(a, b), cmp(tmp_arg, tmp_arg + 1), abort_on_null(FALSE) {}
  ...
  void fix_length_and_dec();
  int set_cmp_func() { return cmp.set_cmp_func(this, tmp_arg, tmp_arg + 1, TRUE); }
  optimize_type select_optimize() const { return OPTIMIZE_OP; }
  virtual enum Functype rev_functype() const { return UNKNOWN_FUNC; }
  bool have_rev_func() const { return rev_functype() != UNKNOWN_FUNC; }

  virtual inline void print(String *str, enum_query_type query_type) { Item_func::print_op(str, query_type); }
...
class Item_bool_rowready_func2 : public Item_bool_func2
{
 public:
  ...
  Item_bool_rowready_func2(const POS &pos, Item *a, Item *b) : Item_bool_func2(pos, a, b)
  {
    allowed_arg_cols = 0;  // Fetch this value from first argument
  }
...
class Item_func_xor : public Item_bool_func2
{
 public:
  ...
  Item_func_xor(const POS &pos, Item *i1, Item *i2) : Item_bool_func2(pos, i1, i2) {}
...
class Item_func_trig_cond : public Item_bool_func
{
  ...
  */
  Item_func_trig_cond(Item *a, bool *f, JOIN *join, plan_idx idx, enum_trig_type trig_type_arg)
      : Item_bool_func(a), trig_var(f), m_join(join), m_idx(idx), trig_type(trig_type_arg)
  {
  }
  longlong val_int();
...
class Item_func_not_all : public Item_func_not
{
 ...
 public:
  ...
  Item_func_not_all(Item *a)
      : Item_func_not(a), test_sum_item(0), test_sub_item(0), subselect(0), abort_on_null(0), show(0)
  {
  }
...
class Item_func_eq : public Item_bool_rowready_func2
{
 public:
  ...
  Item_func_eq(const POS &pos, Item *a, Item *b) : Item_bool_rowready_func2(pos, a, b) {}
  longlong val_int();
...
class Item_func_equal : public Item_bool_rowready_func2
{
 public:
  ...
  Item_func_equal(const POS &pos, Item *a, Item *b) : Item_bool_rowready_func2(pos, a, b){};
...
class Item_func_interval : public Item_int_func
{
 ...
 public:
  Item_func_interval(const POS &pos, MEM_ROOT *mem_root, Item *expr1, Item *expr2,
                     class PT_item_list *opt_expr_list = NULL)
      : super(pos, alloc_row(pos, mem_root, expr1, expr2, opt_expr_list)), intervals(0)
  {
    allowed_arg_cols = 0;  // Fetch this value from first argument
  }
 ...
 private:
  Item_row *alloc_row(const POS &pos, MEM_ROOT *mem_root, Item *expr1, Item *expr2, class PT_item_list *opt_expr_list);
};
...
class Item_func_coalesce : public Item_func_numhybrid
{
 protected:
  ...
  Item_func_coalesce(const POS &pos, Item *a, Item *b) : Item_func_numhybrid(pos, a, b) {}
...
class Item_func_ifnull : public Item_func_coalesce
{
 ...
 public:
  Item_func_ifnull(const POS &pos, Item *a, Item *b) : Item_func_coalesce(pos, a, b) {}
  double real_op();
  longlong int_op();
...
class Item_func_if : public Item_func
{
 ...
 public:
  ...
  Item_func_if(const POS &pos, Item *a, Item *b, Item *c) : Item_func(pos, a, b, c), cached_result_type(INT_RESULT) {}
...
class Item_func_nullif : public Item_bool_func2
{
 ...
 public:
  Item_func_nullif(const POS &pos, Item *a, Item *b) : Item_bool_func2(pos, a, b), cached_result_type(INT_RESULT) {}
  double val_real();
  longlong val_int();
  String *val_str(String *str);
  my_decimal *val_decimal(my_decimal *);
...
class in_string : public in_vector
{
 ...
 public:
  in_string(THD *thd, uint elements, qsort2_cmp cmp_func, const CHARSET_INFO *cs);
  ~in_string();
  void set(uint pos, Item *item);
  uchar *get_value(Item *item);
  Item *create_item() { return new Item_string(collation); }
...
class in_longlong : public in_vector
{
 ...
 public:
  ...
  void value_to_item(uint pos, Item *item)
  {
    ...
    ((Item_int *)item)->unsigned_flag = (my_bool)base[pos].unsigned_flag;
  }
...
{
 public:
  in_datetime_as_longlong(THD *thd, uint elements) : in_longlong(thd, elements){};
  Item *create_item() { return new Item_temporal(MYSQL_TYPE_DATETIME, 0LL); }
  void set(uint pos, Item *item);
  uchar *get_value(Item *item);
};
...
class in_time_as_longlong : public in_longlong
{
 public:
  ...
  Item *create_item() { return new Item_temporal(MYSQL_TYPE_TIME, 0LL); }
  void set(uint pos, Item *item);
  uchar *get_value(Item *item);
};
...
class in_datetime : public in_longlong
{
 public:
  ...
  in_datetime(THD *thd_arg, Item *warn_item_arg, uint elements)
      : in_longlong(thd_arg, elements), warn_item(warn_item_arg), lval_cache(0){};
  void set(uint pos, Item *item);
  uchar *get_value(Item *item);

  Item *create_item() { return new Item_temporal(MYSQL_TYPE_DATETIME, (longlong)0); }
};
...
class in_double : public in_vector
{
 ...
 public:
  ...
  void set(uint pos, Item *item);
  uchar *get_value(Item *item);
  Item *create_item() { return new Item_float(0.0, 0); }
  void value_to_item(uint pos, Item *item) { ((Item_float *)item)->value = base[pos]; }
...
class in_decimal : public in_vector
{
 ...
 public:
  ...
  void set(uint pos, Item *item);
  uchar *get_value(Item *item);
  Item *create_item() { return new Item_decimal(0, FALSE); }
  void value_to_item(uint pos, Item *item)
  {
...
class cmp_item_string : public cmp_item_scalar
{
 ...
 public:
  cmp_item_string(const CHARSET_INFO *cs) : value(value_buff, sizeof(value_buff), cs), cmp_charset(cs) {}
...
class Item_func_in : public Item_func_opt_neg
{
  ...
  */
  ...
  Item_func_in(const POS &pos, PT_item_list *list, bool is_negation)
      : Item_func_opt_neg(pos, list, is_negation), array(NULL), have_null(false), dep_subq_in_list(false)
  {
    memset(&cmp_items, 0, sizeof(cmp_items));
    allowed_arg_cols = 0;  // Fetch this value from first argument
  }
  ...
  */
  float get_single_col_filtering_effect(Item_ident *fieldref, table_map filter_for_table,
 ...
 public:
  ...
  virtual void update_used_tables()
  {
    ...
    else
    {
      ...
      if ((const_item_cache = !(used_tables_cache = args[0]->used_tables()) && !with_subselect && !with_stored_program))
      {
...
class Item_func_isnotnull : public Item_bool_func
{
 ...
 public:
  ...
  Item_func_isnotnull(const POS &pos, Item *a) : Item_bool_func(pos, a), abort_on_null(0) {}
...
class Item_func_regex : public Item_bool_func
{
 ...
 public:
  Item_func_regex(const POS &pos, Item *a, Item *b) : Item_bool_func(pos, a, b), regex_compiled(0), regex_is_const(0) {}
  void cleanup();
  longlong val_int();
  bool fix_fields(THD *thd, Item **ref);
...
class Item_cond : public Item_bool_func
{
 ...
 public:
  ...
  Item_cond(const POS &pos, Item *i1, Item *i2) : Item_bool_func(pos), abort_on_null(0)
  {
    list.push_back(i1);
    list.push_back(i2);
  }
...
class Item_equal : public Item_bool_func
{
 ...
 public:
  ...
  virtual ~Item_equal() { delete eval_item; }
  ...
  */
  ...
  Item *transform(Item_transformer transformer, uchar *arg);
  virtual void print(String *str, enum_query_type query_type);
  const CHARSET_INFO *compare_collation() { return fields.head()->collation.collation; }
...
bool get_mysql_time_from_str(THD *thd, String *str, timestamp_type warn_type, const char *warn_name,
                             MYSQL_TIME *l_time);
/*
