...
class BG_result_buf_mgr
{
 ...
 public:
  ...
  void free_intermediate_result_buffers()
  {
    ...
    for (Prealloced_buffers::iterator itr = bg_results.begin(); itr != bg_results.end(); ++itr) gis_wkb_raw_free(*itr);
    bg_results.clear();
  }
...
class BG_geometry_collection
{
 ...
 public:
  ...
  Geometry::srid_t get_srid() const { return m_srid; }

  void set_srid(Geometry::srid_t srid) { m_srid = srid; }

  bool fill(const Geometry *geo, bool break_multi_geom = false) { return store_geometry(geo, break_multi_geom); }
 ...
 private:
  template <typename Coordsys>
  bool merge_one_run(Item_func_spatial_operation *ifso, my_bool *pnull_value);
...
class Item_geometry_func : public Item_str_func
{
 public:
  ...
  Item_geometry_func(const POS &pos, Item *a, Item *b, Item *c) : Item_str_func(pos, a, b, c) {}
...
class Item_func_geometry_from_text : public Item_geometry_func
{
 ...
 public:
  Item_func_geometry_from_text(const POS &pos, Item *a) : Item_geometry_func(pos, a) {}
  Item_func_geometry_from_text(const POS &pos, Item *a, Item *srid) : Item_geometry_func(pos, a, srid) {}
...
class Item_func_geometry_from_wkb : public Item_geometry_func
{
 ...
 public:
  Item_func_geometry_from_wkb(const POS &pos, Item *a) : Item_geometry_func(pos, a) {}
  Item_func_geometry_from_wkb(const POS &pos, Item *a, Item *srid) : Item_geometry_func(pos, a, srid) {}
...
class Item_func_geomfromgeojson : public Item_geometry_func
{
  ...
  */
  ...
  Item_func_geomfromgeojson(const POS &pos, Item *json_string, Item *options)
      : Item_geometry_func(pos, json_string, options), m_user_provided_srid(false), m_srid_found_in_document(-1)
  {
  }
  Item_func_geomfromgeojson(const POS &pos, Item *json_string, Item *options, Item *srid)
      : Item_geometry_func(pos, json_string, options, srid), m_srid_found_in_document(-1)
  {
  }
  String *val_str(String *);
  void fix_length_and_dec();
  ...
  bool parse_object(const Json_object *object, bool *rollback, String *buffer, bool is_parent_featurecollection,
                    Geometry **geometry);
  bool parse_object_array(const Json_array *points, Geometry::wkbType type, bool *rollback, String *buffer,
  ...
  bool is_member_valid(const Json_dom *member, const char *member_name, Json_dom::enum_json_type expected_type,
...
{
 public:
  Item_func_make_envelope(const POS &pos, Item *a, Item *b) : Item_geometry_func(pos, a, b) {}
...
class Item_func_simplify : public Item_geometry_func
{
  ...
  String arg_val;
  template <typename Coordsys>
  int simplify_basic(Geometry *geom, double max_dist, String *str, Gis_geometry_collection *gc = NULL,
                     String *gcbuf = NULL);

 public:
  Item_func_simplify(const POS &pos, Item *a, Item *b) : Item_geometry_func(pos, a, b) {}
...
{
 public:
  Item_func_point(const POS &pos, Item *a, Item *b) : Item_geometry_func(pos, a, b) {}
...
class Item_func_pointfromgeohash : public Item_geometry_func
{
 ...
 public:
  ...
  String *val_str(String *);
  bool fix_fields(THD *thd, Item **ref);
  Field::geometry_type get_geometry_type() const { return Field::GEOM_POINT; };
};
...
class Item_func_spatial_decomp : public Item_geometry_func
{
 ...
 public:
  Item_func_spatial_decomp(const POS &pos, Item *a, Item_func::Functype ft) : Item_geometry_func(pos, a)
  {
    decomp_func = ft;
  }
...
class Item_func_spatial_decomp_n : public Item_geometry_func
{
 ...
 public:
  Item_func_spatial_decomp_n(const POS &pos, Item *a, Item *b, Item_func::Functype ft) : Item_geometry_func(pos, a, b)
  {
    decomp_func_n = ft;
  }
  const char *func_name() const
...
class Item_func_spatial_mbr_rel : public Item_bool_func2
{
 ...
 public:
  Item_func_spatial_mbr_rel(Item *a, Item *b, enum Functype sp_rel) : Item_bool_func2(a, b) { spatial_rel = sp_rel; }
  Item_func_spatial_mbr_rel(const POS &pos, Item *a, Item *b, enum Functype sp_rel) : Item_bool_func2(pos, a, b)
  {
    spatial_rel = sp_rel;
  }
  longlong val_int();
...
class Item_func_spatial_rel : public Item_bool_func2
{
 ...
 public:
  ...
  static int bg_geo_relation_check(Geometry *g1, Geometry *g2, Functype relchk_type, my_bool *);
 ...
 protected:
  ...
  static int within_check(Geometry *g1, Geometry *g2, my_bool *pnull_value);
  template <typename Geotypes>
  static int equals_check(Geometry *g1, Geometry *g2, my_bool *pnull_value);
  template <typename Geotypes>
  static int disjoint_check(Geometry *g1, Geometry *g2, my_bool *pnull_value);
  template <typename Geotypes>
  static int intersects_check(Geometry *g1, Geometry *g2, my_bool *pnull_value);
  template <typename Geotypes>
  static int overlaps_check(Geometry *g1, Geometry *g2, my_bool *pnull_value);
  template <typename Geotypes>
  static int touches_check(Geometry *g1, Geometry *g2, my_bool *pnull_value);
  template <typename Geotypes>
  static int crosses_check(Geometry *g1, Geometry *g2, my_bool *pnull_value);
  ...
  template <typename Coordsys>
  int geocol_relcheck_intersect_disjoint(const typename BG_geometry_collection::Geometry_list *gv1,
                                         const typename BG_geometry_collection::Geometry_list *gv2);
  template <typename Coordsys>
  int geocol_relcheck_within(const typename BG_geometry_collection::Geometry_list *gv1,
                             const typename BG_geometry_collection::Geometry_list *gv2);
  template <typename Coordsys>
  int geocol_equals_check(const typename BG_geometry_collection::Geometry_list *gv1,
                          const typename BG_geometry_collection::Geometry_list *gv2);
};
...
class Item_func_spatial_operation : public Item_geometry_func
{
 protected:
  ...
  Geometry *simplify_multilinestring(Gis_multi_line_string *mls, String *result);

  template <typename Coordsys>
  Geometry *geometry_collection_set_operation(Geometry *g1, Geometry *g2, String *result);
  ...
  template <typename Coordsys>
  Geometry *geocol_symdifference(const BG_geometry_collection &bggc1, const BG_geometry_collection &bggc2,
                                 String *result);
  template <typename Coordsys>
  Geometry *geocol_difference(const BG_geometry_collection &bggc1, const BG_geometry_collection &bggc2, String *result);
  template <typename Coordsys>
  Geometry *geocol_intersection(const BG_geometry_collection &bggc1, const BG_geometry_collection &bggc2,
                                String *result);
  template <typename Coordsys>
  Geometry *geocol_union(const BG_geometry_collection &bggc1, const BG_geometry_collection &bggc2, String *result);
 ...
 public:
  ...
  Item_func_spatial_operation(const POS &pos, Item *a, Item *b, Item_func_spatial_operation::op_type sp_op)
...
class Item_func_distance : public Item_real_func
{
  ...
  double distance_point_geometry_spherical(const Geometry *g1, const Geometry *g2);
  double distance_multipoint_geometry_spherical(const Geometry *g1, const Geometry *g2);
 ...
 public:
  ...
  Item_func_distance(const POS &pos, PT_item_list *ilist, bool isspherical)
      : Item_real_func(pos, ilist),
        is_spherical_equatorial(isspherical),
  ...
  double val_real();
  const char *func_name() const { return is_spherical_equatorial ? "st_distance_sphere" : "st_distance"; }
};
