...
class Item_str_func : public Item_func
{
 ...
 public:
  ...
  Item_str_func(const POS &pos, Item *a) : Item_func(pos, a) { decimals = NOT_FIXED_DEC; }

  Item_str_func(Item *a, Item *b) : Item_func(a, b) { decimals = NOT_FIXED_DEC; }
  Item_str_func(const POS &pos, Item *a, Item *b) : Item_func(pos, a, b) { decimals = NOT_FIXED_DEC; }

  Item_str_func(Item *a, Item *b, Item *c) : Item_func(a, b, c) { decimals = NOT_FIXED_DEC; }
  Item_str_func(const POS &pos, Item *a, Item *b, Item *c) : Item_func(pos, a, b, c) { decimals = NOT_FIXED_DEC; }

  Item_str_func(Item *a, Item *b, Item *c, Item *d) : Item_func(a, b, c, d) { decimals = NOT_FIXED_DEC; }
  Item_str_func(const POS &pos, Item *a, Item *b, Item *c, Item *d) : Item_func(pos, a, b, c, d)
  {
    decimals = NOT_FIXED_DEC;
  }

  Item_str_func(Item *a, Item *b, Item *c, Item *d, Item *e) : Item_func(a, b, c, d, e) { decimals = NOT_FIXED_DEC; }
  Item_str_func(const POS &pos, Item *a, Item *b, Item *c, Item *d, Item *e) : Item_func(pos, a, b, c, d, e)
  {
    decimals = NOT_FIXED_DEC;
  }

  Item_str_func(List<Item> &list) : Item_func(list) { decimals = NOT_FIXED_DEC; }
  Item_str_func(const POS &pos, PT_item_list *opt_list) : Item_func(pos, opt_list) { decimals = NOT_FIXED_DEC; }
...
class Item_str_ascii_func : public Item_str_func
{
 ...
 public:
  Item_str_ascii_func() : Item_str_func() { collation.set_repertoire(MY_REPERTOIRE_ASCII); }
  ...
  Item_str_ascii_func(const POS &pos, Item *a, Item *b, Item *c) : Item_str_func(pos, a, b, c)
  {
    collation.set_repertoire(MY_REPERTOIRE_ASCII);
  }

  String *val_str(String *str) { return val_str_from_val_str_ascii(str, &ascii_buf); }
...
{
 public:
  Item_func_sha2(const POS &pos, Item *a, Item *b) : Item_str_ascii_func(pos, a, b) {}
  String *val_str_ascii(String *);
  void fix_length_and_dec();
...
class Item_func_aes_encrypt : public Item_str_func
{
 ...
 public:
  Item_func_aes_encrypt(const POS &pos, Item *a, Item *b) : Item_str_func(pos, a, b) {}
  Item_func_aes_encrypt(const POS &pos, Item *a, Item *b, Item *c) : Item_str_func(pos, a, b, c) {}
...
class Item_func_aes_decrypt : public Item_str_func
{
 ...
 public:
  Item_func_aes_decrypt(const POS &pos, Item *a, Item *b) : Item_str_func(pos, a, b) {}
  Item_func_aes_decrypt(const POS &pos, Item *a, Item *b, Item *c) : Item_str_func(pos, a, b, c) {}
...
class Item_func_random_bytes : public Item_str_func
{
 ...
 public:
  ...
  const char *func_name() const { return "random_bytes"; }
};
...
class Item_func_concat : public Item_str_func
{
 ...
 public:
  ...
  Item_func_concat(Item *a, Item *b) : Item_str_func(a, b), tmp_value("", 0, collation.collation) {}
  Item_func_concat(const POS &pos, Item *a, Item *b) : Item_str_func(pos, a, b), tmp_value("", 0, collation.collation)
  {
  }
...
class Item_func_concat_ws : public Item_str_func
{
 ...
 public:
  Item_func_concat_ws(List<Item> &list) : Item_str_func(list), tmp_value("", 0, collation.collation) {}
...
class Item_func_replace : public Item_str_func
{
 ...
 public:
  Item_func_replace(const POS &pos, Item *org, Item *find, Item *replace) : Item_str_func(pos, org, find, replace) {}
  String *val_str(String *);
  void fix_length_and_dec();
...
class Item_func_substr_index : public Item_str_func
{
 ...
 public:
  Item_func_substr_index(const POS &pos, Item *a, Item *b, Item *c) : Item_str_func(pos, a, b, c) {}
  String *val_str(String *);
  void fix_length_and_dec();
...
class Item_func_trim : public Item_str_func
{
 ...
 public:
  Item_func_trim(Item *a, Item *b, TRIM_MODE tm)
      : Item_str_func(a, b), m_trim_mode(tm), m_trim_leading(trim_leading()), m_trim_trailing(trim_trailing())
  {
  }

  Item_func_trim(const POS &pos, Item *a, Item *b, TRIM_MODE tm)
      : Item_str_func(pos, a, b), m_trim_mode(tm), m_trim_leading(trim_leading()), m_trim_trailing(trim_trailing())
  {
  }

  Item_func_trim(Item *a, TRIM_MODE tm)
      : Item_str_func(a), m_trim_mode(tm), m_trim_leading(trim_leading()), m_trim_trailing(trim_trailing())
  {
  }

  Item_func_trim(const POS &pos, Item *a, TRIM_MODE tm)
      : Item_str_func(pos, a), m_trim_mode(tm), m_trim_leading(trim_leading()), m_trim_trailing(trim_trailing())
  {
  }

  bool trim_leading() const
  {
    return m_trim_mode == TRIM_BOTH_DEFAULT || m_trim_mode == TRIM_BOTH || m_trim_mode == TRIM_LEADING ||
           m_trim_mode == TRIM_LTRIM;
  }

  bool trim_trailing() const
  {
    return m_trim_mode == TRIM_BOTH_DEFAULT || m_trim_mode == TRIM_BOTH || m_trim_mode == TRIM_TRAILING ||
...
class Item_func_des_encrypt : public Item_str_func
{
 ...
 public:
  ...
  Item_func_des_encrypt(const POS &pos, Item *a, Item *b) : Item_str_func(pos, a, b) {}
  String *val_str(String *);
  void fix_length_and_dec()
  {
    maybe_null = 1;
...
class Item_func_des_decrypt : public Item_str_func
{
 ...
 public:
  ...
  Item_func_des_decrypt(const POS &pos, Item *a, Item *b) : Item_str_func(pos, a, b) {}
  String *val_str(String *);
  void fix_length_and_dec()
  {
    maybe_null = 1;
...
class Item_func_encrypt : public Item_str_func
{
 ...
 public:
  Item_func_encrypt(const POS &pos, Item *a) : Item_str_func(pos, a) { constructor_helper(); }
  Item_func_encrypt(const POS &pos, Item *a, Item *b) : Item_str_func(pos, a, b) { constructor_helper(); }
...
class Item_func_encode : public Item_str_func
{
 ...
 public:
  Item_func_encode(const POS &pos, Item *a, Item *seed) : Item_str_func(pos, a, seed) {}
  String *val_str(String *);
  void fix_length_and_dec();
...
{
 public:
  Item_func_decode(const POS &pos, Item *a, Item *seed) : Item_func_encode(pos, a, seed) {}
...
class Item_func_sysconst : public Item_str_func
{
 ...
 public:
  ...
  explicit Item_func_sysconst(const POS &pos) : super(pos) { collation.set(system_charset_info, DERIVATION_SYSCONST); }
...
class Item_func_database : public Item_func_sysconst
{
 ...
 public:
  ...
  const Name_string fully_qualified_func_name() const { return NAME_STRING("database()"); }
};
...
class Item_func_user : public Item_func_sysconst
{
 ...
 public:
  ...
  explicit Item_func_user(const POS &pos) : super(pos) { str_value.set("", 0, system_charset_info); }
  ...
  bool fix_fields(THD *thd, Item **ref);
  void fix_length_and_dec() { max_length = (USERNAME_LENGTH + (HOSTNAME_LENGTH + 1) * SYSTEM_CHARSET_MBMAXLEN); }
  const char *func_name() const { return "user"; }
  const Name_string fully_qualified_func_name() const { return NAME_STRING("user()"); }
};
...
class Item_func_current_user : public Item_func_user
{
 ...
 public:
  ...
  const Name_string fully_qualified_func_name() const { return NAME_STRING("current_user()"); }
};
...
{
 public:
  Item_func_elt(const POS &pos, PT_item_list *opt_list) : Item_str_func(pos, opt_list) {}
  double val_real();
  longlong val_int();
...
class Item_func_make_set : public Item_str_func
{
 ...
 public:
  Item_func_make_set(const POS &pos, Item *a, PT_item_list *opt_list) : Item_str_func(pos, opt_list), item(a) {}
  ...
  bool fix_fields(THD *thd, Item **ref)
  {
    assert(fixed == 0);
    bool res =
        ((!item->fixed && item->fix_fields(thd, &item)) || item->check_cols(1) || Item_func::fix_fields(thd, ref));
...
class Item_func_format : public Item_str_ascii_func
{
 ...
 public:
  Item_func_format(const POS &pos, Item *org, Item *dec) : Item_str_ascii_func(pos, org, dec) {}
  Item_func_format(const POS &pos, Item *org, Item *dec, Item *lang) : Item_str_ascii_func(pos, org, dec, lang) {}
...
{
 public:
  Item_func_char(const POS &pos, PT_item_list *list) : Item_str_func(pos, list) { collation.set(&my_charset_bin); }
  Item_func_char(const POS &pos, PT_item_list *list, const CHARSET_INFO *cs) : Item_str_func(pos, list)
  {
    collation.set(cs);
  }
  String *val_str(String *);
  void fix_length_and_dec() { max_length = arg_count * 4; }
...
class Item_func_repeat : public Item_str_func
{
 ...
 public:
  Item_func_repeat(const POS &pos, Item *arg1, Item *arg2) : Item_str_func(pos, arg1, arg2) {}
  String *val_str(String *);
  void fix_length_and_dec();
...
class Item_func_rpad : public Item_str_func
{
 ...
 public:
  Item_func_rpad(const POS &pos, Item *arg1, Item *arg2, Item *arg3) : Item_str_func(pos, arg1, arg2, arg3) {}
  String *val_str(String *);
  void fix_length_and_dec();
...
class Item_func_lpad : public Item_str_func
{
 ...
 public:
  Item_func_lpad(const POS &pos, Item *arg1, Item *arg2, Item *arg3) : Item_str_func(pos, arg1, arg2, arg3) {}
  String *val_str(String *);
  void fix_length_and_dec();
...
{
 public:
  Item_func_conv(const POS &pos, Item *a, Item *b, Item *c) : Item_str_func(pos, a, b, c) {}
...
class Item_func_like_range : public Item_str_func
{
 ...
 public:
  Item_func_like_range(const POS &pos, Item *a, Item *b, bool is_min_arg) : Item_str_func(pos, a, b), is_min(is_min_arg)
  {
    maybe_null = 1;
  }
  String *val_str(String *);
...
{
 public:
  Item_func_like_range_min(const POS &pos, Item *a, Item *b) : Item_func_like_range(pos, a, b, true) {}
...
{
 public:
  Item_func_like_range_max(const POS &pos, Item *a, Item *b) : Item_func_like_range(pos, a, b, false) {}
...
class Item_char_typecast : public Item_str_func
{
 ...
 public:
  ...
  Item_char_typecast(const POS &pos, Item *a, int length_arg, const CHARSET_INFO *cs_arg)
...
{
 public:
  Item_func_export_set(const POS &pos, Item *a, Item *b, Item *c) : Item_str_func(pos, a, b, c) {}
  Item_func_export_set(const POS &pos, Item *a, Item *b, Item *c, Item *d) : Item_str_func(pos, a, b, c, d) {}
  Item_func_export_set(const POS &pos, Item *a, Item *b, Item *c, Item *d, Item *e) : Item_str_func(pos, a, b, c, d, e)
  {
  }
  String *val_str(String *str);
  void fix_length_and_dec();
...
class Item_func_quote : public Item_str_func
{
 ...
 public:
  ...
  {
    collation.set(args[0]->collation);
    ulong max_result_length = (ulong)args[0]->max_length * 2 + 2 * collation.collation->mbmaxlen;
...
class Item_func_conv_charset : public Item_str_func
{
 ...
 public:
  ...
  Item_func_conv_charset(const POS &pos, Item *a, const CHARSET_INFO *cs) : Item_str_func(pos, a)
  {
    conv_charset = cs;
    use_cached_value = 0;
    safe = 0;
  }
  Item_func_conv_charset(Item *a, const CHARSET_INFO *cs, bool cache_if_const) : Item_str_func(a)
  {
    ...
    if (cache_if_const && args[0]->const_item())
    {
      ...
      if (!str || str_value.copy(str->ptr(), str->length(), str->charset(), conv_charset, &errors))
        null_value = 1;
      use_cached_value = 1;
...
class Item_func_weight_string : public Item_str_func
{
 ...
 public:
  Item_func_weight_string(const POS &pos, Item *a, uint result_length_arg, uint nweights_arg, uint flags_arg,
...
class Item_func_crc32 : public Item_int_func
{
 ...
 public:
  Item_func_crc32(const POS &pos, Item *a) : Item_int_func(pos, a) { unsigned_flag = 1; }
...
class Item_func_gtid_subtract : public Item_str_ascii_func
{
 ...
 public:
  Item_func_gtid_subtract(const POS &pos, Item *a, Item *b) : Item_str_ascii_func(pos, a, b) {}
  void fix_length_and_dec();
